...
const FanlingHighway_LamTsuen = new Waypoint("fanlinghw", "").markAttributes("i");
...
const HKU_ShekTongTsui = new Waypoint("shektongtsui", "");
...
const KT_Anderson = new Waypoint("anderson", "");
const SauMauPing = new Waypoint("", "");
const KT_KwunTongFerryPier = new Waypoint("", "");
...
const WC_WanChaiFerryPier = new Waypoint("", "").addNeighbor(MTR_erl_exhibition);
const CW_ChaiWanRoad = new Waypoint("", "");
...
const SKW_YiuTungEstate = new Waypoint("", "");
const KowloonBayCommercial = new Waypoint("", "");
const WestWood_HKU = new Waypoint("", "").addNeighbor(HKU_ShekTongTsui);
const TaiPo_LamChuen = new Waypoint("", "");
const Rural_Kadoorie = new Waypoint("", "");
const KSR_SheugnTsuen = new Waypoint("", "");
...
const TsuenWanMarket = new Waypoint("", "").addNeighbor(TW_ChungOnStreet).addNeighbor(MTR_twl_tsuenwan);
...
const HH_HungHomFerryPier = new Waypoint("", "");
const TY_CheungTsingTunnel = new Waypoint("", "").markAttributes("i");
const TY_TingKauBridge = new Waypoint("", "").markAttributes("i");
const KLC_KowloonCityPier = new Waypoint("", "");
const ST_KwongYuen = new Waypoint("", "");
const FanlingHighway_KwuTung = new Waypoint("", "").markAttributes("i");
const SunTinHighway = new Waypoint("", "").markAttributes("i");
const YL_YuenLongPark = new Waypoint("", "");
const YL_Residence88 = new Waypoint("", "");
const TKO_HongSingGarden = new Waypoint("", "");
const KLC_ArgyleStreet = new Waypoint("", "");
const ST_LungHangEstate = new Waypoint("", "");
const KSR_KamTinCore = new Waypoint("", "");
const KSR_ShekKongMilitary = new Waypoint("", "");
const KSR_YuenKongTsuen = new Waypoint("", "");
const ConnaughtRoadFlyover = new Waypoint("", "").markAttributes("i");
const CW_SiuSaiWan = new Waypoint("", "");
const TM_TuenMunTownCenter = new Waypoint("", "").addNeighbor(MTR_tml_tuenmun).addNeighbor(KCR_lrt_2_puito);
const TY_CheungTsingEstate = new Waypoint("", "");
