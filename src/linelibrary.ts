...
const WALK_KLP_CH_ALL = [WALK_KLP_CH_TowardsBus, WALK_KLP_CH_TowardsMTR];

const WALK_KLP_ALL = [].concat(WALK_KLP_MK_ALL, WALK_KLP_HMT_ALL, WALK_KLP_WKL_ALL, WALK_KLP_SSP_ALL, WALK_KLP_CH_ALL);
...
// All 21*
const KMB_NUM_21x_ALL = [KMB_216M];
...
const KMB_NUM_26x_ALL = [KMB_263_EAST, KMB_263_WEST, KMB_269D_EAST, KMB_269D_WEST];
...
// 03*
const CTB_37A_POSITIVE = new Line('37A', lineType_CTB, '置富花園', '中環', [PokFuLam_Actual, MTR_swil_wahfoo, MTR_swil_tinwan, MTR_swil_aberdeen, MTR_swil_wongchukhang, AberdeenTunnel_Interchange, AberdeenTunnel, HappyValley, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, MTR_ill_saiyingpun, MTR_swil_hku, MTR_swil_queenmary, PokFuLam_Actual], 15).markCircular();
const CTB_37B_NEGATIVE = new Line('37B', lineType_CTB, '置富花園', '金鐘東', [PokFuLam_Actual, MTR_swil_queenmary, MTR_ill_hku, MTR_ill_saiyingpun, MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, HappyValley, AberdeenTunnel, AberdeenTunnel_Interchange, MTR_swil_wongchukhang, MTR_swil_aberdeen, MTR_swil_tinwan, MTR_swil_wahfoo, PokFuLam_Actual], 15).markCircular();
...
// 09*
const NWFB_91_NORTH = new Line("91", lineType_NWFB, "鴨脷洲邨", "中環渡輪碼頭", [MTR_seil_southhoriz, MTR_seil_leitung, MTR_swil_aberdeen, MTR_swil_tinwan, MTR_swil_wahfoo, PokFuLam_Actual, MTR_swil_queenmary, MTR_ill_hku, MTR_ill_saiyingpun, MTR_ill_sheungwan, MTR_tcl_hongkong], 18);
const NWFB_91_SOUTH = new Line("91", lineType_NWFB, "中環渡輪碼頭", "鴨脷洲邨", [MTR_tcl_hongkong, MTR_ill_sheungwan, MTR_ill_saiyingpun, MTR_ill_hku, MTR_swil_queenmary, PokFuLam_Actual, MTR_swil_wahfoo, MTR_swil_tinwan, MTR_swil_aberdeen, MTR_seil_leitung, MTR_seil_southhoriz], 18);
...
const GMB_NT_28K = new Line("28K", lineType_GMB_NT, "大埔墟站", "沙田市中心", [MTR_erl_taipomarket, TaiPoRoad_TaiPoKau, TaiPoRoad_CUHK, RoyalAscot, MTR_erl_fotan, MTR_erl_shatin, MTR_erl_fotan, RoyalAscot, TaiPoRoad_CUHK, TaiPoRoad_TaiPoKau, MTR_erl_taipomarket], 9).markCircular();
const GMB_NT_28S = new Line("28S", lineType_GMB_NT, "白石角", "沙田市中心", [PakShekKok, CheungShueTan, TaiPoRoad_CUHK, RoyalAscot, MTR_erl_fotan, MTR_erl_shatin, MTR_erl_fotan, RoyalAscot, TaiPoRoad_CUHK, CheungShueTan, PakShekKok], 35).markCircular();
// All 02*
...
// All 10*
const CHT_NUM_10x_ALL = [CHT_102_NORTH, CHT_102_SOUTH, CHT_107_NORTH, CHT_107_SOUTH];
// 17*
