...
const KMB_43X_EAST = new Line("43X", lineType_KMB, "荃灣西站", "耀安", [MTR_tml_tsuenwanwest, TW_ChungOnStreet, TW_YiPeiChuen, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ST_ShatinSeafood, ST_ShatinHospital, ChevalierGarden, MTR_mos_hengon, MOS_HengHongStreet], 13);
const KMB_43X_WEST = new Line("43X", lineType_KMB, "耀安", "荃灣西站", [MOS_HengHongStreet, MTR_mos_hengon, ChevalierGarden, ST_ShatinHospital, ST_ShatinSeafood, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_YiPeiChuen, TW_ChungOnStreet, MTR_tml_tsuenwanwest], 13);
...
// All 29*
const KMB_NUM_29x_ALL = [KMB_290_EAST, KMB_290_WEST, KMB_290A_EAST, KMB_290A_WEST, KMB_290B_WEST, KMB_290X_EAST, KMB_290X_WEST];
...
// All 6**
const CHT_NUM_6xx_ALL = [].concat(CHT_NUM_60x_ALL, CHT_NUM_67x_ALL, CHT_NUM_68x_ALL, CHT_NUM_69x_ALL);
// 90*
