...
const WALK_KLP_HMT_WMP_ToPier = new Line("", lineType_WALK, "黃埔花園", "紅磡渡輪碼頭", [MTR_ktl_whampoa, HH_HungHomFerryPier]);
const WALK_KLP_HMT_WMP_FromPier = new Line("", lineType_WALK, "紅磡渡輪碼頭", "黃埔花園", [HH_HungHomFerryPier, MTR_ktl_whampoa]);
...
// Shatin Matrix
const WALK_NTE_ST_STW = new Line("瀝源橋", lineType_WALK, "沙田市中心", "乙明邨", [ShatinTownCenter, JatMinEstate]);
const WALK_NTE_STW_ST = new Line("瀝源橋", lineType_WALK, "乙明邨", "沙田市中心", [JatMinEstate, ShatinTownCenter]);
...
const WALK_NTE_ST_CS = new Line("獅子橋", lineType_WALK, "沙田市中心", "秦石邨", [ShatinTownCenter, MTR_mos_chekungtemple]);
const WALK_NTE_CS_ST = new Line("獅子橋", lineType_WALK, "秦石邨", "沙田市中心", [MTR_mos_chekungtemple, ShatinTownCenter]);
...
const KMB_6D_EAST = new Line("6D", lineType_KMB, "美孚", "牛頭角", [MTR_twl_meifoo, MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, MTR_ktl_shekkipmei, MongKokFlowerMarket, BoundaryPrince, PE_RegalOrientalHotel, SunPoKong_Inside, MTR_ktl_diamondhill, MTR_ktl_choihung, MTR_ktl_kowloonbay], 15);
const KMB_6D_WEST = new Line("6D", lineType_KMB, "牛頭角", "美孚", [MTR_ktl_kowloonbay, MTR_ktl_choihung, MTR_ktl_diamondhill, SunPoKong_Inside, PE_RegalOrientalHotel, BoundaryPrince, MongKokFlowerMarket, MTR_ktl_shekkipmei, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok, MTR_twl_meifoo], 15);

// All 00*
const KMB_NUM_00x_ALL = [KMB_1_NORTH, KMB_1_SOUTH, KMB_6_NORTH, KMB_6_SOUTH, KMB_6D_EAST, KMB_6D_WEST];

// 01*
const KMB_11D_EAST = new Line("11D", lineType_KMB, "樂富", "觀塘碼頭", [MTR_ktl_lokfu, BoundaryPrince, PE_RegalOrientalHotel, MTR_ktl_choihung, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, KT_KwunTongFerryPier], 20);
const KMB_11D_WEST = new Line("11D", lineType_KMB, "觀塘碼頭", "樂富", [KT_KwunTongFerryPier, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, MTR_ktl_choihung, PE_RegalOrientalHotel, BoundaryPrince, MTR_ktl_lokfu], 20);
...
const KMB_36A_NORTH = new Line("36A", lineType_KMB, "長沙灣深旺道", "梨木樹", [MTR_tml_namcheong, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok, MTR_twl_meifoo, LaiKingChokePoint, MTR_twl_laiking, MTR_twl_kwaifong, TW_LeiMukShueEstate], 20);
const KMB_36A_SOUTH = new Line("36A", lineType_KMB, "梨木樹", "長沙灣深旺道", [TW_LeiMukShueEstate, MTR_twl_kwaihing, MTR_twl_laiking, LaiKingChokePoint, MTR_twl_meifoo, MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, MTR_tml_namcheong], 20);
...
const KMB_40X_EAST = new Line("40X", lineType_KMB, "葵涌邨", "烏溪沙站", [KwaiChungEstate, MTR_twl_kwaihing, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, YuenWo, ShatinSeafood, ShatinHospital, MTR_mos_taishuihang, HengHongStreet, MTR_mos_maonshan, KamYingCourt, MTR_mos_wukaisha], 13);
const KMB_40X_WEST = new Line("40X", lineType_KMB, "烏溪沙站", "葵涌邨", [MTR_mos_wukaisha, KamYingCourt, MTR_mos_maonshan, HengHongStreet, MTR_mos_taishuihang, ShatinHospital, ShatinSeafood, YuenWo, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_kwaihing, KwaiChungEstate], 13);
const KMB_43X_EAST = new Line("43X", lineType_KMB, "荃灣西站", "耀安", [MTR_tml_tsuenwanwest, TW_ChungOnStreet, YiPeiChuen, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ShatinSeafood, ShatinHospital, ChevalierGarden, MTR_mos_hengon, HengHongStreet], 13);
const KMB_43X_WEST = new Line("43X", lineType_KMB, "耀安", "荃灣西站", [HengHongStreet, MTR_mos_hengon, ChevalierGarden, ShatinHospital, ShatinSeafood, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, YiPeiChuen, TW_ChungOnStreet, MTR_tml_tsuenwanwest], 13);
...
const KMB_47A_EAST = new Line("47A", lineType_KMB, "葵芳南", "水泉澳", [MTR_twl_kwaifong, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ShatinTownCenter, MTR_mos_shatinwai, ShuiChuenO], 30);
const KMB_47A_WEST = new Line("47A", lineType_KMB, "水泉澳", "葵芳南", [ShuiChuenO, MTR_mos_shatinwai, ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_kwaihing, MTR_twl_kwaifong], 30).setNotes("早繁時間不經沙田市中心");
const KMB_47X_EAST = new Line("47X", lineType_KMB, "葵盛東", "秦石", [MTR_twl_kwaifong, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ShatinTownCenter, MTR_mos_shatinwai, MTR_mos_chekungtemple], 8);
const KMB_47X_WEST = new Line("47X", lineType_KMB, "秦石", "葵盛東", [MTR_mos_chekungtemple, MTR_mos_shatinwai, ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_kwaihing, MTR_twl_kwaifong], 8).setNotes("早繁時間不經沙田市中心");
const KMB_48X_EAST = new Line("48X", lineType_KMB, "灣景花園", "禾輋邨", [BelvedereGarden, MTR_twl_tsuenking, MTR_twl_tsuenwan, MTR_twl_taiwohau, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ShatinTownCenter, YuenWo], 5);
const KMB_48X_WEST = new Line("48X", lineType_KMB, "禾輋邨", "灣景花園", [YuenWo, ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_taiwohau, MTR_twl_tsuenwan, MTR_twl_tsuenking, BelvedereGarden], 5);
const KMB_49X_EAST = new Line("49X", lineType_KMB, "青衣碼頭", "沙田廣源", [TsingYiFerryPier, TY_CheungOnEstate, TW_NinaTowers, MTR_twl_tsuenwan, CheungPeiShanRoad, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ShatinTownCenter, BelairGardens, MTR_mos_cityone], 8);
const KMB_49X_WEST = new Line("49X", lineType_KMB, "沙田廣源", "青衣碼頭", [MTR_mos_cityone, ShatinSeafood, BelairGardens, ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, CheungPeiShanRoad, MTR_twl_tsuenwan, TW_NinaTowers, TY_CheungOnEstate, TsingYiFerryPier], 8);
...
// 06*
const KMB_64K_EAST = new Line("64K", lineType_KMB, "元朗(西)", "大埔墟站", [KCR_lrt_5_fungninroad, MTR_tml_yuenlong, KSR_KoPoTsuen, MTR_tml_kamsheungroad, KSR_YuenKongTsuen, KSR_SheugnTsuen, Rural_Kadoorie, TaiPo_LamChuen, MTR_erl_taiwo, WanTauKokLane, MTR_erl_taipomarket]).setNotes("途經林錦公路");
const KMB_64K_WEST = new Line("64K", lineType_KMB, "大埔墟站", "元朗(西)", [MTR_erl_taipomarket,  MTR_erl_taiwo, TaiPo_LamChuen, Rural_Kadoorie, KSR_SheugnTsuen, KSR_YuenKongTsuen, MTR_tml_kamsheungroad, KSR_KoPoTsuen, MTR_tml_yuenlong, KCR_lrt_5_fungninroad]).setNotes("途經林錦公路");
const KMB_67M_EAST = new Line("67M", lineType_KMB, "兆康苑", "葵芳站", [MTR_tml_siuhong, LingNamUniversity, KCR_lrt_2_primeview, KCR_lrt_2_puito, TuenMunHighway_SoKwunWat, TuenMunHighway_InterchangeEast, TuenMunHighway_TsingLungTau, TuenMunHighway_YauKomTau, MTR_twl_tsuenking, TW_ChungOnStreet, MTR_twl_taiwohau, MTR_twl_kwaihing, MTR_twl_kwaifong], 10).setNotes("星期一至日 05:25-23:40");
...
// All 06*
const KMB_NUM_06x_ALL = [KMB_64K_EAST, KMB_64K_WEST, KMB_67M_EAST, KMB_67M_WEST, KMB_68E_NORTH, KMB_68E_SOUTH, KMB_68X_EAST, KMB_68X_WEST];
// 07*
...
// 08*
const KMB_80_NORTH = new Line('80', lineType_KMB, '觀塘碼頭', '美林', [KT_KwunTongFerryPier, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, HungNgokHouse_ChoiHung, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, LionRockTunnel, LionRockTunnelHighway, ST_LungHangEstate, MTR_tml_hinkeng, MTR_erl_taiwai, TaiPoRoad_MeiLam], 10);
const KMB_80_SOUTH = new Line('80', lineType_KMB, '美林', '觀塘碼頭', [MTR_erl_taiwai, MTR_tml_hinkeng, ST_LungHangEstate, LionRockTunnelHighway, LionRockTunnel, MTR_ktl_wongtaisin, MTR_ktl_diamondhill, MTR_ktl_choihung, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, KT_KwunTongFerryPier], 10);
...
const KMB_80X_EAST = new Line('80X', lineType_KMB, '沙田(秦石)', '觀塘碼頭', [MTR_mos_chekungtemple, MTR_mos_shatinwai, OldTatesTunnel_Interchange, OldTatesTunnel, ChoiHungBusTerminus, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, KT_KwunTongFerryPier], 10).setNotes('經觀塘道、彩虹、大老山隧道');
const KMB_80X_WEST = new Line('80X', lineType_KMB, '觀塘碼頭', '沙田(秦石)', [KT_KwunTongFerryPier, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, HungNgokHouse_ChoiHung, OldTatesTunnel, OldTatesTunnel_Interchange, MTR_mos_shatinwai, MTR_mos_chekungtemple], 10).setNotes('經觀塘道、彩虹、大老山隧道');
...
const KMB_83K = new Line("83K", lineType_KMB, "沙田黃泥頭", "沙田市中心", [ST_KwongYuen, HangSengUniversity, MTR_mos_cityone, ShatinSeafood, BelairGardens, ShatinTownCenter, YuenWo, MTR_mos_cityone, HangSengUniversity, ST_KwongYuen]).markCircular();
const KMB_85A_NORTH = new Line('85A', lineType_KMB, '九龍城碼頭', '沙田廣源邨', [KLC_KowloonCityPier, MTR_tml_sungwongtoi, BoundaryPrince, MTR_ktl_lokfu, LionRockTunnel, LionRockTunnel_Interchange, LionRockTunnelHighway, SunTinWai, MTR_mos_shatinwai, BelairGardens, MTR_mos_cityone, HangSengUniversity, ST_KwongYuen], 25).setNotes('經浸會大學');
...
const KMB_88K_NORTH = new Line("88K", lineType_KMB, "顯徑", "駿景園", [MTR_tml_hinkeng, ST_LungHangEstate, MTR_erl_taiwai, TaiPoRoad_MeiLam, ShatinTownCenter, YuenWo, MTR_erl_fotan, RoyalAscot], 12);
const KMB_88K_SOUTH = new Line("88K", lineType_KMB, "駿景園", "顯徑", [RoyalAscot, MTR_erl_fotan, YuenWo, ShatinTownCenter, TaiPoRoad_MeiLam, MTR_erl_taiwai, ST_LungHangEstate, MTR_tml_hinkeng], 12);
...
// All 08*
const KMB_NUM_08x_ALL = [KMB_80_NORTH, KMB_80_SOUTH, KMB_80K_EAST, KMB_80K_WEST, KMB_80M_NORTH, KMB_80M_SOUTH, KMB_80X_EAST, KMB_80X_WEST, KMB_81_NORTH, KMB_81_SOUTH, KMB_81C_NORTH, KMB_81C_SOUTH, KMB_81K_NORTH, KMB_81K_SOUTH, KMB_83K, KMB_85A_NORTH, KMB_85A_NORTH, KMB_85K_NORTH, KMB_85K_SOUTH, KMB_86_EAST, KMB_86_WEST, KMB_86A_NORTH, KMB_86A_SOUTH, KMB_86C_EAST, KMB_86C_WEST, KMB_87D_NORTH, KMB_87D_SOUTH, KMB_87K, KMB_87S, KMB_88K_NORTH, KMB_88K_SOUTH, KMB_88X_MORNING, KMB_88X_AFTERNOON, KMB_89_NORTH, KMB_89_SOUTH, KMB_89B_EAST, KMB_89B_WEST];

// 09*
const KMB_98A = new Line("98A", lineType_KMB, "坑口北", "牛頭角站", [MTR_tko_hanghau, MTR_tko_polam, KT_Anderson, SauMauPing, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, SauMauPing, KT_Anderson, MTR_tko_polam, MTR_tko_hanghau], 12).markCircular();
...
// 24*
const KMB_249X_EAST = new Line('249X', lineType_KMB, '青衣站', '沙田 (博康)', [MTR_tcl_tsingyi, TY_TsingYiWest, TY_CheungTsingEstate, TY_SouthBridge, LaiKingChokePoint, EaglesNestTunnel, TsingShaInterchange, ShatinHeightsTunnel, MTR_erl_taiwai, MTR_mos_chekungtemple, ShatinTownCenter, MTR_mos_shatinwai], 25).setNotes('經長青邨、青沙公路');
...
// 25*
const KMB_251A = new Line('251A', lineType_KMB, '錦上路站', '上村', [MTR_tml_kamsheungroad, TaiLamTunnel_Interchange, KSR_YuenKongTsuen, KSR_SheugnTsuen, KSR_YuenKongTsuen, TaiLamTunnel_Interchange, MTR_tml_kamsheungroad], 20).markCircular().setNotes('繞經元崗村');
const KMB_251B = new Line('251B', lineType_KMB, '八鄉路', '上村', [TaiLamTunnel_Interchange, MTR_tml_kamsheungroad, KSR_KamTinCore, KSR_PatHeungPolice, KSR_SheugnTsuen, KSR_PatHeungPolice, KSR_KamTinCore, MTR_tml_kamsheungroad, TaiLamTunnel_Interchange], 20).markCircular().setNotes('繞經錦田街市');
// All 25*
...
const KMB_269C_WEST = new Line('269C', lineType_KMB, '觀塘碼頭', '天水圍市中心', [KT_KwunTongFerryPier, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, MTR_ktl_choihung, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, ChingCheungRoad_BeaconHill, ChingCheungRoad_Other, LaiKingChokePoint, TY_CheungTsingTunnel, TY_TingKauBridge, TaiLamTunnel, TaiLamTunnel_Interchange, TsingLongHighway, YuenLongHighway, LongTinRoad, MTR_tml_tinshuiwai, KCR_lrt_4_tinshui, KCR_lrt_4_tinwing], 10).setNotes('天水圍特快 (不經元朗)');
...
const KMB_278X_SOUTH = new Line('278X', lineType_KMB, '上水', '荃灣（如心廣場）', [MTR_erl_sheungshui, MTR_erl_fanling, WahMingTerminus, FanlingHighway_Interchange, FanlingHighway_LamTsuen, ToloHighway_TaiPo, ToloHighway_Coastal, TaiPoRoad_Shatin, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_taiwohau, TW_ChungOnStreet, TW_NinaTowers], 10).setNotes('經華明');
// All 27*
const KMB_NUM_27x_ALL = [KMB_270A_NORTH, KMB_270A_SOUTH, KMB_273, KMB_273A, KMB_273D, KMB_278X_NORTH, KMB_278X_SOUTH];

// 28*
const KMB_280X_NORTH = new Line("280X", lineType_KMB, "尖東麼地道", "穗禾苑", [MTR_tml_easttsimshatsui, MTR_tml_austin, EaglesNestTunnel, TsingShaInterchange, ShatinHeightsTunnel, ShatinTownCenter, YuenWo, FoTanTsuen], 20).setNotes("經青沙公路");
const KMB_280X_SOUTH = new Line("280X", lineType_KMB, "穗禾苑", "尖東麼地道", [FoTanTsuen, YuenWo, ShatinTownHall, ShatinHeightsTunnel, TsingShaInterchange, EaglesNestTunnel, NgaCheungRoad_WHTX, MTR_twl_tsimshatsui], 20).setNotes("經青沙公路");
...
const KMB_281M_NORTH = new Line("281M", lineType_KMB, "九龍塘站", "新田圍", [MTR_erl_kowloontong, LionRockTunnel, LionRockTunnel_Interchange, LionRockTunnelHighway, ST_LungHangEstate, MTR_tml_hinkeng, MTR_erl_taiwai, MTR_mos_chekungtemple, SunTinWai]);
const KMB_281M_SOUTH = new Line("281M", lineType_KMB, "新田圍", "九龍塘站", [SunTinWai, MTR_mos_chekungtemple, MTR_erl_taiwai, MTR_tml_hinkeng, ST_LungHangEstate, LionRockTunnelHighway, LionRockTunnel_Interchange, LionRockTunnel, MTR_erl_kowloontong]);
...
// All 2**
const KMB_NUM_2xx_ALL = [].concat(KMB_NUM_21x_ALL, KMB_NUM_23x_ALL, KMB_NUM_24x_ALL, KMB_NUM_25x_ALL, KMB_NUM_26x_ALL, KMB_NUM_27x_ALL, KMB_NUM_28x_ALL);
...
// All Special Lines
const KMB_NUM_SPECIAL_ALL = [KMB_W3_NORTH, KMB_W3_SOUTH];
/*
...
const KMB_HK18_ALL = [].concat(KMB_NUM_0xx_ALL, KMB_NUM_2xx_ALL, KMB_NUM_SPECIAL_ALL);
...
// E4*
const LWB_E42_EAST = new Line('E42', lineType_LWB, '機場', '博康', [MTR_aex_airport, Airport_CathayPacificCity, MTR_tcl_tungchung, LantauLink_SiuHoWan, LantauLink_YamO, LantauLink_Interchange, LantauLink_TsingMaBridge, TY_TsingYiWest, TW_TexacoFlyover, CheungPeiShanRoad, ShingMunTunnel, ShingMunTunnelHighway, TaiPoRoad_MeiLam, MTR_mos_taiwai, MTR_mos_chekungtemple, ShatinTownCenter, MTR_mos_shatinwai], 16).setNotes('經機場南部設施');
...
const NWFB_8_EAST = new Line("8", lineType_NWFB, "灣仔北", "杏花邨", [WC_WanChaiFerryPier, MTR_ill_wanchai, MTR_ill_causewaybay, MTR_ill_tinhau, EasternCorridor, CW_ChaiWanRoad, MTR_ill_chaiwan, MTR_ill_hengfachuen], 13).setNotes("東走特快");
const NWFB_8_WEST = new Line("8", lineType_NWFB, "杏花邨", "灣仔北", [MTR_ill_hengfachuen, MTR_ill_chaiwan, CW_ChaiWanRoad, EasternCorridor, MTR_ill_fortresshill, MTR_ill_tinhau, MTR_ill_causewaybay, MTR_ill_wanchai, WC_WanChaiFerryPier], 13).setNotes("東走特快");
...
// All 01*
const NWFB_NUM_01x_ALL = [NWFB_18X_EAST, NWFB_18X_WEST];
// 03*
...
const NWFB_798A_AFTERNOON = new Line('798A', lineType_NWFB, '沙田市中心', '將軍澳(康盛花園)', [ShatinTownCenter, MTR_mos_shatinwai, OldTatesTunnel_Interchange, OldTatesTunnel, KowloonBayFlyover, KwunTongBypass, TseungKwanOTunnel, MTR_tko_polam, TKO_HongSingGarden], 1440).markCommuter().setNotes('單班車1815開出；經寶琳北');
...
// 06*
const GMB_NT_65A_EAST = new Line("65A", lineType_GMB_NT, "沙田大會堂", "黃泥頭", [ShatinTownHall, BelairGardens, MTR_mos_cityone, HangSengUniversity, ST_KwongYuen], 7);
const GMB_NT_65A_WEST = new Line("65A", lineType_GMB_NT, "黃泥頭", "沙田大會堂", [ST_KwongYuen, HangSengUniversity, MTR_mos_cityone, ShatinSeafood, BelairGardens, ShatinTownHall], 7);
...
const GMB_NT_68K_EAST = new Line("68K", lineType_GMB_NT, "瑞峰花園", "沙田站", [ST_LungHangEstate, MTR_mos_taiwai, MTR_mos_chekungtemple, ShatinTownCenter, MTR_erl_shatin], 8);
...
// All 11*
const CHT_NUM_11x_ALL = [CHT_110, CHT_112_NORTH, CHT_112_SOUTH, CHT_116_NORTH, CHT_116_SOUTH];
// 17*
...
// 60*
const CHT_606_NORTH = new Line('606', lineType_HARBOUR, '小西灣(藍灣半島)', '彩雲(豐盛街)', [CW_SiuSaiWan, MTR_ill_chaiwan, CW_ChaiWanRoad, SKW_YiuTungEstate, MTR_ill_saiwanho, MTR_ill_taikoo, MTR_ill_quarrybay, EastHarbourTunnel, EastHarbourTunnel_Interchange, MTR_ktl_lamtin, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, KowloonBayCommercial, MTR_ktl_choihung], 20).setNotes('經九龍灣商貿區');
const CHT_606_SOUTH = new Line('606', lineType_HARBOUR, '彩雲(豐盛街)', '小西灣(藍灣半島)', [MTR_ktl_choihung, KowloonBayCommercial, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, MTR_ktl_lamtin, EastHarbourTunnel_Interchange, EastHarbourTunnel, MTR_ill_quarrybay, MTR_ill_taikoo, MTR_ill_saiwanho, SKW_YiuTungEstate, CW_ChaiWanRoad, MTR_ill_chaiwan, CW_SiuSaiWan], 20).setNotes('經九龍灣商貿區');
// All 60*
const CHT_NUM_60x_ALL = [CHT_606_NORTH, CHT_606_SOUTH];
// All 6**
const CHT_NUM_6xx_ALL = [].concat(CHT_NUM_60x_ALL);
// 90*
...
const CHT_905_NORTH = new Line('905', lineType_HARBOUR, '灣仔北', '荔枝角', [WC_WanChaiFerryPier, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, MTR_ill_saiyingpun, HKU_ShekTongTsui, WestHarbourTunnel, WestHarbourTunnel_Interchange, MTR_tcl_olympic, MTR_twl_princeedward, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok, MTR_twl_meifoo], 10);
...
const KMB_978_NORTH = new Line('978', lineType_KMB, '灣仔北', '華明總站', [WC_WanChaiFerryPier, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, WestHarbourTunnel, WestHarbourTunnel_Interchange, WestKowloonHighway, LaiKingChokePoint, TY_CheungTsingTunnel, TY_TingKauBridge, TaiLamTunnel, TaiLamTunnel_Interchange, TsingLongHighway, SunTinHighway, FanlingHighway_KwuTung, MTR_erl_sheungshui, MTR_erl_fanling, WahMingTerminus], 20).setNotes('星期一至日 10:00-23:30；經大欖隧道、西隧');
const KMB_978_SOUTH = new Line('978', lineType_KMB, '華明總站', '灣仔北', [WahMingTerminus, MTR_erl_fanling, MTR_erl_sheungshui, FanlingHighway_KwuTung, SunTinHighway, TsingLongHighway, TaiLamTunnel_Interchange, TaiLamTunnel, TY_TingKauBridge, TY_CheungTsingTunnel, LaiKingChokePoint, WestKowloonHighway, WestHarbourTunnel_Interchange, WestHarbourTunnel, MTR_ill_sheungwan, MTR_tcl_hongkong, MTR_ill_admiralty, MTR_erl_exhibition, WC_WanChaiFerryPier], 20).setNotes('星期一至日 06:00-23:00；經大欖隧道、西隧');
...
const HK18_ALL_LINES: Array<Line> = [].concat(WALK_HK18_ALL, TRAM_ALL, FERRY_HK18_ALL, KMB_HK18_ALL, LWB_HK18_ALL, CTB_HK18_ALL, NWFB_HK18_ALL, GMB_HK18_ALL, CHT_HK18_ALL);