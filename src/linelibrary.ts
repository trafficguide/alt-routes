...
const WALK_HK18_ALL = [].concat(WALK_HKI_ALL, WALK_NTE_ALL);
...
// All 08*
const KMB_NUM_08x_ALL = [KMB_80M_NORTH, KMB_80M_SOUTH, KMB_81_NORTH, KMB_81_SOUTH, KMB_81K_NORTH, KMB_81K_SOUTH, KMB_85K_NORTH, KMB_85K_SOUTH, KMB_87D_NORTH, KMB_87D_SOUTH, KMB_87K, KMB_87S, KMB_88K_NORTH, KMB_88K_SOUTH];
// All 0**
...
const KMB_PURE_HK18_ALL = [].concat(KMB_NUM_0xx_ALL, KMB_NUM_SPECIAL);
...
const HK18_ALL_LINES: Array<Line> = [].concat(WALK_HK18_ALL, KMB_PURE_HK18_ALL, GMB_HK18_ALL);