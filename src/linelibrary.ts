...
// Wah Foo
const WALK_HKI_WF_ToMainRoad = new Line("", lineType_WALK, "華富邨商場", "華富邨 (石排灣道入口)", [MTR_swil_wahfoo, OuterWahFoo]);
const WALK_HKI_WF_ToInner = new Line("", lineType_WALK, "華富邨 (石排灣道入口)", "華富邨商場", [OuterWahFoo, MTR_swil_wahfoo]);

const WALK_HKI_WF_ALL = [WALK_HKI_WF_ToMainRoad, WALK_HKI_WF_ToInner];

const WALK_HKI_ALL = [].concat(WALK_HKI_CENTRAL_ALL, WALK_HKI_HKU_ALL, WALK_HKI_WF_ALL);
...
const WALK_NTW_TKT_LK_ToMTR = new Line("", lineType_WALK, "葵涌道荔景邨站", "荔景站", [TW_LowerLaiKing, MTR_twl_laiking]);
const WALK_NTW_TKT_LK_ToLower = new Line("", lineType_WALK, "荔景站", "葵涌道荔景邨站", [MTR_twl_laiking, TW_LowerLaiKing]);

const WALK_NTW_TSUENKWAITSING_ALL = [WALK_NTW_TKT_TWSYS_NORTH, WALK_NTW_TKT_TWSYS_SOUTH, WALK_NTW_CO_TY, WALK_NTW_TY_CO, WALK_NTW_TKT_KCE_ToTWH, WALK_NTW_TKT_KCE_FromTWH, WALK_NTW_TKT_KCE_ToKH, WALK_NTW_TKT_KCE_FromKH, WALK_NTW_TKT_KH_ToCPR, WALK_NTW_TKT_KH_FromCPR, WALK_NTW_TKT_LK_ToMTR, WALK_NTW_TKT_LK_ToLower];
...
const KMB_2F_EAST = new Line('2F', lineType_KMB, '長沙灣', '慈雲山北', [MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, MTR_ktl_shekkipmei, KowloonTongCornwall, MTR_ktl_lokfu, MTR_ktl_wongtaisin], 20).setNotes('經樂富、歌和老街、南昌街');
const KMB_2F_WEST = new Line('2F', lineType_KMB, '慈雲山北', '長沙灣', [MTR_ktl_wongtaisin, MTR_ktl_lokfu, KowloonTongCornwall, MTR_ktl_shekkipmei, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok], 20).setNotes('經樂富、歌和老街、南昌街');
const KMB_3C_NORTH = new Line('3C', lineType_KMB, '中港碼頭', '慈雲山(北)', [MTR_tml_austin, MTR_twl_jordan, MTR_ktl_yaumatei, MTR_ktl_mongkok, KowloonHospital, MTR_ktl_kowloontong, MTR_ktl_lokfu, MTR_ktl_wongtaisin], 15).setNotes('每日 06:15-00:40');
const KMB_3C_SOUTH = new Line('3C', lineType_KMB, '慈雲山(北)', '中港碼頭', [MTR_ktl_wongtaisin, MTR_ktl_lokfu, MTR_ktl_kowloontong, MK_FlowerMarket, MTR_ktl_princeedward, MTR_ktl_mongkok, MTR_ktl_yaumatei, MTR_twl_jordan, MTR_tml_austin], 15).setNotes('每日 05:30-23:50');
...
// All 00*
const KMB_NUM_00x_ALL = [KMB_1_NORTH, KMB_1_SOUTH, KMB_2F_EAST, KMB_2F_WEST, KMB_3C_NORTH, KMB_3C_SOUTH, KMB_6_NORTH, KMB_6_SOUTH, KMB_6D_EAST, KMB_6D_WEST];
...
const KMB_68M_NORTH = new Line('68M', lineType_KMB, '荃灣站巴士總站', '元朗（西）總站', [MTR_twl_tsuenwan, MTR_twl_tsuenking, TuenMunHighway_YauKomTau, TaiLamTunnel, TaiLamTunnel_Interchange, TsingLongHighway, KCR_lrt_5_yuenlong, KCR_lrt_5_fungninroad], 12).setNotes('星期一至日 06:10-00:50');
const KMB_68M_SOUTH = new Line('68M', lineType_KMB, '元朗（西）總站', '荃灣站巴士總站', [KCR_lrt_5_fungninroad, KCR_lrt_5_yuenlong, TsingLongHighway, TaiLamTunnel_Interchange, TaiLamTunnel, TuenMunHighway_YauKomTau, MTR_twl_tsuenking, MTR_twl_tsuenwan], 12).setNotes('星期一至日 05:30-00:10');
...
// All 06*
const KMB_NUM_06x_ALL = [KMB_64K_EAST, KMB_64K_WEST, KMB_67M_EAST, KMB_67M_WEST, KMB_68E_NORTH, KMB_68E_SOUTH, KMB_68M_NORTH, KMB_68M_SOUTH, KMB_68X_EAST, KMB_68X_WEST, KMB_69M_NORTH, KMB_69M_SOUTH];
// 07*
const KMB_72_NORTH = new Line("72", lineType_KMB, "長沙灣", "大埔太和", [MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, TaiPoRoad_KowloonReservoir, TaiPoRoad_ShatinHeights, TaiPoRoad_MeiLam, MTR_erl_shatin, ST_YuenWo, TaiPoRoad_Shatin, TaiPoRoad_CUHK, TaiPoRoad_TaiPoKau, TP_KwongFukEstate, KwongFukRoad, MTR_erl_taiwo], 20);
const KMB_72_SOUTH = new Line("72", lineType_KMB, "大埔太和", "長沙灣", [MTR_erl_taiwo, WanTauKokLane, TP_KwongFukEstate, TaiPoRoad_TaiPoKau, TaiPoRoad_CUHK, TaiPoRoad_Shatin, ST_YuenWo, MTR_erl_shatin, TaiPoRoad_ShatinHeights, TaiPoRoad_KowloonReservoir, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok], 20);
const KMB_72A_NORTH = new Line("72A", lineType_KMB, "大圍站", "大埔工業邨", [MTR_erl_taiwai, MTR_mos_chekungtemple, ST_JatMinChuen, ST_YuenWo, TaiPoRoad_Shatin, TaiPoRoad_CUHK, TaiPoRoad_TaiPoKau, TP_KwongFukEstate, KwongFukRoad], 30).setNotes("設有雙程分段收費");
const KMB_72A_SOUTH = new Line("72A", lineType_KMB, "大埔工業邨", "大圍站", [WanTauKokLane, TP_KwongFukEstate, TaiPoRoad_TaiPoKau, TaiPoRoad_CUHK, TaiPoRoad_Shatin, ST_YuenWo, ST_JatMinChuen, MTR_erl_taiwai], 30).setNotes("設有雙程分段收費");
const KMB_72X_NORTH = new Line("72X", lineType_KMB, "旺角(柏景灣)", "大埔中心", [MTR_tcl_olympic, MTR_ktl_mongkok, MTR_erl_kowloontong, LionRockTunnel, LionRockTunnel_Interchange, TaiPoRoad_Shatin, TP_KwongFukEstate, KwongFukRoad]).setNotes("大埔特快");
const KMB_72X_SOUTH = new Line("72X", lineType_KMB, "大埔中心", "旺角(柏景灣)", [WanTauKokLane, TP_KwongFukEstate, TaiPoRoad_Shatin, LionRockTunnel_Interchange, LionRockTunnel, MTR_erl_kowloontong, MTR_ktl_mongkok, MTR_tcl_olympic]).setNotes("大埔特快");
...
const KMB_73A_NORTH = new Line("73A", lineType_KMB, "愉翠苑", "粉嶺華明", [MTR_mos_cityone, MTR_erl_fotan, TaiPoRoad_Shatin, TaiPoRoad_CUHK, TaiPoRoad_TaiPoKau, TP_KwongFukEstate, KwongFukRoad, MTR_erl_taiwo, TaiPoRoad_HongLokYuen, TaiPoRoad_KiuTau, FL_WahMing], 30);
const KMB_73A_SOUTH = new Line("73A", lineType_KMB, "粉嶺華明", "愉翠苑", [FL_WahMing, TaiPoRoad_KiuTau, TaiPoRoad_HongLokYuen, MTR_erl_taiwo, WanTauKokLane, TP_KwongFukEstate, TaiPoRoad_TaiPoKau, TaiPoRoad_CUHK, TaiPoRoad_Shatin, MTR_erl_fotan, MTR_mos_cityone], 30).setNotes("設有雙程分段收費");
const KMB_73X_NORTH = new Line("73X", lineType_KMB, "荃灣(如心廣場)", "富善邨", [TW_NinaTowers, TW_ChungOnStreet, MTR_twl_taiwohau, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, TaiPoRoad_Shatin, ToloHighway_Coastal, TP_KwongFukEstate, KwongFukRoad]).setNotes("大埔特快");
const KMB_73X_SOUTH = new Line("73X", lineType_KMB, "富善邨", "荃灣(如心廣場)", [WanTauKokLane, TP_KwongFukEstate, ToloHighway_Coastal, TaiPoRoad_Shatin, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_taiwohau, TW_ChungOnStreet, TW_NinaTowers]).setNotes("大埔特快");
...
const KMB_74D_SOUTH = new Line('74D', lineType_KMB, '九龍坑', '觀塘碼頭', [TaiPoRoad_KiuTau, TaiPoRoad_HongLokYuen, MTR_erl_taiwo, TP_KwongFukEstate, ToloHighway_Coastal, PakShekKok, SciencePark, OldTatesTunnel_Interchange, OldTatesTunnel, ChoiHungBusTerminus, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, KT_FerryPier], 60).setNotes('班次疏落，經科學園及白石角');
const KMB_74X_NORTH = new Line('74X', lineType_KMB, '觀塘碼頭', '大埔中心', [KT_FerryPier, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, HungNgokHouse_ChoiHung, MTR_ktl_diamondhill, OldTatesTunnel, OldTatesTunnel_Interchange, ToloHighway_Coastal, TP_KwongFukEstate], 7).setNotes('經新蒲崗，鑽石山，大老山');
const KMB_74X_SOUTH = new Line('74X', lineType_KMB, '大埔中心', '觀塘碼頭', [TP_KwongFukEstate, ToloHighway_Coastal, OldTatesTunnel_Interchange, OldTatesTunnel, ChoiHungBusTerminus, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, KT_FerryPier], 7).setNotes('經大老山，彩虹');
// All 07*
const KMB_NUM_07x_ALL = [KMB_72_NORTH, KMB_72_SOUTH, KMB_72A_NORTH, KMB_72A_SOUTH, KMB_73_NORTH, KMB_73_SOUTH, KMB_73A_NORTH, KMB_73A_SOUTH, KMB_73X_NORTH, KMB_73X_SOUTH, KMB_74A_NORTH, KMB_74A_SOUTH, KMB_74D_NORTH, KMB_74D_SOUTH, KMB_74X_NORTH, KMB_74X_SOUTH];
// 08*
...
// 21*
const KMB_214_EAST = new Line('214', lineType_KMB, '長沙灣 (甘泉街)', '油塘', [MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, MTR_ktl_shekkipmei, ChingCheungRoad_BeaconHill, MTR_ktl_wongtaisin, MTR_ktl_diamondhill, MTR_ktl_choihung, KT_ShunLeeEstate, KT_Anderson, KT_PoTatEstate, KT_KwongTin, MTR_ktl_yautong], 15);
const KMB_214_WEST = new Line('214', lineType_KMB, '油塘', '長沙灣 (甘泉街)', [MTR_ktl_yautong, KT_KwongTin, KT_PoTatEstate, KT_Anderson, MTR_ktl_choihung, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, ChingCheungRoad_BeaconHill, MTR_ktl_shekkipmei, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok], 15);
...
// All 21*
const KMB_NUM_21x_ALL = [KMB_214_EAST, KMB_214_WEST, KMB_215X_EAST, KMB_215X_WEST, KMB_216M];
...
const KMB_271_NORTH = new Line('271', lineType_KMB, '佐敦(西九龍站)', '大埔(富亨)', [TP_KwongFukEstate, ToloHighway_Coastal, TaiPoRoad_Shatin, LionRockTunnelHighway, LionRockTunnel, MTR_erl_kowloontong, KowloonHospital, MTR_ktl_yaumatei, MTR_twl_jordan, MTR_twl_tsimshatsui, MTR_tml_austin], 10).setNotes('經尖沙咀,佐敦,油麻地,何文田,九龍塘,獅隧');
const KMB_271_SOUTH = new Line('271', lineType_KMB, '大埔(富亨)', '佐敦(西九龍站)', [MTR_tml_austin, MTR_twl_tsimshatsui, MTR_twl_jordan, MTR_ktl_yaumatei, KowloonHospital, MTR_erl_kowloontong, LionRockTunnel, LionRockTunnelHighway, TaiPoRoad_Shatin, ToloHighway_Coastal, TP_KwongFukEstate], 10).setNotes('經九龍塘,何文田,油麻地,佐敦,尖沙咀');
...
// All 27*
const KMB_NUM_27x_ALL = [KMB_270A_NORTH, KMB_270A_SOUTH, KMB_271_NORTH, KMB_271_SOUTH, KMB_273, KMB_273A, KMB_273D, KMB_278X_NORTH, KMB_278X_SOUTH];
...
const KMB_286M = new Line('286M', lineType_KMB, '馬鞍山市中心', '鑽石山站', [MTR_mos_maonshan, MTR_mos_hengon, MTR_mos_taishuihang, ST_ShatinHospital, OldTatesTunnel_Interchange, OldTatesTunnel, MTR_ktl_diamondhill, OldTatesTunnel, OldTatesTunnel_Interchange, ST_ShatinHospital, MTR_mos_taishuihang, MTR_mos_hengon, MTR_mos_maonshan], 20).markCircular().setNotes('每日 05:30-00:00');
...
// All 28*
const KMB_NUM_28x_ALL = [KMB_280X_NORTH, KMB_280X_SOUTH, KMB_281A_NORTH, KMB_281A_SOUTH, KMB_281M_NORTH, KMB_281M_SOUTH, KMB_282, KMB_284, KMB_286M, KMB_286X, KMB_287X, KMB_288, KMB_289K];
...
const KMB_W3_NORTH = new Line("W3", lineType_KMB, "西九龍站", "上水", [MTR_hsr_westkowloon, WestKowloonHighway, EaglesNestTunnel, TsingShaInterchange, ShatinHeightsTunnel, MTR_erl_shatin, TaiPoRoad_Shatin, ToloHighway_Coastal, TP_KwongFukEstate, FanlingHighway_LamTsuen, MTR_erl_sheungshui]).setNotes("高鐵特快；設有雙程分段收費");
const KMB_W3_SOUTH = new Line("W3", lineType_KMB, "上水", "西九龍站", [MTR_erl_sheungshui, FanlingHighway_LamTsuen, TP_KwongFukEstate, ToloHighway_Coastal, TaiPoRoad_Shatin, MTR_erl_shatin, ShatinHeightsTunnel, TsingShaInterchange, EaglesNestTunnel, WestKowloonHighway, MTR_hsr_westkowloon]).setNotes("高鐵特快");
// All Special Lines
...
// All 04*
const CTB_NUM_04x_ALL = [];

// 07*
const CTB_70_NORTH = new Line('70', lineType_CTB, '華貴邨', '中環交易廣場', [MTR_swil_tinwan, MTR_swil_aberdeen, MTR_swil_wongchukhang, AberdeenTunnel_Interchange, AberdeenTunnel, MTR_ill_wanchai, MTR_ill_central], 10).setNotes('經香隧、鵝頸橋、舊灣仔警署、皇后像廣場');
const CTB_70_SOUTH = new Line('70', lineType_CTB, '中環交易廣場', '華貴邨', [MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, AberdeenTunnel, AberdeenTunnel_Interchange, MTR_swil_wongchukhang, MTR_swil_aberdeen, MTR_swil_tinwan], 10).setNotes('經金鐘，入境大樓，鵝頸橋、香隧');
const CTB_71_NORTH = new Line('71', lineType_CTB, '黃竹坑', '中環林士街', [MTR_seil_wongchukhang, MTR_swil_aberdeen, MTR_swil_tinwan, OuterWahFoo, PokFuLam_Actual, MTR_swil_queenmary, UpperKennedyTown, MTR_ill_hku, MTR_ill_saiyingpun, MTR_ill_sheungwan], 25).setNotes('經瑪麗醫院，HKU，西營盤，上環');
const CTB_71_SOUTH = new Line('71', lineType_CTB, '中環林士街', '黃竹坑', [MTR_ill_sheungwan, MTR_ill_central, MTR_ill_sheungwan, MTR_ill_saiyingpun, MTR_ill_hku, UpperKennedyTown, MTR_swil_queenmary, PokFuLam_Actual, OuterWahFoo, MTR_swil_tinwan, MTR_swil_aberdeen, MTR_seil_wongchukhang], 25).setNotes('經瑪麗醫院，HKU，西營盤，上環');
...
// All 07*
const CTB_NUM_07x_ALL = [CTB_70_NORTH, CTB_70_SOUTH, CTB_71_NORTH, CTB_71_SOUTH, CTB_72_NORTH, CTB_72_SOUTH, CTB_77_EAST, CTB_77_WEST];
...
const CTB_97_NORTH = new Line('97', lineType_CTB, '利東邨', '中環交易廣場', [MTR_seil_leitung, MTR_seil_wongchukhang, AberdeenTunnel_Interchange, AberdeenTunnel, HappyValley, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central], 15).setNotes('經金鐘，灣仔');
const CTB_97_SOUTH = new Line('97', lineType_CTB, '中環交易廣場', '利東邨', [MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, HappyValley, AberdeenTunnel, AberdeenTunnel_Interchange, MTR_seil_wongchukhang, MTR_seil_leitung], 15).setNotes('經金鐘，灣仔');
...
// All 09*
const CTB_NUM_09x_ALL = [CTB_96_NORTH, CTB_96_SOUTH, CTB_97_NORTH, CTB_97_SOUTH, CTB_98_NORTH, CTB_98_SOUTH, CTB_99_EAST, CTB_99_WEST];
// All 00*
...
// 78*
const CTB_780_EAST = new Line('780', lineType_CTB, '中環碼頭', '柴灣(東)', [CEN_FerryPier, MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, WC_FerryPier, EasternCorridor, CW_ChaiWanRoad, MTR_ill_chaiwan, MTR_ill_siusaiwan], 15).setNotes('特快路線，經中環、怡和大廈、入境事務大樓、灣仔碼頭、柴灣道、漁灣邨');
const CTB_780_WEST = new Line('780', lineType_CTB, '柴灣(東)', '中環碼頭', [MTR_ill_siusaiwan, MTR_ill_chaiwan, CW_ChaiWanRoad, EasternCorridor, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, CEN_FerryPier], 15).setNotes('特快路線，經漁灣邨、柴灣道、舊灣仔警署、海富中心、中環');
const CTB_780P_MORNING = new Line('780P', lineType_CTB, '興華邨', '中環碼頭', [MTR_ill_chaiwan, CW_ChaiWanRoad, EasternCorridor, MTR_ill_causewaybay, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, CEN_FerryPier], 1440).markCommuter().setNotes('只於平日早上服務，經康翠臺、柴灣道、百德新街、內告士打道、海富中心、中環');
const CTB_788_EAST = new Line('788', lineType_CTB, '中環(港澳碼頭)', '小西灣(藍灣半島)', [MTR_ill_sheungwan, MTR_ill_central, MTR_ill_wanchai, WC_FerryPier, EasternCorridor, MTR_ill_siusaiwan], 9).setNotes('特快路線，經中環、怡和大廈、入境事務大樓、灣仔碼頭、柴灣工廠區、小西灣');
const CTB_788_WEST = new Line('788', lineType_CTB, '小西灣(藍灣半島)', '中環(港澳碼頭)', [MTR_ill_siusaiwan, EasternCorridor, MTR_ill_wanchai, MTR_ill_central, MTR_ill_sheungwan], 9).setNotes('特快路線，部分班次不停富景花園，經小西灣、翠灣邨、舊灣仔警署、中環');
const CTB_789_EAST = new Line('789', lineType_CTB, '金鐘(樂禮街)', '小西灣(藍灣半島)', [MTR_ill_admiralty, MTR_ill_wanchai, EasternCorridor, MTR_ill_siusaiwan], 11).setNotes('經灣仔道、漁灣邨、小西灣');
const CTB_789_WEST = new Line('789', lineType_CTB, '小西灣(藍灣半島)', '金鐘(樂禮街)', [MTR_ill_siusaiwan, EasternCorridor, MTR_ill_wanchai, MTR_ill_admiralty], 11).setNotes('經小西灣、舊灣仔警署');
// All 78*
const CTB_NUM_78x_ALL = [CTB_780_EAST, CTB_780_WEST, CTB_780P_MORNING, CTB_788_EAST, CTB_788_WEST, CTB_789_EAST, CTB_789_WEST];
// All 7**
const CTB_NUM_7xx_ALL = [].concat(CTB_NUM_78x_ALL);

// Special
// A2*
const CTB_A22_EAST = new Line('A22', lineType_CTB, '機場地面運輸中心', '藍田站', [MTR_aex_airport, Airport_HKZHMCBridgePort, LantauLink_SiuHoWan, LantauLink_YamO, LantauLink_Interchange, LantauLink_TsingMaBridge, NgongShuenChauBridge, WestKowloonHighway, MTR_tml_austin, MTR_twl_jordan, MTR_tml_homantin, MTR_tml_tokwawan, MTR_tml_sungwongtoi, PE_RegalOrientalHotel, PE_SunPoKong, ChoiHungBusTerminus, PE_ChoiHung, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, MTR_ktl_lamtin], 20).setNotes('經港珠澳大橋香港口岸、青嶼幹線、昂船洲大橋、佐敦、紅磡、馬頭圍、新蒲崗、觀塘');
const CTB_A22_WEST = new Line('A22', lineType_CTB, '藍田站', '機場地面運輸中心', [MTR_ktl_lamtin, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, PE_ChoiHung, PE_SunPoKong, PE_RegalOrientalHotel, MTR_tml_sungwongtoi, MTR_tml_tokwawan, MTR_tml_homantin, MTR_twl_jordan, MTR_tml_austin, WestKowloonHighway, NgongShuenChauBridge, LantauLink_TsingMaBridge, LantauLink_Interchange, LantauLink_YamO, LantauLink_SiuHoWan, MTR_aex_airport, Airport_HKZHMCBridgePort, MTR_aex_airport], 20).setNotes('經觀塘、新蒲崗、馬頭圍、紅磡、佐敦、昂船洲大橋、青嶼幹線、珠澳大橋香港口岸、T1、T2');
const CTB_A26_EAST = new Line('A26', lineType_CTB, '機場地面運輸中心', '油塘', [MTR_aex_airport, LantauLink_SiuHoWan, LantauLink_YamO, LantauLink_Interchange, LantauLink_TsingMaBridge, TY_CheungTsingTunnel, LaiKingChokePoint, ChingCheungRoad_Other, ChingCheungRoad_BeaconHill, MTR_ktl_wongtaisin, MTR_ktl_diamondhill, MTR_ktl_choihung, KT_ShunLeeEstate, KT_Anderson, KT_KwongTin, MTR_ktl_yautong], 60).setNotes('經藍田、安秀道、牛池灣、鑽石山、黃大仙、青嶼幹線 服務時間：06:30 - 20:30');
const CTB_A26_WEST = new Line('A26', lineType_CTB, '油塘', '機場地面運輸中心', [MTR_ktl_yautong, KT_KwongTin, KT_Anderson, MTR_ktl_choihung, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, ChingCheungRoad_BeaconHill, ChingCheungRoad_Other, LaiKingChokePoint, TY_CheungTsingTunnel, LantauLink_TsingMaBridge, LantauLink_Interchange, LantauLink_YamO, LantauLink_SiuHoWan, MTR_aex_airport], 60).setNotes('經青嶼幹線、黃大仙、鑽石山站、牛池灣、安秀道、藍田 服務時間：11:45 - 23:45');
// All A2*
const CTB_NUM_A2x_ALL = [CTB_A22_EAST, CTB_A22_WEST, CTB_A26_EAST, CTB_A26_WEST];
// All A**
const CTB_NUM_Axx_ALL = [].concat(CTB_NUM_A2x_ALL);
// E2*
...
// All special lines
const CTB_NUM_SPECIAL_ALL = [].concat(CTB_NUM_Axx_ALL, CTB_NUM_Exx_ALL, CTB_NUM_Wxx_ALL);

const CTB_HK18_ALL = [].concat(CTB_NUM_0xx_ALL, CTB_NUM_5xx_ALL, CTB_NUM_7xx_ALL, CTB_NUM_SPECIAL_ALL);
...
const NWFB_4X_NORTH = new Line('4X', lineType_NWFB, '華富(南)', '中環碼頭', [MTR_swil_wahfoo, PokFuLam_Actual, MTR_swil_queenmary, UpperKennedyTown, MTR_ill_hku, MTR_ill_sheungwan, CEN_FerryPier, MTR_ill_central], 15).setNotes('有循環乘搭限制；(山道天橋特快)(一至六服務)經瑪麗醫院，HKU，上環');
const NWFB_4X_SOUTH = new Line('4X', lineType_NWFB, '中環碼頭', '華富(南)', [MTR_ill_central, MTR_ill_sheungwan, MTR_ill_saiyingpun, MTR_ill_hku, UpperKennedyTown, MTR_swil_queenmary, PokFuLam_Actual, MTR_swil_wahfoo], 15).setNotes('有循環乘搭限制；(一至六服務)經瑪麗醫院，HKU，西營盤，上環');
...
const NWFB_NUM_00x_ALL = [NWFB_2_EAST, NWFB_2_WEST, NWFB_4_NORTH, NWFB_4_SOUTH, NWFB_4X_NORTH, NWFB_4X_SOUTH, NWFB_8_EAST, NWFB_8_WEST];
...
const NWFB_38_EAST = new Line('38', lineType_NWFB, '置富花園', '北角碼頭', [PokFuLam_Actual, OuterWahFoo, MTR_swil_tinwan, MTR_swil_aberdeen, MTR_swil_wongchukhang, AberdeenTunnel_Interchange, AberdeenTunnel, HappyValley, MTR_ill_causewaybay, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, NP_FerryPier], 12).setNotes('經銅鑼灣，天后，黃竹坑，香港仔');
const NWFB_38_WEST = new Line('38', lineType_NWFB, '北角碼頭', '置富花園', [NP_FerryPier, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_tinhau, MTR_ill_causewaybay, HappyValley, AberdeenTunnel, AberdeenTunnel_Interchange, MTR_swil_wongchukhang, MTR_swil_aberdeen, MTR_swil_tinwan, OuterWahFoo, PokFuLam_Actual], 12).setNotes('經銅鑼灣，天后，黃竹坑，香港仔');
// All 03*
const NWFB_NUM_03x_ALL = [NWFB_30X_NORTH, NWFB_30X_SOUTH, NWFB_38_EAST, NWFB_38_WEST];
// 04*
const NWFB_42_EAST = new Line('42', lineType_NWFB, '華富邨(南)', '北角碼頭', [MTR_swil_wahfoo, MTR_swil_tinwan, MTR_swil_aberdeen, MTR_swil_wongchukhang, AberdeenTunnel_Interchange, AberdeenTunnel, HappyValley, MTR_ill_causewaybay, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, NP_FerryPier], 12).setNotes('經銅鑼灣，天后，黃竹坑，香港仔');
const NWFB_42_WEST = new Line('42', lineType_NWFB, '北角碼頭', '華富邨(南)', [NP_FerryPier, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_tinhau, MTR_ill_causewaybay, HappyValley, AberdeenTunnel, AberdeenTunnel_Interchange, MTR_swil_wongchukhang, MTR_swil_aberdeen, MTR_swil_tinwan, MTR_swil_wahfoo], 12).setNotes('經銅鑼灣，天后，黃竹坑，香港仔');
// All 04*
const NWFB_NUM_04x_ALL = [NWFB_42_EAST, NWFB_42_WEST];
// 08*
const NWFB_81_EAST = new Line('81', lineType_NWFB, '勵德邨', '興華邨', [Moreton_CausewayBay, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, MTR_ill_quarrybay, MTR_ill_taikoo, MTR_ill_saiwanho, MTR_ill_saukeiwan, CW_ChaiWanRoad, MTR_ill_chaiwan], 20).setNotes('經維園、英皇道、西灣河、筲箕灣、柴灣道、柴灣工業邨');
const NWFB_81_WEST = new Line('81', lineType_NWFB, '興華邨', '勵德邨', [MTR_ill_chaiwan, CW_ChaiWanRoad, MTR_ill_saukeiwan, MTR_ill_saiwanho, MTR_ill_taikoo, MTR_ill_quarrybay, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_tinhau, Moreton_CausewayBay], 20).setNotes('經柴灣工業邨、柴灣道、筲箕灣、西灣河、英皇道、大坑');
const NWFB_82_EAST = new Line('82', lineType_NWFB, '北角碼頭', '小西灣(藍灣半島)', [MTR_ill_siusaiwan, MTR_ill_chaiwan, CW_ChaiWanRoad, MTR_ill_saukeiwan, MTR_ill_saiwanho, MTR_ill_taikoo, MTR_ill_quarrybay, MTR_ill_northpoint, NP_FerryPier], 13).setNotes('經鰂魚涌、西灣河、筲箕灣、柴灣道、漁灣邨');
const NWFB_82_WEST = new Line('82', lineType_NWFB, '小西灣(藍灣半島)', '北角碼頭', [NP_FerryPier, MTR_ill_northpoint, MTR_ill_quarrybay, MTR_ill_taikoo, MTR_ill_saiwanho, MTR_ill_saukeiwan, CW_ChaiWanRoad, MTR_ill_chaiwan, MTR_ill_siusaiwan], 11).setNotes('經柴灣、東區醫院、筲箕灣、西灣河、鰂魚涌');
// All 08*
const NWFB_NUM_08x_ALL = [NWFB_81_EAST, NWFB_81_WEST, NWFB_82_EAST, NWFB_82_WEST];
// 09*
...
const NWFB_NUM_0xx_ALL = [].concat(NWFB_NUM_00x_ALL, NWFB_NUM_01x_ALL, NWFB_NUM_03x_ALL, NWFB_NUM_04x_ALL, NWFB_NUM_08x_ALL, NWFB_NUM_09x_ALL);
...
// 02*
const GMB_NT_26_EAST = new Line("26", lineType_GMB_NT, "香港教育大學", "海柏花園", [TP_KwongFukEstate, ToloHighway_Coastal, MOS_HengHongStreet, MTR_mos_maonshan], 8).setNotes("大埔特快");
const GMB_NT_26_WEST = new Line("26", lineType_GMB_NT, "海柏花園", "香港教育大學", [MTR_mos_maonshan, MOS_HengHongStreet, ToloHighway_Coastal, TP_KwongFukEstate], 8).setNotes("大埔特快");
...
const GMB_NT_44A_NORTH = new Line('44A', lineType_GMB_NT, '屯門站', '上水站', [KCR_lrt_2_tuenmun, KCR_lrt_2_taihing, KCR_lrt_3_tinking, KCR_lrt_3_siuhong, YuenLongHighway, SunTinHighway, FanlingHighway_KwuTung, MTR_erl_sheungshui], 5).setNotes('經良景、石排；設特別車沿線開出/直往上水');
const GMB_NT_44A_SOUTH = new Line('44A', lineType_GMB_NT, '上水站', '屯門站', [MTR_erl_sheungshui, FanlingHighway_KwuTung, SunTinHighway, YuenLongHighway, KCR_lrt_3_siuhong, KCR_lrt_3_tinking, KCR_lrt_2_taihing, MTR_tml_tuenmun], 5).setNotes('經良景、石排');
...
// All 04*
const GMB_NT_NUM_04x_ALL = [GMB_NT_44_NORTH, GMB_NT_44_SOUTH, GMB_NT_44A_NORTH, GMB_NT_44A_SOUTH, GMB_NT_46_NORTH, GMB_NT_46_SOUTH];
// 06*
...
const CHT_962_EAST = new Line('962', lineType_HARBOUR, '屯門 (龍門居)', '銅鑼灣 (摩頓台)', [KCR_lrt_1_lungmun, KCR_lrt_1_tuenmunferrypier, KCR_lrt_1_samshing, CPR_GoldenBeach, CPR_SiuLam, TuenMunHighway_InterchangeEast, TuenMunHighway_TsingLungTau, TY_TingKauBridge, TY_CheungTsingTunnel, WestKowloonHighway, WestHarbourTunnel_Interchange, WestHarbourTunnel, MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_causewaybay, Moreton_CausewayBay], 1440).markCommuter().setNotes('經黃金海岸');
const CHT_962_WEST = new Line('962', lineType_HARBOUR, '銅鑼灣 (摩頓台)', '屯門 (龍門居)', [Moreton_CausewayBay, MTR_ill_causewaybay, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, WestHarbourTunnel, WestHarbourTunnel_Interchange, WestKowloonHighway, TY_CheungTsingTunnel, TY_TingKauBridge, TuenMunHighway_TsingLungTau, TuenMunHighway_InterchangeWest, CPR_SiuLam, CPR_GoldenBeach, KCR_lrt_1_samshing, KCR_lrt_1_tuenmunferrypier, KCR_lrt_1_lungmun], 1440).markCommuter().setNotes('經黃金海岸');
const CHT_962X_EAST = new Line('962X', lineType_HARBOUR, '屯門 (龍門居)', '銅鑼灣 (摩頓台)', [KCR_lrt_1_lungmun, KCR_lrt_1_tuenmunferrypier, KCR_lrt_1_samshing, TM_TuenMunTownCenter, TuenMunHighway_SoKwunWat, TuenMunHighway_InterchangeEast, TuenMunHighway_TsingLungTau, TY_TingKauBridge, TY_CheungTsingTunnel, WestKowloonHighway, WestHarbourTunnel_Interchange, WestHarbourTunnel, MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_causewaybay, Moreton_CausewayBay], 15);
const CHT_962X_WEST = new Line('962X', lineType_HARBOUR, '銅鑼灣 (摩頓台)', '屯門 (龍門居)', [Moreton_CausewayBay, MTR_ill_causewaybay, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, WestHarbourTunnel, WestHarbourTunnel_Interchange, WestKowloonHighway, TY_CheungTsingTunnel, TY_TingKauBridge, TuenMunHighway_TsingLungTau, TuenMunHighway_InterchangeWest, TuenMunHighway_SoKwunWat, TM_TuenMunTownCenter, KCR_lrt_1_samshing, KCR_lrt_1_tuenmunferrypier, KCR_lrt_1_lungmun], 15);
// All 96*
const CHT_NUM_96x_ALL = [CHT_960_NORTH, CHT_960_SOUTH, CHT_961_NORTH, CHT_961_SOUTH, CHT_962_EAST, CHT_962_WEST, CHT_962X_EAST, CHT_962X_WEST];
// 97*
...
// All 97*
const CHT_NUM_97x_ALL = [CHT_970_NORTH, CHT_970_SOUTH, CHT_970X_NORTH, CHT_970X_SOUTH, CHT_973_NORTH, CHT_973_SOUTH, KMB_978_NORTH, KMB_978_SOUTH];
...
// N6**
const CHT_N680_NORTH = new Line('N680', lineType_HARBOUR, '中環(港澳碼頭)', '錦英苑', [MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_causewaybay, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, EastHarbourTunnel, EastHarbourTunnel_Interchange, KwunTongBypass, KowloonBayFlyover, OldTatesTunnel, OldTatesTunnel_Interchange, ST_SiuLekYuenPlayground, ST_ShatinHospital, MTR_mos_taishuihang, MOS_HengHongStreet, MTR_mos_maonshan, MOS_KamYingCourt], 20).markNightOnly().setNotes('經東隧、大隧、沙田第一城、濱景花園、富安花園、恆安/耀安、馬鞍山市中心、利安');
const CHT_N680_SOUTH = new Line('N680', lineType_HARBOUR, '錦英苑', '中環(港澳碼頭)', [MOS_KamYingCourt, MTR_mos_maonshan, MOS_HengHongStreet, MTR_mos_taishuihang, ST_ShatinHospital, ST_SiuLekYuenPlayground, OldTatesTunnel_Interchange, OldTatesTunnel, KowloonBayFlyover, KwunTongBypass, EastHarbourTunnel_Interchange, EastHarbourTunnel, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_tinhau, MTR_ill_causewaybay, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan], 20).markNightOnly().setNotes('經大隧、東隧、北角、炮台山、銅鑼灣、灣仔、中環');
// All N6**
const CHT_NUM_N6xx_ALL = [CHT_N680_NORTH, CHT_N680_SOUTH];

// All Nightly CHT bus
const CHT_NUM_Nxxx_ALL = [].concat(CHT_NUM_N1xx_ALL, CHT_NUM_N6xx_ALL);
