...
const KMB_N216_WEST = new Line('N216', lineType_KMB, '油塘', '紅磡站', [MTR_ktl_yautong, KT_SauMauPing, KT_ShunLee, MTR_ktl_choihung, MTR_ktl_diamondhill, SunPoKong_Inside, PE_RegalOrientalHotel, BoundaryPrince, MTR_ktl_princeedward, MTR_ktl_mongkok, MTR_ktl_yaumatei, MTR_twl_jordan, MTR_twl_tsimshatsui, MTR_tml_easttsimshatsui, MTR_tml_hunghom], 20).markNightOnly().setNotes('經彌敦道、九龍城、新蒲崗、順利、秀茂坪、藍田半山');

// All N2**
const KMB_NUM_N2xx_ALL = [KMB_N216_EAST, KMB_N216_WEST];
...
// All 60*
const CHT_NUM_60x_ALL = [CHT_603_EAST, CHT_603_WEST, CHT_606_NORTH, CHT_606_SOUTH];
// 67*
...
// All 6**
const CHT_NUM_6xx_ALL = [].concat(CHT_NUM_60x_ALL, CHT_NUM_67x_ALL);
// 90*
