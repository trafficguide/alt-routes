...
// Shatin Matrix
const WALK_NTE_ST_STW = new Line("瀝源橋", lineType_WALK, "沙田市中心", "乙明邨", [ShatinTownCenter, ST_JatMinChuen]);
const WALK_NTE_STW_ST = new Line("瀝源橋", lineType_WALK, "乙明邨", "沙田市中心", [ST_JatMinChuen, ShatinTownCenter]);
...
const WALK_NTE_ST_LY_Cen = new Line("", lineType_WALK, "瀝源邨/禾輋邨", "沙田市中心", [ST_YuenWo, ShatinTownCenter]);
const WALK_NTE_ST_Cen_LY = new Line("", lineType_WALK, "沙田市中心", "瀝源邨/禾輋邨", [ShatinTownCenter, ST_YuenWo]);
...
const WALK_NTW_TKT_KCE_ToKH = new Line("", lineType_WALK, "葵涌邨", "葵興", [TW_KwaiChungEstate, MTR_twl_kwaihing]);
const WALK_NTW_TKT_KCE_FromKH = new Line("", lineType_WALK, "葵興", "葵涌邨", [MTR_twl_kwaihing, TW_KwaiChungEstate]);

const WALK_NTW_TSUENKWAITSING_ALL = [WALK_NTW_TKT_TWSYS_NORTH, WALK_NTW_TKT_TWSYS_SOUTH, WALK_NTW_CO_TY, WALK_NTW_TY_CO, WALK_NTW_TKT_KCE_ToTWH, WALK_NTW_TKT_KCE_FromTWH, WALK_NTW_TKT_KCE_ToKH, WALK_NTW_TKT_KCE_FromKH];
...
const KMB_33A_EAST = new Line('33A', lineType_KMB, '荃灣(如心廣場)', '旺角(柏景灣)', [TW_NinaTowers, TW_KwaiChungEstate, MTR_twl_kwaihing, MTR_twl_laiking, MTR_twl_meifoo, MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, MTR_twl_princeedward, MTR_twl_mongkok, MTR_tcl_olympic], 22);
const KMB_33A_WEST = new Line('33A', lineType_KMB, '旺角(柏景灣)', '荃灣(如心廣場)', [MTR_tcl_olympic, MTR_twl_mongkok, MTR_twl_princeedward, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok, MTR_twl_meifoo, MTR_twl_laiking, MTR_twl_kwaifong, MTR_twl_kwaihing, TW_KwaiChungEstate, TW_NinaTowers], 22);
...
// All 03*
const KMB_NUM_03x_ALL = [KMB_30X_NORTH, KMB_30X_SOUTH, KMB_33A_EAST, KMB_33A_WEST, KMB_36A_NORTH, KMB_36A_SOUTH];
...
const KMB_40X_WEST = new Line("40X", lineType_KMB, "烏溪沙站", "葵涌邨", [MTR_mos_wukaisha, KamYingCourt, MTR_mos_maonshan, HengHongStreet, MTR_mos_taishuihang, ST_ShatinHospital, ST_ShatinSeafood, ST_YuenWo, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_kwaihing, TW_KwaiChungEstate], 13);
const KMB_43X_EAST = new Line("43X", lineType_KMB, "荃灣西站", "耀安", [MTR_tml_tsuenwanwest, TW_ChungOnStreet, TW_YiPeiChuen, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ST_ShatinSeafood, ST_ShatinHospital, ChevalierGarden, MTR_mos_hengon, HengHongStreet], 13);
const KMB_43X_WEST = new Line("43X", lineType_KMB, "耀安", "荃灣西站", [HengHongStreet, MTR_mos_hengon, ChevalierGarden, ST_ShatinHospital, ST_ShatinSeafood, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_YiPeiChuen, TW_ChungOnStreet, MTR_tml_tsuenwanwest], 13);
...
const KMB_47A_EAST = new Line("47A", lineType_KMB, "葵芳南", "水泉澳", [MTR_twl_kwaifong, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ShatinTownCenter, MTR_mos_shatinwai, ST_ShuiChuenO], 30);
const KMB_47A_WEST = new Line("47A", lineType_KMB, "水泉澳", "葵芳南", [ST_ShuiChuenO, MTR_mos_shatinwai, ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_kwaihing, MTR_twl_kwaifong], 30).setNotes("早繁時間不經沙田市中心");
...
const KMB_48X_EAST = new Line("48X", lineType_KMB, "灣景花園", "禾輋邨", [TW_BelvedereGarden, MTR_twl_tsuenking, MTR_twl_tsuenwan, MTR_twl_taiwohau, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ShatinTownCenter, ST_YuenWo], 5);
const KMB_48X_WEST = new Line("48X", lineType_KMB, "禾輋邨", "灣景花園", [ST_YuenWo, ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_taiwohau, MTR_twl_tsuenwan, MTR_twl_tsuenking, TW_BelvedereGarden], 5);
const KMB_49X_EAST = new Line("49X", lineType_KMB, "青衣碼頭", "沙田廣源", [TY_TsingYiFerryPier, TY_CheungOnEstate, TW_NinaTowers, MTR_twl_tsuenwan, TW_CheungPeiShanRoad, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ShatinTownCenter, ST_BelairGardens, MTR_mos_cityone], 8);
const KMB_49X_WEST = new Line("49X", lineType_KMB, "沙田廣源", "青衣碼頭", [MTR_mos_cityone, ST_ShatinSeafood, ST_BelairGardens, ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_CheungPeiShanRoad, MTR_twl_tsuenwan, TW_NinaTowers, TY_CheungOnEstate, TY_TsingYiFerryPier], 8);
...
const KMB_80K_EAST = new Line("80K", lineType_KMB, "新翠", "愉翠苑", [MTR_erl_taiwai, TaiPoRoad_MeiLam, ShatinTownCenter, ST_YuenWo, MTR_mos_cityone], 15);
const KMB_80K_WEST = new Line("80K", lineType_KMB, "愉翠苑", "新翠", [MTR_mos_cityone, ST_YuenWo, ShatinTownCenter, TaiPoRoad_MeiLam, MTR_erl_taiwai], 15);
const KMB_80M_NORTH = new Line("80M", lineType_KMB, "九龍塘站", "穗禾苑", [MTR_erl_kowloontong, LionRockTunnel, LionRockTunnel_Interchange, LionRockTunnelHighway, ShatinTownCenter, ST_YuenWo, FoTanTsuen], 30);
...
const KMB_81_NORTH = new Line("81", lineType_KMB, "西九龍站", "禾輋", [MTR_hsr_westkowloon, MTR_twl_yaumatei, MTR_twl_mongkok, MTR_twl_princeedward, MTR_twl_shamshuipo, TaiPoRoad_KowloonReservoir, TaiPoRoad_ShatinHeights, TaiPoRoad_MeiLam, ShatinTownCenter, ST_YuenWo]);
const KMB_81_SOUTH = new Line("81", lineType_KMB, "禾輋", "西九龍站", [ST_YuenWo, ShatinTownCenter, TaiPoRoad_MeiLam, TaiPoRoad_ShatinHeights, TaiPoRoad_KowloonReservoir, MTR_twl_shamshuipo, MTR_twl_princeedward, MTR_twl_mongkok, MTR_twl_yaumatei, MTR_hsr_westkowloon]);
...
const KMB_81K_NORTH = new Line("81K", lineType_KMB, "新田圍", "穗禾苑", [ST_SunTinWai, MTR_mos_chekungtemple, MTR_mos_shatinwai, ShatinTownCenter, ST_YuenWo, FoTanTsuen], 10);
const KMB_81K_SOUTH = new Line("81K", lineType_KMB, "穗禾苑", "新田圍", [FoTanTsuen, ST_YuenWo, ShatinTownCenter, MTR_mos_shatinwai, MTR_mos_chekungtemple, ST_SunTinWai], 10);
const KMB_83K = new Line("83K", lineType_KMB, "沙田黃泥頭", "沙田市中心", [ST_KwongYuen, HangSengUniversity, MTR_mos_cityone, ST_ShatinSeafood, ST_BelairGardens, ShatinTownCenter, ST_YuenWo, MTR_mos_cityone, HangSengUniversity, ST_KwongYuen]).markCircular();
...
const KMB_85K_NORTH = new Line("85K", lineType_KMB, "沙田站", "恆安", [MTR_erl_shatin, ST_YuenWo, ST_ShatinSeafood, ST_ShatinHospital, ChevalierGarden, MTR_mos_hengon], 15);
const KMB_85K_SOUTH = new Line("85K", lineType_KMB, "恆安", "沙田站", [MTR_mos_hengon, ChevalierGarden, ST_ShatinHospital, ST_ShatinSeafood, ST_YuenWo, MTR_erl_shatin], 15);
...
const KMB_86C_WEST = new Line('86C', lineType_KMB, '馬鞍山(利安)', '長沙灣', [MOS_LeeOnEstate, KamYingCourt, MTR_mos_maonshan, HengHongStreet, MTR_mos_taishuihang, ST_ShatinHospital, ST_ShatinSeafood, ST_BelairGardens, ST_JatMinChuen, ST_SunTinWai, LionRockTunnelHighway, LionRockTunnel, KowloonTongCornwall, MTR_ktl_shekkipmei, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok], 15).setNotes('經濱景花園、沙乙博、獅隧、歌和老街、石硤尾、深水埗');
...
const KMB_88K_NORTH = new Line("88K", lineType_KMB, "顯徑", "駿景園", [MTR_tml_hinkeng, ST_LungHangEstate, MTR_erl_taiwai, TaiPoRoad_MeiLam, ShatinTownCenter, ST_YuenWo, MTR_erl_fotan, ST_RoyalAscot], 12);
const KMB_88K_SOUTH = new Line("88K", lineType_KMB, "駿景園", "顯徑", [ST_RoyalAscot, MTR_erl_fotan, ST_YuenWo, ShatinTownCenter, TaiPoRoad_MeiLam, MTR_erl_taiwai, ST_LungHangEstate, MTR_tml_hinkeng], 12);
...
const KMB_89_NORTH = new Line('89', lineType_KMB, '觀塘站', '瀝源', [MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, HungNgokHouse_ChoiHung, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, LionRockTunnel, LionRockTunnel_Interchange, ST_SunTinWai, ShatinTownCenter, ST_YuenWo], 12);
...
// 28*
const KMB_280X_NORTH = new Line("280X", lineType_KMB, "尖東麼地道", "穗禾苑", [MTR_tml_easttsimshatsui, MTR_tml_austin, EaglesNestTunnel, TsingShaInterchange, ShatinHeightsTunnel, ShatinTownCenter, ST_YuenWo, FoTanTsuen], 20).setNotes("經青沙公路");
...
const KMB_282 = new Line("282", lineType_KMB, "沙田市中心", "新田圍", [ShatinTownCenter, MTR_mos_chekungtemple, ST_SunTinWai, MTR_mos_chekungtemple, ShatinTownCenter]).markCircular();
const KMB_284 = new Line("284", lineType_KMB, "沙田巿中心", "濱景花園", [ShatinTownCenter, ST_BelairGardens, ST_ShatinSeafood, ST_BelairGardens, ShatinTownCenter], 9).markCircular();
...
// E4*
const LWB_E42_EAST = new Line('E42', lineType_LWB, '機場', '博康', [MTR_aex_airport, Airport_CathayPacificCity, MTR_tcl_tungchung, LantauLink_SiuHoWan, LantauLink_YamO, LantauLink_Interchange, LantauLink_TsingMaBridge, TY_TsingYiWest, TW_TexacoFlyover, TW_CheungPeiShanRoad, ShingMunTunnel, ShingMunTunnelHighway, TaiPoRoad_MeiLam, MTR_mos_taiwai, MTR_mos_chekungtemple, ShatinTownCenter, MTR_mos_shatinwai], 16).setNotes('經機場南部設施');
...
// 79*
const NWFB_798_EAST = new Line("798", lineType_NWFB, "火炭山尾街", "調景嶺站", [FoTanTsuen, ST_YuenWo, ShatinTownCenter, MTR_mos_shatinwai, OldTatesTunnel_Interchange, OldTatesTunnel, KowloonBayFlyover, KwunTongBypass, TseungKwanOTunnel, MTR_tko_polam, MTR_tko_hanghau, MTR_tko_tseungkwano, MTR_tko_tiukengleng], 15).setNotes("將軍澳特快");
...
// Kowloon section
// 00*
const GMB_KL_8_NORTH = new Line('8', lineType_GMB_KL, '尖沙咀 漢口道', '何文田', [MTR_tml_easttsimshatsui, MTR_tml_hunghom, MTR_tml_homantin, HMT_HoManTinEstate], 6).setNotes('經愛民邨');
const GMB_KL_8_SOUTH = new Line('8', lineType_GMB_KL, '何文田', '尖沙咀 漢口道', [HMT_HoManTinEstate, MTR_tml_homantin, MTR_tml_hunghom, MTR_tml_easttsimshatsui], 6).setNotes('經愛民邨');
// All 00*
...
// All 04*
const GMB_NT_NUM_04x_ALL = [GMB_NT_44_NORTH, GMB_NT_44_SOUTH];
// 06*
...
// All 0**
const GMB_NT_NUM_0xx_ALL = [].concat(GMB_NT_NUM_01x_ALL, GMB_NT_NUM_02x_ALL, GMB_NT_NUM_04x_ALL, GMB_NT_NUM_06x_ALL);
// 48*
...
// 80*
const GMB_NT_803_NORTH = new Line("803", lineType_GMB_NT, "顯徑", "利安", [MTR_tml_hinkeng, MTR_mos_taiwai, MTR_mos_chekungtemple, ST_JatMinChuen, ST_BelairGardens, ST_ShatinSeafood, ST_ShatinHospital, MTR_mos_taishuihang, HengHongStreet, MTR_mos_maonshan, MOS_LeeOnEstate], 15).setNotes("繁忙時間不停大水坑站");
const GMB_NT_803_SOUTH = new Line("803", lineType_GMB_NT, "利安", "顯徑", [MOS_LeeOnEstate, MTR_mos_maonshan, HengHongStreet, MTR_mos_taishuihang, ST_ShatinHospital, ST_ShatinSeafood, ST_BelairGardens, ST_JatMinChuen, MTR_mos_chekungtemple, MTR_mos_taiwai, MTR_tml_hinkeng], 15).setNotes("繁忙時間不停大水坑站");
