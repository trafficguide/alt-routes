...
// Wah Foo
var WALK_HKI_WF_ToMainRoad = new Line("", lineType_WALK, "華富邨商場", "華富邨 (石排灣道入口)", [MTR_swil_wahfoo, OuterWahFoo]);
var WALK_HKI_WF_ToInner = new Line("", lineType_WALK, "華富邨 (石排灣道入口)", "華富邨商場", [OuterWahFoo, MTR_swil_wahfoo]);
var WALK_HKI_WF_ALL = [WALK_HKI_WF_ToMainRoad, WALK_HKI_WF_ToInner];
var WALK_HKI_ALL = [].concat(WALK_HKI_CENTRAL_ALL, WALK_HKI_HKU_ALL, WALK_HKI_WF_ALL);
// Kowloon Peninsula
// Mong Kok
...
// Shatin Matrix
var WALK_NTE_ST_STW = new Line("瀝源橋", lineType_WALK, "沙田市中心", "乙明邨", [ST_ShatinTownCenter, ST_JatMinChuen]);
var WALK_NTE_STW_ST = new Line("瀝源橋", lineType_WALK, "乙明邨", "沙田市中心", [ST_JatMinChuen, ST_ShatinTownCenter]);
...
var WALK_NTE_ST_LY_Cen = new Line("", lineType_WALK, "瀝源邨/禾輋邨", "沙田市中心", [ST_YuenWo, ST_ShatinTownCenter]);
var WALK_NTE_ST_Cen_LY = new Line("", lineType_WALK, "沙田市中心", "瀝源邨/禾輋邨", [ST_ShatinTownCenter, ST_YuenWo]);
...
var WALK_NTE_ST_CS = new Line("獅子橋", lineType_WALK, "沙田市中心", "秦石邨", [ST_ShatinTownCenter, MTR_mos_chekungtemple]);
var WALK_NTE_CS_ST = new Line("獅子橋", lineType_WALK, "秦石邨", "沙田市中心", [MTR_mos_chekungtemple, ST_ShatinTownCenter]);
...
var WALK_NTW_TKT_KCE_ToKH = new Line("", lineType_WALK, "葵涌邨", "葵興站", [TW_KwaiChungEstate, MTR_twl_kwaihing]);
var WALK_NTW_TKT_KCE_FromKH = new Line("", lineType_WALK, "葵興站", "葵涌邨", [MTR_twl_kwaihing, TW_KwaiChungEstate]);
var WALK_NTW_TKT_KH_ToCPR = new Line("", lineType_WALK, "葵興站", "青山公路 (葵涌)", [MTR_twl_kwaihing, CPRoad_KwaiChung]);
var WALK_NTW_TKT_KH_FromCPR = new Line("", lineType_WALK, "青山公路 (葵涌)", "葵興站", [CPRoad_KwaiChung, MTR_twl_kwaihing]);
var WALK_NTW_TKT_LK_ToMTR = new Line("", lineType_WALK, "葵涌道荔景邨站", "荔景站", [TW_LowerLaiKing, MTR_twl_laiking]);
var WALK_NTW_TKT_LK_ToLower = new Line("", lineType_WALK, "荔景站", "葵涌道荔景邨站", [MTR_twl_laiking, TW_LowerLaiKing]);
var WALK_NTW_TSUENKWAITSING_ALL = [WALK_NTW_TKT_TWSYS_NORTH, WALK_NTW_TKT_TWSYS_SOUTH, WALK_NTW_CO_TY, WALK_NTW_TY_CO, WALK_NTW_TKT_KCE_ToTWH, WALK_NTW_TKT_KCE_FromTWH, WALK_NTW_TKT_KCE_ToKH, WALK_NTW_TKT_KCE_FromKH, WALK_NTW_TKT_KH_ToCPR, WALK_NTW_TKT_KH_FromCPR, WALK_NTW_TKT_LK_ToMTR, WALK_NTW_TKT_LK_ToLower];
// Yuen Long
...
var KMB_2F_EAST = new Line('2F', lineType_KMB, '長沙灣', '慈雲山北', [MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, MTR_ktl_shekkipmei, KowloonTongCornwall, MTR_ktl_lokfu, MTR_ktl_wongtaisin], 20).setNotes('經樂富、歌和老街、南昌街');
var KMB_2F_WEST = new Line('2F', lineType_KMB, '慈雲山北', '長沙灣', [MTR_ktl_wongtaisin, MTR_ktl_lokfu, KowloonTongCornwall, MTR_ktl_shekkipmei, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok], 20).setNotes('經樂富、歌和老街、南昌街');
var KMB_3C_NORTH = new Line('3C', lineType_KMB, '中港碼頭', '慈雲山(北)', [MTR_tml_austin, MTR_twl_jordan, MTR_ktl_yaumatei, MTR_ktl_mongkok, KowloonHospital, MTR_ktl_kowloontong, MTR_ktl_lokfu, MTR_ktl_wongtaisin], 15).setNotes('每日 06:15-00:40');
var KMB_3C_SOUTH = new Line('3C', lineType_KMB, '慈雲山(北)', '中港碼頭', [MTR_ktl_wongtaisin, MTR_ktl_lokfu, MTR_ktl_kowloontong, MK_FlowerMarket, MTR_ktl_princeedward, MTR_ktl_mongkok, MTR_ktl_yaumatei, MTR_twl_jordan, MTR_tml_austin], 15).setNotes('每日 05:30-23:50');
...
// All 00*
var KMB_NUM_00x_ALL = [KMB_1_NORTH, KMB_1_SOUTH, KMB_2F_EAST, KMB_2F_WEST, KMB_3C_NORTH, KMB_3C_SOUTH, KMB_6_NORTH, KMB_6_SOUTH, KMB_6D_EAST, KMB_6D_WEST];
// 01*
...
var KMB_33A_EAST = new Line('33A', lineType_KMB, '荃灣(如心廣場)', '旺角(柏景灣)', [TW_NinaTowers, TW_KwaiChungEstate, MTR_twl_kwaihing, TW_LowerLaiKing, MTR_twl_meifoo, MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, MTR_twl_princeedward, MTR_twl_mongkok, MTR_tcl_olympic], 22);
var KMB_33A_WEST = new Line('33A', lineType_KMB, '旺角(柏景灣)', '荃灣(如心廣場)', [MTR_tcl_olympic, MTR_twl_mongkok, MTR_twl_princeedward, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok, MTR_twl_meifoo, TW_LowerLaiKing, MTR_twl_kwaifong, MTR_twl_kwaihing, TW_KwaiChungEstate, TW_NinaTowers], 22);
var KMB_35A_NORTH = new Line('35A', lineType_KMB, '尖東', '葵涌安蔭邨', [MTR_tml_easttsimshatsui, MTR_twl_tsimshatsui, MTR_twl_jordan, MTR_twl_yaumatei, MTR_twl_mongkok, MTR_twl_princeedward, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok, MTR_twl_meifoo, CPRoad_KwaiChung, TW_ShekLei], 13).setNotes('經青山公路往返安蔭');
var KMB_35A_SOUTH = new Line('35A', lineType_KMB, '葵涌安蔭邨', '尖東', [TW_ShekLei, CPRoad_KwaiChung, MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, MTR_twl_princeedward, MTR_twl_mongkok, MTR_twl_yaumatei, MTR_twl_jordan, MTR_twl_tsimshatsui, MTR_tml_easttsimshatsui], 13).setNotes('經青山公路往返安蔭');
var KMB_36A_NORTH = new Line("36A", lineType_KMB, "長沙灣深旺道", "梨木樹", [MTR_tml_namcheong, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok, MTR_twl_meifoo, LaiKingChokePoint, TW_LowerLaiKing, MTR_twl_kwaifong, TW_LeiMukShueEstate], 20);
var KMB_36A_SOUTH = new Line("36A", lineType_KMB, "梨木樹", "長沙灣深旺道", [TW_LeiMukShueEstate, MTR_twl_kwaihing, TW_LowerLaiKing, LaiKingChokePoint, MTR_twl_meifoo, MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, MTR_tml_namcheong], 20);
// All 03*
var KMB_NUM_03x_ALL = [KMB_30X_NORTH, KMB_30X_SOUTH, KMB_33A_EAST, KMB_33A_WEST, KMB_35A_NORTH, KMB_35A_SOUTH, KMB_36A_NORTH, KMB_36A_SOUTH];
// 04*
...
var KMB_40X_WEST = new Line("40X", lineType_KMB, "烏溪沙站", "葵涌邨", [MTR_mos_wukaisha, MOS_KamYingCourt, MTR_mos_maonshan, MOS_HengHongStreet, MTR_mos_taishuihang, ST_ShatinHospital, ST_ShatinSeafood, ST_YuenWo, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_kwaihing, TW_KwaiChungEstate], 13);
var KMB_43X_EAST = new Line("43X", lineType_KMB, "荃灣西站", "耀安", [MTR_tml_tsuenwanwest, TW_ChungOnStreet, TW_YiPeiChuen, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ST_ShatinSeafood, ST_ShatinHospital, MOS_ChevalierGarden, MTR_mos_hengon, MOS_HengHongStreet], 13);
var KMB_43X_WEST = new Line("43X", lineType_KMB, "耀安", "荃灣西站", [MOS_HengHongStreet, MTR_mos_hengon, MOS_ChevalierGarden, ST_ShatinHospital, ST_ShatinSeafood, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_YiPeiChuen, TW_ChungOnStreet, MTR_tml_tsuenwanwest], 13);
...
var KMB_47A_EAST = new Line("47A", lineType_KMB, "葵芳南", "水泉澳", [MTR_twl_kwaifong, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ST_ShatinTownCenter, MTR_mos_shatinwai, ST_ShuiChuenO], 30);
var KMB_47A_WEST = new Line("47A", lineType_KMB, "水泉澳", "葵芳南", [ST_ShuiChuenO, MTR_mos_shatinwai, ST_ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_kwaihing, MTR_twl_kwaifong], 30).setNotes("早繁時間不經沙田市中心");
var KMB_47X_EAST = new Line("47X", lineType_KMB, "葵盛東", "秦石", [MTR_twl_kwaifong, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ST_ShatinTownCenter, MTR_mos_shatinwai, MTR_mos_chekungtemple], 8);
var KMB_47X_WEST = new Line("47X", lineType_KMB, "秦石", "葵盛東", [MTR_mos_chekungtemple, MTR_mos_shatinwai, ST_ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_kwaihing, MTR_twl_kwaifong], 8).setNotes("早繁時間不經沙田市中心");
var KMB_48X_EAST = new Line("48X", lineType_KMB, "灣景花園", "禾輋邨", [TW_BelvedereGarden, MTR_twl_tsuenking, MTR_twl_tsuenwan, MTR_twl_taiwohau, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ST_ShatinTownCenter, ST_YuenWo], 5);
var KMB_48X_WEST = new Line("48X", lineType_KMB, "禾輋邨", "灣景花園", [ST_YuenWo, ST_ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_taiwohau, MTR_twl_tsuenwan, MTR_twl_tsuenking, TW_BelvedereGarden], 5);
var KMB_49X_EAST = new Line("49X", lineType_KMB, "青衣碼頭", "沙田廣源", [TY_TsingYiFerryPier, TY_CheungOnEstate, TW_NinaTowers, MTR_twl_tsuenwan, TW_CheungPeiShanRoad, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ST_ShatinTownCenter, ST_BelairGardens, MTR_mos_cityone], 8);
var KMB_49X_WEST = new Line("49X", lineType_KMB, "沙田廣源", "青衣碼頭", [MTR_mos_cityone, ST_ShatinSeafood, ST_BelairGardens, ST_ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_CheungPeiShanRoad, MTR_twl_tsuenwan, TW_NinaTowers, TY_CheungOnEstate, TY_TsingYiFerryPier], 8);
// All 04*
...
var KMB_68M_NORTH = new Line('68M', lineType_KMB, '荃灣站巴士總站', '元朗（西）總站', [MTR_twl_tsuenwan, MTR_twl_tsuenking, TuenMunHighway_YauKomTau, TaiLamTunnel, TaiLamTunnel_Interchange, TsingLongHighway, KCR_lrt_5_yuenlong, KCR_lrt_5_fungninroad], 12).setNotes('星期一至日 06:10-00:50');
var KMB_68M_SOUTH = new Line('68M', lineType_KMB, '元朗（西）總站', '荃灣站巴士總站', [KCR_lrt_5_fungninroad, KCR_lrt_5_yuenlong, TsingLongHighway, TaiLamTunnel_Interchange, TaiLamTunnel, TuenMunHighway_YauKomTau, MTR_twl_tsuenking, MTR_twl_tsuenwan], 12).setNotes('星期一至日 05:30-00:10');
...
var KMB_69M_NORTH = new Line('69M', lineType_KMB, '葵芳鐵路站', '天水圍市中心', [MTR_twl_kwaifong, MTR_twl_taiwohau, TW_ChungOnStreet, MTR_twl_tsuenking, TuenMunHighway_YauKomTau, TaiLamTunnel, TaiLamTunnel_Interchange, TsingLongHighway, YuenLongHighway, LongTinRoad, MTR_tml_tinshuiwai, KCR_lrt_4_tinshui, KCR_lrt_4_tinwing], 15).setNotes('星期一至日 06:15-00:45');
var KMB_69M_SOUTH = new Line('69M', lineType_KMB, '天水圍市中心', '葵芳鐵路站', [KCR_lrt_4_tinwing, KCR_lrt_4_tinshui, MTR_tml_tinshuiwai, LongTinRoad, YuenLongHighway, TsingLongHighway, TaiLamTunnel_Interchange, TaiLamTunnel, TuenMunHighway_YauKomTau, MTR_twl_tsuenking, TW_ChungOnStreet, MTR_twl_taiwohau, MTR_twl_kwaihing, MTR_twl_kwaifong], 15).setNotes('星期一至日 05:10-23:55');
// All 06*
var KMB_NUM_06x_ALL = [KMB_64K_EAST, KMB_64K_WEST, KMB_67M_EAST, KMB_67M_WEST, KMB_68E_NORTH, KMB_68E_SOUTH, KMB_68M_NORTH, KMB_68M_SOUTH, KMB_68X_EAST, KMB_68X_WEST, KMB_69M_NORTH, KMB_69M_SOUTH];
// 07*
var KMB_72_NORTH = new Line("72", lineType_KMB, "長沙灣", "大埔太和", [MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, TaiPoRoad_KowloonReservoir, TaiPoRoad_ShatinHeights, TaiPoRoad_MeiLam, MTR_erl_shatin, ST_YuenWo, TaiPoRoad_Shatin, TaiPoRoad_CUHK, TaiPoRoad_TaiPoKau, TP_KwongFukEstate, KwongFukRoad, MTR_erl_taiwo], 20);
var KMB_72_SOUTH = new Line("72", lineType_KMB, "大埔太和", "長沙灣", [MTR_erl_taiwo, WanTauKokLane, TP_KwongFukEstate, TaiPoRoad_TaiPoKau, TaiPoRoad_CUHK, TaiPoRoad_Shatin, ST_YuenWo, MTR_erl_shatin, TaiPoRoad_ShatinHeights, TaiPoRoad_KowloonReservoir, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok], 20);
var KMB_72A_NORTH = new Line("72A", lineType_KMB, "大圍站", "大埔工業邨", [MTR_erl_taiwai, MTR_mos_chekungtemple, ST_JatMinChuen, ST_YuenWo, TaiPoRoad_Shatin, TaiPoRoad_CUHK, TaiPoRoad_TaiPoKau, TP_KwongFukEstate, KwongFukRoad], 30).setNotes("設有雙程分段收費");
var KMB_72A_SOUTH = new Line("72A", lineType_KMB, "大埔工業邨", "大圍站", [WanTauKokLane, TP_KwongFukEstate, TaiPoRoad_TaiPoKau, TaiPoRoad_CUHK, TaiPoRoad_Shatin, ST_YuenWo, ST_JatMinChuen, MTR_erl_taiwai], 30).setNotes("設有雙程分段收費");
var KMB_72X_NORTH = new Line("72X", lineType_KMB, "旺角(柏景灣)", "大埔中心", [MTR_tcl_olympic, MTR_ktl_mongkok, MTR_erl_kowloontong, LionRockTunnel, LionRockTunnel_Interchange, TaiPoRoad_Shatin, TP_KwongFukEstate, KwongFukRoad]).setNotes("大埔特快");
var KMB_72X_SOUTH = new Line("72X", lineType_KMB, "大埔中心", "旺角(柏景灣)", [WanTauKokLane, TP_KwongFukEstate, TaiPoRoad_Shatin, LionRockTunnel_Interchange, LionRockTunnel, MTR_erl_kowloontong, MTR_ktl_mongkok, MTR_tcl_olympic]).setNotes("大埔特快");
...
var KMB_73A_NORTH = new Line("73A", lineType_KMB, "愉翠苑", "粉嶺華明", [MTR_mos_cityone, MTR_erl_fotan, TaiPoRoad_Shatin, TaiPoRoad_CUHK, TaiPoRoad_TaiPoKau, TP_KwongFukEstate, KwongFukRoad, MTR_erl_taiwo, TaiPoRoad_HongLokYuen, TaiPoRoad_KiuTau, FL_WahMing], 30);
var KMB_73A_SOUTH = new Line("73A", lineType_KMB, "粉嶺華明", "愉翠苑", [FL_WahMing, TaiPoRoad_KiuTau, TaiPoRoad_HongLokYuen, MTR_erl_taiwo, WanTauKokLane, TP_KwongFukEstate, TaiPoRoad_TaiPoKau, TaiPoRoad_CUHK, TaiPoRoad_Shatin, MTR_erl_fotan, MTR_mos_cityone], 30).setNotes("設有雙程分段收費");
var KMB_73X_NORTH = new Line("73X", lineType_KMB, "荃灣(如心廣場)", "富善邨", [TW_NinaTowers, TW_ChungOnStreet, MTR_twl_taiwohau, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, TaiPoRoad_Shatin, ToloHighway_Coastal, TP_KwongFukEstate, KwongFukRoad]).setNotes("大埔特快");
var KMB_73X_SOUTH = new Line("73X", lineType_KMB, "富善邨", "荃灣(如心廣場)", [WanTauKokLane, TP_KwongFukEstate, ToloHighway_Coastal, TaiPoRoad_Shatin, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_taiwohau, TW_ChungOnStreet, TW_NinaTowers]).setNotes("大埔特快");
var KMB_74A_NORTH = new Line("74A", lineType_KMB, "啟業", "太和", [KowloonBayCommercial, HungNgokHouse_ChoiHung, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, LionRockTunnel, LionRockTunnel_Interchange, LionRockTunnelHighway, ST_JatMinChuen, ST_BelairGardens, TaiPoRoad_Shatin, TaiPoRoad_CUHK, TaiPoRoad_TaiPoKau, TP_KwongFukEstate, MTR_erl_taiwo], 60).setNotes("班次疏落");
var KMB_74A_SOUTH = new Line("74A", lineType_KMB, "太和", "啟業", [MTR_erl_taiwo, TP_KwongFukEstate, TaiPoRoad_TaiPoKau, TaiPoRoad_CUHK, TaiPoRoad_Shatin, ST_BelairGardens, ST_JatMinChuen, LionRockTunnelHighway, LionRockTunnel_Interchange, LionRockTunnel, MTR_ktl_wongtaisin, MTR_ktl_diamondhill, ChoiHungBusTerminus, KowloonBayCommercial], 60).setNotes("班次疏落");
var KMB_74D_NORTH = new Line('74D', lineType_KMB, '觀塘碼頭', '九龍坑', [MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, HungNgokHouse_ChoiHung, OldTatesTunnel, OldTatesTunnel_Interchange, SciencePark, PakShekKok, ToloHighway_Coastal, TP_KwongFukEstate, MTR_erl_taiwo, TaiPoRoad_HongLokYuen, TaiPoRoad_KiuTau], 60).setNotes('班次疏落，經科學園及白石角');
var KMB_74D_SOUTH = new Line('74D', lineType_KMB, '九龍坑', '觀塘碼頭', [TaiPoRoad_KiuTau, TaiPoRoad_HongLokYuen, MTR_erl_taiwo, TP_KwongFukEstate, ToloHighway_Coastal, PakShekKok, SciencePark, OldTatesTunnel_Interchange, OldTatesTunnel, ChoiHungBusTerminus, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, KT_FerryPier], 60).setNotes('班次疏落，經科學園及白石角');
var KMB_74X_NORTH = new Line('74X', lineType_KMB, '觀塘碼頭', '大埔中心', [KT_FerryPier, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, HungNgokHouse_ChoiHung, MTR_ktl_diamondhill, OldTatesTunnel, OldTatesTunnel_Interchange, ToloHighway_Coastal, TP_KwongFukEstate], 7).setNotes('經新蒲崗，鑽石山，大老山');
var KMB_74X_SOUTH = new Line('74X', lineType_KMB, '大埔中心', '觀塘碼頭', [TP_KwongFukEstate, ToloHighway_Coastal, OldTatesTunnel_Interchange, OldTatesTunnel, ChoiHungBusTerminus, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, KT_FerryPier], 7).setNotes('經大老山，彩虹');
// All 07*
var KMB_NUM_07x_ALL = [KMB_72_NORTH, KMB_72_SOUTH, KMB_72A_NORTH, KMB_72A_SOUTH, KMB_73_NORTH, KMB_73_SOUTH, KMB_73A_NORTH, KMB_73A_SOUTH, KMB_73X_NORTH, KMB_73X_SOUTH, KMB_74A_NORTH, KMB_74A_SOUTH, KMB_74D_NORTH, KMB_74D_SOUTH, KMB_74X_NORTH, KMB_74X_SOUTH];
// 08*
...
var KMB_80K_EAST = new Line("80K", lineType_KMB, "新翠", "愉翠苑", [MTR_erl_taiwai, TaiPoRoad_MeiLam, ST_ShatinTownCenter, ST_YuenWo, MTR_mos_cityone], 15);
var KMB_80K_WEST = new Line("80K", lineType_KMB, "愉翠苑", "新翠", [MTR_mos_cityone, ST_YuenWo, ST_ShatinTownCenter, TaiPoRoad_MeiLam, MTR_erl_taiwai], 15);
var KMB_80M_NORTH = new Line("80M", lineType_KMB, "九龍塘站", "穗禾苑", [MTR_erl_kowloontong, LionRockTunnel, LionRockTunnel_Interchange, LionRockTunnelHighway, ST_ShatinTownCenter, ST_YuenWo, FoTanTsuen], 30);
...
var KMB_81_NORTH = new Line("81", lineType_KMB, "西九龍站", "禾輋", [MTR_hsr_westkowloon, MTR_twl_yaumatei, MTR_twl_mongkok, MTR_twl_princeedward, MTR_twl_shamshuipo, TaiPoRoad_KowloonReservoir, TaiPoRoad_ShatinHeights, TaiPoRoad_MeiLam, ST_ShatinTownCenter, ST_YuenWo]);
var KMB_81_SOUTH = new Line("81", lineType_KMB, "禾輋", "西九龍站", [ST_YuenWo, ST_ShatinTownCenter, TaiPoRoad_MeiLam, TaiPoRoad_ShatinHeights, TaiPoRoad_KowloonReservoir, MTR_twl_shamshuipo, MTR_twl_princeedward, MTR_twl_mongkok, MTR_twl_yaumatei, MTR_hsr_westkowloon]);
...
var KMB_81K_NORTH = new Line("81K", lineType_KMB, "新田圍", "穗禾苑", [ST_SunTinWai, MTR_mos_chekungtemple, MTR_mos_shatinwai, ST_ShatinTownCenter, ST_YuenWo, FoTanTsuen], 10);
var KMB_81K_SOUTH = new Line("81K", lineType_KMB, "穗禾苑", "新田圍", [FoTanTsuen, ST_YuenWo, ST_ShatinTownCenter, MTR_mos_shatinwai, MTR_mos_chekungtemple, ST_SunTinWai], 10);
var KMB_82X = new Line('82X', lineType_KMB, '濱景花園', '黃大仙', [MTR_mos_cityone, ST_KwongYuen, OldTatesTunnel_Interchange, OldTatesTunnel, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, MTR_ktl_diamondhill, OldTatesTunnel, OldTatesTunnel_Interchange, ST_KwongYuen, MTR_mos_cityone], 12).markCircular();
var KMB_83K = new Line("83K", lineType_KMB, "沙田黃泥頭", "沙田市中心", [ST_KwongYuen, HangSengUniversity, MTR_mos_cityone, ST_ShatinSeafood, ST_BelairGardens, ST_ShatinTownCenter, ST_YuenWo, MTR_mos_cityone, HangSengUniversity, ST_KwongYuen]).markCircular();
var KMB_84M_NORTH = new Line('84M', lineType_KMB, '樂富', '富安花園', [MTR_ktl_lokfu, MTR_ktl_wongtaisin, MTR_ktl_diamondhill, OldTatesTunnel, OldTatesTunnel_Interchange, MTR_mos_cityone, ST_ShatinHospital, MOS_ChevalierGarden], 20);
var KMB_84M_SOUTH = new Line('84M', lineType_KMB, '富安花園', '樂富', [MOS_ChevalierGarden, ST_ShatinHospital, MTR_mos_cityone, OldTatesTunnel_Interchange, OldTatesTunnel, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, MTR_ktl_lokfu], 20);
...
var KMB_85K_NORTH = new Line("85K", lineType_KMB, "沙田站", "恆安", [MTR_erl_shatin, ST_YuenWo, ST_ShatinSeafood, ST_ShatinHospital, MOS_ChevalierGarden, MTR_mos_hengon], 15);
var KMB_85K_SOUTH = new Line("85K", lineType_KMB, "恆安", "沙田站", [MTR_mos_hengon, MOS_ChevalierGarden, ST_ShatinHospital, ST_ShatinSeafood, ST_YuenWo, MTR_erl_shatin], 15);
...
var KMB_87K = new Line("87K", lineType_KMB, "大學站", "錦英苑", [MTR_erl_university, MOS_HengHongStreet, MTR_mos_maonshan, MOS_KamYingCourt, MTR_mos_maonshan, MOS_HengHongStreet, MTR_erl_university], 8).markCircular();
var KMB_87S = new Line("87S", lineType_KMB, "大學站", "錦英苑", [MTR_erl_university, MOS_KamYingCourt, MaOnShanRoad, MTR_erl_university], 10).markCircular();
var KMB_88K_NORTH = new Line("88K", lineType_KMB, "顯徑", "駿景園", [MTR_tml_hinkeng, ST_LungHangEstate, MTR_erl_taiwai, TaiPoRoad_MeiLam, ST_ShatinTownCenter, ST_YuenWo, MTR_erl_fotan, ST_RoyalAscot], 12);
var KMB_88K_SOUTH = new Line("88K", lineType_KMB, "駿景園", "顯徑", [ST_RoyalAscot, MTR_erl_fotan, ST_YuenWo, ST_ShatinTownCenter, TaiPoRoad_MeiLam, MTR_erl_taiwai, ST_LungHangEstate, MTR_tml_hinkeng], 12);
...
var KMB_89_NORTH = new Line('89', lineType_KMB, '觀塘站', '瀝源', [MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, HungNgokHouse_ChoiHung, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, LionRockTunnel, LionRockTunnel_Interchange, ST_SunTinWai, ST_ShatinTownCenter, ST_YuenWo], 12);
...
// 21*
var KMB_214_EAST = new Line('214', lineType_KMB, '長沙灣 (甘泉街)', '油塘', [MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, MTR_ktl_shekkipmei, ChingCheungRoad_BeaconHill, MTR_ktl_wongtaisin, MTR_ktl_diamondhill, MTR_ktl_choihung, KT_ShunLeeEstate, KT_Anderson, KT_PoTatEstate, KT_KwongTin, MTR_ktl_yautong], 15);
var KMB_214_WEST = new Line('214', lineType_KMB, '油塘', '長沙灣 (甘泉街)', [MTR_ktl_yautong, KT_KwongTin, KT_PoTatEstate, KT_Anderson, MTR_ktl_choihung, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, ChingCheungRoad_BeaconHill, MTR_ktl_shekkipmei, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok], 15);
...
// All 21*
var KMB_NUM_21x_ALL = [KMB_214_EAST, KMB_214_WEST, KMB_215X_EAST, KMB_215X_WEST, KMB_216M];
// 23*
...
// 24*
var KMB_249X_EAST = new Line('249X', lineType_KMB, '青衣站', '沙田 (博康)', [MTR_tcl_tsingyi, TY_TsingYiWest, TY_CheungTsingEstate, TY_SouthBridge, LaiKingChokePoint, EaglesNestTunnel, TsingShaInterchange, ShatinHeightsTunnel, MTR_erl_taiwai, MTR_mos_chekungtemple, ST_ShatinTownCenter, MTR_mos_shatinwai], 25).setNotes('經長青邨、青沙公路');
...
var KMB_271_NORTH = new Line('271', lineType_KMB, '佐敦(西九龍站)', '大埔(富亨)', [TP_KwongFukEstate, ToloHighway_Coastal, TaiPoRoad_Shatin, LionRockTunnelHighway, LionRockTunnel, MTR_erl_kowloontong, KowloonHospital, MTR_ktl_yaumatei, MTR_twl_jordan, MTR_twl_tsimshatsui, MTR_tml_austin], 10).setNotes('經尖沙咀,佐敦,油麻地,何文田,九龍塘,獅隧');
var KMB_271_SOUTH = new Line('271', lineType_KMB, '大埔(富亨)', '佐敦(西九龍站)', [MTR_tml_austin, MTR_twl_tsimshatsui, MTR_twl_jordan, MTR_ktl_yaumatei, KowloonHospital, MTR_erl_kowloontong, LionRockTunnel, LionRockTunnelHighway, TaiPoRoad_Shatin, ToloHighway_Coastal, TP_KwongFukEstate], 10).setNotes('經九龍塘,何文田,油麻地,佐敦,尖沙咀');
...
// All 27*
var KMB_NUM_27x_ALL = [KMB_270A_NORTH, KMB_270A_SOUTH, KMB_271_NORTH, KMB_271_SOUTH, KMB_273, KMB_273A, KMB_273D, KMB_278X_NORTH, KMB_278X_SOUTH];
// 28*
var KMB_280X_NORTH = new Line("280X", lineType_KMB, "尖東麼地道", "穗禾苑", [MTR_tml_easttsimshatsui, MTR_tml_austin, EaglesNestTunnel, TsingShaInterchange, ShatinHeightsTunnel, ST_ShatinTownCenter, ST_YuenWo, FoTanTsuen], 20).setNotes("經青沙公路");
...
var KMB_282 = new Line("282", lineType_KMB, "沙田市中心", "新田圍", [ST_ShatinTownCenter, MTR_mos_chekungtemple, ST_SunTinWai, MTR_mos_chekungtemple, ST_ShatinTownCenter]).markCircular();
var KMB_284 = new Line("284", lineType_KMB, "沙田巿中心", "濱景花園", [ST_ShatinTownCenter, ST_BelairGardens, ST_ShatinSeafood, ST_BelairGardens, ST_ShatinTownCenter], 9).markCircular();
var KMB_286M = new Line('286M', lineType_KMB, '馬鞍山市中心', '鑽石山站', [MTR_mos_maonshan, MTR_mos_hengon, MTR_mos_taishuihang, ST_ShatinHospital, OldTatesTunnel_Interchange, OldTatesTunnel, MTR_ktl_diamondhill, OldTatesTunnel, OldTatesTunnel_Interchange, ST_ShatinHospital, MTR_mos_taishuihang, MTR_mos_hengon, MTR_mos_maonshan], 20).markCircular().setNotes('每日 05:30-00:00');
...
var KMB_289K = new Line("289K", lineType_KMB, "大學站", "富安花園", [MTR_erl_university, MTR_mos_hengon, MOS_ChevalierGarden, MTR_mos_hengon, MTR_erl_university], 15).markCircular();
// All 28*
var KMB_NUM_28x_ALL = [KMB_280X_NORTH, KMB_280X_SOUTH, KMB_281A_NORTH, KMB_281A_SOUTH, KMB_281M_NORTH, KMB_281M_SOUTH, KMB_282, KMB_284, KMB_286M, KMB_286X, KMB_287X, KMB_288, KMB_289K];
// 29*
var KMB_290_EAST = new Line('290', lineType_KMB, '荃灣西站', '調景嶺（彩明）', [MTR_tml_tsuenwanwest, TW_ChungOnStreet, MTR_twl_taiwohau, MTR_twl_kwaihing, TW_LowerLaiKing, LaiKingChokePoint, ChingCheungRoad_Other, ChingCheungRoad_BeaconHill, MTR_ktl_wongtaisin, MTR_ktl_choihung, KT_SauMauPing_NonStop, KT_PoTatEstate, TKO_HongSingGarden, MTR_tko_polam, MTR_tko_hanghau, MTR_tko_tseungkwano, MTR_tko_tiukengleng], 20).setNotes('經將軍澳市中心、坑口、寶林、翠林、寶達邨、秀茂坪道、順利邨道、彩雲邨、彩虹、黃大仙、葵涌道、大窩口站、荃灣市中心');
var KMB_290_WEST = new Line('290', lineType_KMB, '調景嶺（彩明）', '荃灣西站', [MTR_tko_tiukengleng, MTR_tko_tseungkwano, MTR_tko_hanghau, MTR_tko_polam, TKO_HongSingGarden, KT_PoTatEstate, KT_SauMauPing_NonStop, MTR_ktl_choihung, HungNgokHouse_ChoiHung, MTR_ktl_wongtaisin, ChingCheungRoad_BeaconHill, ChingCheungRoad_Other, LaiKingChokePoint, TW_LowerLaiKing, MTR_twl_kwaifong, MTR_twl_taiwohau, TW_ChungOnStreet, MTR_tml_tsuenwanwest], 20).setNotes('經將軍澳市中心、坑口、寶林、翠林、寶達邨、秀茂坪道、順利邨道、彩雲邨、彩虹、黃大仙、葵涌道、大窩口站、荃灣市中心');
var KMB_290A_EAST = new Line('290A', lineType_KMB, '荃灣西站', '調景嶺（彩明）', [MTR_tml_tsuenwanwest, TW_ChungOnStreet, MTR_twl_taiwohau, MTR_twl_kwaihing, TW_LowerLaiKing, LaiKingChokePoint, ChingCheungRoad_Other, ChingCheungRoad_BeaconHill, MTR_ktl_wongtaisin, MTR_ktl_choihung, KT_ShunLeeEstate, KT_SauMauPing, KT_PoTatEstate, TKO_HongSingGarden, MTR_tko_polam, MTR_tko_hanghau, MTR_tko_tseungkwano, MTR_tko_tiukengleng], 20).setNotes('經將軍澳市中心、坑口、寶林、翠林、秀茂坪、四順、彩雲邨、彩虹、黃大仙、葵涌道、大窩口站、荃灣市中心');
var KMB_290A_WEST = new Line('290A', lineType_KMB, '調景嶺（彩明）', '荃灣西站', [MTR_tko_tiukengleng, MTR_tko_tseungkwano, MTR_tko_hanghau, MTR_tko_polam, TKO_HongSingGarden, KT_PoTatEstate, KT_SauMauPing, KT_ShunLeeEstate, MTR_ktl_choihung, HungNgokHouse_ChoiHung, MTR_ktl_wongtaisin, ChingCheungRoad_BeaconHill, ChingCheungRoad_Other, LaiKingChokePoint, TW_LowerLaiKing, MTR_twl_kwaifong, MTR_twl_taiwohau, TW_ChungOnStreet, MTR_tml_tsuenwanwest], 20).setNotes('經將軍澳市中心、坑口、寶林、翠林、秀茂坪、四順、彩雲邨、彩虹、黃大仙、葵涌道、大窩口站、荃灣市中心');
var KMB_290B_WEST = new Line('290B', lineType_KMB, '將軍澳工業邨', '荃灣西站', [MTR_tko_lohaspark, MTR_tko_tseungkwano, MTR_tko_polam, TKO_HongSingGarden, KT_PoTatEstate, KT_SauMauPing_NonStop, MTR_ktl_choihung, HungNgokHouse_ChoiHung, MTR_ktl_wongtaisin, ChingCheungRoad_Other, LaiKingChokePoint, TW_LowerLaiKing, MTR_twl_kwaifong, MTR_twl_taiwohau, TW_ChungOnStreet, MTR_tml_tsuenwanwest], 1440).markCommuter().setNotes('由將軍澳工業邨開出一班(17:15)單向前往荃灣西站。');
var KMB_290X_EAST = new Line('290X', lineType_KMB, '荃灣西站', '康城站', [MTR_tml_tsuenwanwest, TW_ChungOnStreet, MTR_twl_taiwohau, MTR_twl_kwaihing, TW_LowerLaiKing, LaiKingChokePoint, ChingCheungRoad_Other, ChingCheungRoad_BeaconHill, MTR_ktl_wongtaisin, MTR_ktl_choihung, KT_Anderson, TKO_HongSingGarden, MTR_tko_polam, MTR_tko_tiukengleng, MTR_tko_tseungkwano, MTR_tko_lohaspark], 30).setNotes('經百勝角、將軍澳市中心、調景嶺、寶林、翠林、安達/安泰、彩雲邨、彩虹、黃大仙、葵涌、大窩口站、荃灣市中心');
var KMB_290X_WEST = new Line('290X', lineType_KMB, '康城站', '荃灣西站', [MTR_tko_lohaspark, MTR_tko_tseungkwano, MTR_tko_tiukengleng, MTR_tko_polam, TKO_HongSingGarden, KT_Anderson, MTR_ktl_choihung, HungNgokHouse_ChoiHung, MTR_ktl_wongtaisin, ChingCheungRoad_BeaconHill, ChingCheungRoad_Other, LaiKingChokePoint, TW_LowerLaiKing, MTR_twl_kwaifong, MTR_twl_taiwohau, TW_ChungOnStreet, MTR_tml_tsuenwanwest], 30).setNotes('經百勝角、將軍澳市中心、調景嶺、寶林、翠林、安達/安泰、彩雲邨、彩虹、黃大仙、葵涌、大窩口站、荃灣市中心');
var KMB_296A = new Line('296A', lineType_KMB, '尚德', '牛頭角站', [MTR_tko_tseungkwano, TseungKwanOTunnel, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, TseungKwanOTunnel, MTR_tko_tseungkwano], 8).markCircular().setNotes('經創紀之城, 牛頭角站，apm, 觀塘泳池');
var KMB_296C_EAST = new Line('296C', lineType_KMB, '長沙灣海盈邨', '尚德', [MTR_tcl_namcheong, MTR_twl_cheungshawan, MTR_twl_shamshuipo, MTR_ktl_princeedward, MTR_ktl_mongkok, MTR_erl_mongkokeast, BoundaryPrince, PE_RegalOrientalHotel, PE_SunPoKong, PE_ChoiHung, MTR_ktl_kowloonbay, MTR_ktl_kwuntong, TseungKwanOTunnel, MTR_tko_tseungkwano], 20);
var KMB_296C_WEST = new Line('296C', lineType_KMB, '尚德', '長沙灣海盈邨', [MTR_tko_tseungkwano, TseungKwanOTunnel, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, PE_ChoiHung, PE_SunPoKong, KowloonHospital, MTR_erl_mongkokeast, MTR_ktl_mongkok, MTR_ktl_princeedward, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_tcl_namcheong], 20);
var KMB_296D_EAST = new Line('296D', lineType_KMB, '九龍站', '尚德', [MTR_tcl_kowloon, MTR_tml_austin, MTR_twl_tsimshatsui, MTR_twl_jordan, MTR_tml_homantin, ToKwaWanFlyover, KaiTakTunnel, HKITCE, KwunTongBypass, TseungKwanOTunnel, MTR_tko_tseungkwano], 20);
var KMB_296D_WEST = new Line('296D', lineType_KMB, '尚德', '九龍站', [MTR_tko_tseungkwano, TseungKwanOTunnel, KwunTongBypass, HKITCE, KaiTakTunnel, ToKwaWanFlyover, MTR_twl_jordan, MTR_twl_jordan, MTR_twl_tsimshatsui, MTR_tml_austin, MTR_tcl_kowloon], 20);
var KMB_296M_EAST = new Line('296M', lineType_KMB, '康盛花園', '坑口站', [TKO_HongSingGarden, MTR_tko_polam, MTR_tko_tseungkwano, MTR_tko_hanghau], 25);
var KMB_296M_WEST = new Line('296M', lineType_KMB, '坑口站', '康盛花園', [MTR_tko_hanghau, MTR_tko_tseungkwano, MTR_tko_polam, TKO_HongSingGarden], 25);
var KMB_296P = new Line('296P', lineType_KMB, '尚德', '旺角', [MTR_tko_tseungkwano, TseungKwanOTunnel, KwunTongBypass, KowloonBayCommercial, PE_ChoiHung, MK_FlowerMarket, MTR_ktl_princeedward, MTR_ktl_mongkok, MTR_erl_mongkokeast, KowloonHospital, PE_RegalOrientalHotel, PE_SunPoKong, PE_ChoiHung, KowloonBayCommercial, KwunTongBypass, TseungKwanOTunnel, MTR_tko_tseungkwano], 1440).markCircular().markCommuter().setNotes('早上及下午各一班,早上開0745,下午開1720');
// All 29*
var KMB_NUM_29x_ALL = [KMB_290_EAST, KMB_290_WEST, KMB_290A_EAST, KMB_290A_WEST, KMB_290B_WEST, KMB_290X_EAST, KMB_290X_WEST, KMB_296A, KMB_296C_EAST, KMB_296C_WEST, KMB_296D_EAST, KMB_296D_WEST, KMB_296M_EAST, KMB_296M_WEST, KMB_296P];
// All 2**
var KMB_NUM_2xx_ALL = [].concat(KMB_NUM_21x_ALL, KMB_NUM_23x_ALL, KMB_NUM_24x_ALL, KMB_NUM_25x_ALL, KMB_NUM_26x_ALL, KMB_NUM_27x_ALL, KMB_NUM_28x_ALL, KMB_NUM_29x_ALL);
// Special Lines
var KMB_B1_NORTH = new Line('B1', lineType_KMB, '天慈', '落馬洲站', [KCR_lrt_4_tintsz, KCR_lrt_4_tinshuiwai, LongTinRoad, KCR_lrt_5_fungninroad, KCR_lrt_5_yuenlong, SunTinHighway, MTR_erl_lokmachau], 15);
var KMB_B1_SOUTH = new Line('B1', lineType_KMB, '落馬洲站', '天慈', [MTR_erl_lokmachau, SunTinHighway, KCR_lrt_5_yuenlong, KCR_lrt_5_fungninroad, LongTinRoad, KCR_lrt_4_tinshuiwai, KCR_lrt_4_tintsz], 15);
var KMB_W2_EAST = new Line('W2', lineType_KMB, '高鐵西九龍站', '觀塘站', [MTR_hsr_westkowloon, MTR_twl_jordan, ToKwaWanFlyover, KaiTakTunnel, HKITCE, KwunTongBypass, MTR_ktl_lamtin, MTR_ktl_kwuntong], 20).setNotes('西九特快，只停西九龍站、佐敦志和街、九展、藍田站');
var KMB_W2_WEST = new Line('W2', lineType_KMB, '觀塘站', '高鐵西九龍站', [MTR_ktl_kwuntong, MTR_ktl_lamtin, KwunTongBypass, HKITCE, KaiTakTunnel, ToKwaWanFlyover, MTR_twl_jordan, MTR_hsr_westkowloon], 20).setNotes('西九特快，只停藍田站、麗港公園、九展、九龍佑寧堂(佐敦)及西九龍站');
var KMB_W3_NORTH = new Line("W3", lineType_KMB, "西九龍站", "上水", [MTR_hsr_westkowloon, WestKowloonHighway, EaglesNestTunnel, TsingShaInterchange, ShatinHeightsTunnel, MTR_erl_shatin, TaiPoRoad_Shatin, ToloHighway_Coastal, TP_KwongFukEstate, FanlingHighway_LamTsuen, MTR_erl_sheungshui]).setNotes("高鐵特快；設有雙程分段收費");
var KMB_W3_SOUTH = new Line("W3", lineType_KMB, "上水", "西九龍站", [MTR_erl_sheungshui, FanlingHighway_LamTsuen, TP_KwongFukEstate, ToloHighway_Coastal, TaiPoRoad_Shatin, MTR_erl_shatin, ShatinHeightsTunnel, TsingShaInterchange, EaglesNestTunnel, WestKowloonHighway, MTR_hsr_westkowloon]).setNotes("高鐵特快");
// All Special Lines
var KMB_NUM_SPECIAL_ALL = [KMB_B1_NORTH, KMB_B1_SOUTH, KMB_W2_EAST, KMB_W2_WEST, KMB_W3_NORTH, KMB_W3_SOUTH];
/*
...
// E4*
var LWB_E42_EAST = new Line('E42', lineType_LWB, '機場', '博康', [MTR_aex_airport, Airport_CathayPacificCity, MTR_tcl_tungchung, LantauLink_SiuHoWan, LantauLink_YamO, LantauLink_Interchange, LantauLink_TsingMaBridge, TY_TsingYiWest, TW_TexacoFlyover, TW_CheungPeiShanRoad, ShingMunTunnel, ShingMunTunnelHighway, TaiPoRoad_MeiLam, MTR_mos_taiwai, MTR_mos_chekungtemple, ST_ShatinTownCenter, MTR_mos_shatinwai], 16).setNotes('經機場南部設施');
...
var CTB_NUM_04x_ALL = [];
// 07*
var CTB_70_NORTH = new Line('70', lineType_CTB, '華貴邨', '中環交易廣場', [MTR_swil_tinwan, MTR_swil_aberdeen, MTR_swil_wongchukhang, AberdeenTunnel_Interchange, AberdeenTunnel, MTR_ill_wanchai, MTR_ill_central], 10).setNotes('經香隧、鵝頸橋、舊灣仔警署、皇后像廣場');
var CTB_70_SOUTH = new Line('70', lineType_CTB, '中環交易廣場', '華貴邨', [MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, AberdeenTunnel, AberdeenTunnel_Interchange, MTR_swil_wongchukhang, MTR_swil_aberdeen, MTR_swil_tinwan], 10).setNotes('經金鐘，入境大樓，鵝頸橋、香隧');
var CTB_71_NORTH = new Line('71', lineType_CTB, '黃竹坑', '中環林士街', [MTR_seil_wongchukhang, MTR_swil_aberdeen, MTR_swil_tinwan, OuterWahFoo, PokFuLam_Actual, MTR_swil_queenmary, UpperKennedyTown, MTR_ill_hku, MTR_ill_saiyingpun, MTR_ill_sheungwan], 25).setNotes('經瑪麗醫院，HKU，西營盤，上環');
var CTB_71_SOUTH = new Line('71', lineType_CTB, '中環林士街', '黃竹坑', [MTR_ill_sheungwan, MTR_ill_central, MTR_ill_sheungwan, MTR_ill_saiyingpun, MTR_ill_hku, UpperKennedyTown, MTR_swil_queenmary, PokFuLam_Actual, OuterWahFoo, MTR_swil_tinwan, MTR_swil_aberdeen, MTR_seil_wongchukhang], 25).setNotes('經瑪麗醫院，HKU，西營盤，上環');
var CTB_72_NORTH = new Line('72', lineType_CTB, '華貴邨', '銅鑼灣(摩頓台)', [MTR_swil_tinwan, MTR_swil_aberdeen, MTR_swil_wongchukhang, AberdeenTunnel_Interchange, AberdeenTunnel, HappyValley, MTR_ill_causewaybay, Moreton_CausewayBay], 7).setNotes('經香隧、崇光');
var CTB_72_SOUTH = new Line('72', lineType_CTB, '銅鑼灣(摩頓台)', '華貴邨', [Moreton_CausewayBay, MTR_ill_causewaybay, HappyValley, AberdeenTunnel, AberdeenTunnel_Interchange, MTR_swil_wongchukhang, MTR_swil_aberdeen, MTR_swil_tinwan], 7).setNotes('經香隧、香港仔');
...
// All 07*
var CTB_NUM_07x_ALL = [CTB_70_NORTH, CTB_70_SOUTH, CTB_71_NORTH, CTB_71_SOUTH, CTB_72_NORTH, CTB_72_SOUTH, CTB_77_EAST, CTB_77_WEST];
// 09*
...
var CTB_97_NORTH = new Line('97', lineType_CTB, '利東邨', '中環交易廣場', [MTR_seil_leitung, MTR_seil_wongchukhang, AberdeenTunnel_Interchange, AberdeenTunnel, HappyValley, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central], 15).setNotes('經金鐘，灣仔');
var CTB_97_SOUTH = new Line('97', lineType_CTB, '中環交易廣場', '利東邨', [MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, HappyValley, AberdeenTunnel, AberdeenTunnel_Interchange, MTR_seil_wongchukhang, MTR_seil_leitung], 15).setNotes('經金鐘，灣仔');
...
var CTB_99_EAST = new Line('99', lineType_CTB, '海怡半島', '筲箕灣', [MTR_seil_southhoriz, MTR_seil_leitung, MTR_seil_wongchukhang, AberdeenTunnel_Interchange, AberdeenTunnel, MTR_ill_fortresshill, MTR_ill_northpoint, MTR_ill_quarrybay, MTR_ill_taikoo, MTR_ill_saiwanho, SKW_YiuTungEstate, MTR_ill_saukeiwan], 20).setNotes('經利東，銅鑼灣(告士打道)，天后，北角，鰂魚涌，太古，鯉景灣，西灣河，耀東邨');
var CTB_99_WEST = new Line('99', lineType_CTB, '筲箕灣', '海怡半島', [MTR_ill_saukeiwan, SKW_YiuTungEstate, MTR_ill_saiwanho, MTR_ill_taikoo, MTR_ill_quarrybay, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_causewaybay, AberdeenTunnel, AberdeenTunnel_Interchange, MTR_seil_wongchukhang, MTR_seil_leitung, MTR_seil_southhoriz], 20).setNotes('經利東，銅鑼灣(告士打道)，天后，北角，鰂魚涌，太古，鯉景灣，西灣河，耀東邨');
// All 09*
var CTB_NUM_09x_ALL = [CTB_96_NORTH, CTB_96_SOUTH, CTB_97_NORTH, CTB_97_SOUTH, CTB_98_NORTH, CTB_98_SOUTH, CTB_99_EAST, CTB_99_WEST];
// All 00*
...
// 78*
var CTB_780_EAST = new Line('780', lineType_CTB, '中環碼頭', '柴灣(東)', [CEN_FerryPier, MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, WC_FerryPier, EasternCorridor, CW_ChaiWanRoad, MTR_ill_chaiwan, MTR_ill_siusaiwan], 15).setNotes('特快路線，經中環、怡和大廈、入境事務大樓、灣仔碼頭、柴灣道、漁灣邨');
var CTB_780_WEST = new Line('780', lineType_CTB, '柴灣(東)', '中環碼頭', [MTR_ill_siusaiwan, MTR_ill_chaiwan, CW_ChaiWanRoad, EasternCorridor, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, CEN_FerryPier], 15).setNotes('特快路線，經漁灣邨、柴灣道、舊灣仔警署、海富中心、中環');
var CTB_780P_MORNING = new Line('780P', lineType_CTB, '興華邨', '中環碼頭', [MTR_ill_chaiwan, CW_ChaiWanRoad, EasternCorridor, MTR_ill_causewaybay, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, CEN_FerryPier], 1440).markCommuter().setNotes('只於平日早上服務，經康翠臺、柴灣道、百德新街、內告士打道、海富中心、中環');
var CTB_788_EAST = new Line('788', lineType_CTB, '中環(港澳碼頭)', '小西灣(藍灣半島)', [MTR_ill_sheungwan, MTR_ill_central, MTR_ill_wanchai, WC_FerryPier, EasternCorridor, MTR_ill_siusaiwan], 9).setNotes('特快路線，經中環、怡和大廈、入境事務大樓、灣仔碼頭、柴灣工廠區、小西灣');
var CTB_788_WEST = new Line('788', lineType_CTB, '小西灣(藍灣半島)', '中環(港澳碼頭)', [MTR_ill_siusaiwan, EasternCorridor, MTR_ill_wanchai, MTR_ill_central, MTR_ill_sheungwan], 9).setNotes('特快路線，部分班次不停富景花園，經小西灣、翠灣邨、舊灣仔警署、中環');
var CTB_789_EAST = new Line('789', lineType_CTB, '金鐘(樂禮街)', '小西灣(藍灣半島)', [MTR_ill_admiralty, MTR_ill_wanchai, EasternCorridor, MTR_ill_siusaiwan], 11).setNotes('經灣仔道、漁灣邨、小西灣');
var CTB_789_WEST = new Line('789', lineType_CTB, '小西灣(藍灣半島)', '金鐘(樂禮街)', [MTR_ill_siusaiwan, EasternCorridor, MTR_ill_wanchai, MTR_ill_admiralty], 11).setNotes('經小西灣、舊灣仔警署');
// All 78*
var CTB_NUM_78x_ALL = [CTB_780_EAST, CTB_780_WEST, CTB_780P_MORNING, CTB_788_EAST, CTB_788_WEST, CTB_789_EAST, CTB_789_WEST];
// All 7**
var CTB_NUM_7xx_ALL = [].concat(CTB_NUM_78x_ALL);
// Special
// A2*
var CTB_A22_EAST = new Line('A22', lineType_CTB, '機場地面運輸中心', '藍田站', [MTR_aex_airport, Airport_HKZHMCBridgePort, LantauLink_SiuHoWan, LantauLink_YamO, LantauLink_Interchange, LantauLink_TsingMaBridge, NgongShuenChauBridge, WestKowloonHighway, MTR_tml_austin, MTR_twl_jordan, MTR_tml_homantin, MTR_tml_tokwawan, MTR_tml_sungwongtoi, PE_RegalOrientalHotel, PE_SunPoKong, ChoiHungBusTerminus, PE_ChoiHung, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, MTR_ktl_lamtin], 20).setNotes('經港珠澳大橋香港口岸、青嶼幹線、昂船洲大橋、佐敦、紅磡、馬頭圍、新蒲崗、觀塘');
var CTB_A22_WEST = new Line('A22', lineType_CTB, '藍田站', '機場地面運輸中心', [MTR_ktl_lamtin, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, PE_ChoiHung, PE_SunPoKong, PE_RegalOrientalHotel, MTR_tml_sungwongtoi, MTR_tml_tokwawan, MTR_tml_homantin, MTR_twl_jordan, MTR_tml_austin, WestKowloonHighway, NgongShuenChauBridge, LantauLink_TsingMaBridge, LantauLink_Interchange, LantauLink_YamO, LantauLink_SiuHoWan, MTR_aex_airport, Airport_HKZHMCBridgePort, MTR_aex_airport], 20).setNotes('經觀塘、新蒲崗、馬頭圍、紅磡、佐敦、昂船洲大橋、青嶼幹線、珠澳大橋香港口岸、T1、T2');
var CTB_A26_EAST = new Line('A26', lineType_CTB, '機場地面運輸中心', '油塘', [MTR_aex_airport, LantauLink_SiuHoWan, LantauLink_YamO, LantauLink_Interchange, LantauLink_TsingMaBridge, TY_CheungTsingTunnel, LaiKingChokePoint, ChingCheungRoad_Other, ChingCheungRoad_BeaconHill, MTR_ktl_wongtaisin, MTR_ktl_diamondhill, MTR_ktl_choihung, KT_ShunLeeEstate, KT_Anderson, KT_KwongTin, MTR_ktl_yautong], 60).setNotes('經藍田、安秀道、牛池灣、鑽石山、黃大仙、青嶼幹線 服務時間：06:30 - 20:30');
var CTB_A26_WEST = new Line('A26', lineType_CTB, '油塘', '機場地面運輸中心', [MTR_ktl_yautong, KT_KwongTin, KT_Anderson, MTR_ktl_choihung, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, ChingCheungRoad_BeaconHill, ChingCheungRoad_Other, LaiKingChokePoint, TY_CheungTsingTunnel, LantauLink_TsingMaBridge, LantauLink_Interchange, LantauLink_YamO, LantauLink_SiuHoWan, MTR_aex_airport], 60).setNotes('經青嶼幹線、黃大仙、鑽石山站、牛池灣、安秀道、藍田 服務時間：11:45 - 23:45');
// All A2*
var CTB_NUM_A2x_ALL = [CTB_A22_EAST, CTB_A22_WEST, CTB_A26_EAST, CTB_A26_WEST];
// All A**
var CTB_NUM_Axx_ALL = [].concat(CTB_NUM_A2x_ALL);
// E2*
...
// All special lines
var CTB_NUM_SPECIAL_ALL = [].concat(CTB_NUM_Axx_ALL, CTB_NUM_Exx_ALL, CTB_NUM_Wxx_ALL);
var CTB_HK18_ALL = [].concat(CTB_NUM_0xx_ALL, CTB_NUM_5xx_ALL, CTB_NUM_7xx_ALL, CTB_NUM_SPECIAL_ALL);
/**
...
var NWFB_4_NORTH = new Line('4', lineType_NWFB, '華富(南)', '中環交易廣場', [MTR_swil_wahfoo, PokFuLam_Actual, MTR_swil_queenmary, UpperKennedyTown, MTR_ill_hku, MTR_ill_saiyingpun, MTR_ill_sheungwan, MTR_ill_central], 15).setNotes('有循環乘搭限制；經瑪麗醫院，HKU，西營盤，上環');
var NWFB_4_SOUTH = new Line('4', lineType_NWFB, '中環交易廣場', '華富(南)', [MTR_ill_central, MTR_ill_sheungwan, MTR_ill_saiyingpun, MTR_ill_hku, UpperKennedyTown, MTR_swil_queenmary, PokFuLam_Actual, MTR_swil_wahfoo], 15).setNotes('有循環乘搭限制；經瑪麗醫院，HKU，西營盤，上環');
var NWFB_4X_NORTH = new Line('4X', lineType_NWFB, '華富(南)', '中環碼頭', [MTR_swil_wahfoo, PokFuLam_Actual, MTR_swil_queenmary, UpperKennedyTown, MTR_ill_hku, MTR_ill_sheungwan, CEN_FerryPier, MTR_ill_central], 15).setNotes('有循環乘搭限制；(山道天橋特快)(一至六服務)經瑪麗醫院，HKU，上環');
var NWFB_4X_SOUTH = new Line('4X', lineType_NWFB, '中環碼頭', '華富(南)', [MTR_ill_central, MTR_ill_sheungwan, MTR_ill_saiyingpun, MTR_ill_hku, UpperKennedyTown, MTR_swil_queenmary, PokFuLam_Actual, MTR_swil_wahfoo], 15).setNotes('有循環乘搭限制；(一至六服務)經瑪麗醫院，HKU，西營盤，上環');
...
var NWFB_NUM_00x_ALL = [NWFB_2_EAST, NWFB_2_WEST, NWFB_4_NORTH, NWFB_4_SOUTH, NWFB_4X_NORTH, NWFB_4X_SOUTH, NWFB_8_EAST, NWFB_8_WEST];
// 01*
var NWFB_18P_EAST = new Line('18P', lineType_NWFB, '堅尼地城 (卑路乍灣)', '北角 (健康中街)', [MTR_ill_kennedytown, HKU_ShekTongTsui, MTR_ill_saiyingpun, MTR_ill_wanchai, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint], 12).setNotes('特快線');
var NWFB_18P_WEST = new Line('18P', lineType_NWFB, '北角 (健康中街)', '堅尼地城 (卑路乍灣)', [MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_causewaybay, MTR_erl_exhibition, MTR_ill_central, MTR_ill_saiyingpun, HKU_ShekTongTsui, MTR_ill_kennedytown], 12).setNotes('特快線');
...
// All 01*
var NWFB_NUM_01x_ALL = [NWFB_18P_EAST, NWFB_18P_WEST, NWFB_18X_EAST, NWFB_18X_WEST];
// 03*
...
var NWFB_38_EAST = new Line('38', lineType_NWFB, '置富花園', '北角碼頭', [PokFuLam_Actual, OuterWahFoo, MTR_swil_tinwan, MTR_swil_aberdeen, MTR_swil_wongchukhang, AberdeenTunnel_Interchange, AberdeenTunnel, HappyValley, MTR_ill_causewaybay, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, NP_FerryPier], 12).setNotes('經銅鑼灣，天后，黃竹坑，香港仔');
var NWFB_38_WEST = new Line('38', lineType_NWFB, '北角碼頭', '置富花園', [NP_FerryPier, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_tinhau, MTR_ill_causewaybay, HappyValley, AberdeenTunnel, AberdeenTunnel_Interchange, MTR_swil_wongchukhang, MTR_swil_aberdeen, MTR_swil_tinwan, OuterWahFoo, PokFuLam_Actual], 12).setNotes('經銅鑼灣，天后，黃竹坑，香港仔');
// All 03*
var NWFB_NUM_03x_ALL = [NWFB_30X_NORTH, NWFB_30X_SOUTH, NWFB_38_EAST, NWFB_38_WEST];
// 04*
var NWFB_42_EAST = new Line('42', lineType_NWFB, '華富邨(南)', '北角碼頭', [MTR_swil_wahfoo, MTR_swil_tinwan, MTR_swil_aberdeen, MTR_swil_wongchukhang, AberdeenTunnel_Interchange, AberdeenTunnel, HappyValley, MTR_ill_causewaybay, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, NP_FerryPier], 12).setNotes('經銅鑼灣，天后，黃竹坑，香港仔');
var NWFB_42_WEST = new Line('42', lineType_NWFB, '北角碼頭', '華富邨(南)', [NP_FerryPier, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_tinhau, MTR_ill_causewaybay, HappyValley, AberdeenTunnel, AberdeenTunnel_Interchange, MTR_swil_wongchukhang, MTR_swil_aberdeen, MTR_swil_tinwan, MTR_swil_wahfoo], 12).setNotes('經銅鑼灣，天后，黃竹坑，香港仔');
// All 04*
var NWFB_NUM_04x_ALL = [NWFB_42_EAST, NWFB_42_WEST];
// 08*
var NWFB_81_EAST = new Line('81', lineType_NWFB, '勵德邨', '興華邨', [Moreton_CausewayBay, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, MTR_ill_quarrybay, MTR_ill_taikoo, MTR_ill_saiwanho, MTR_ill_saukeiwan, CW_ChaiWanRoad, MTR_ill_chaiwan], 20).setNotes('經維園、英皇道、西灣河、筲箕灣、柴灣道、柴灣工業邨');
var NWFB_81_WEST = new Line('81', lineType_NWFB, '興華邨', '勵德邨', [MTR_ill_chaiwan, CW_ChaiWanRoad, MTR_ill_saukeiwan, MTR_ill_saiwanho, MTR_ill_taikoo, MTR_ill_quarrybay, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_tinhau, Moreton_CausewayBay], 20).setNotes('經柴灣工業邨、柴灣道、筲箕灣、西灣河、英皇道、大坑');
var NWFB_82_EAST = new Line('82', lineType_NWFB, '北角碼頭', '小西灣(藍灣半島)', [MTR_ill_siusaiwan, MTR_ill_chaiwan, CW_ChaiWanRoad, MTR_ill_saukeiwan, MTR_ill_saiwanho, MTR_ill_taikoo, MTR_ill_quarrybay, MTR_ill_northpoint, NP_FerryPier], 13).setNotes('經鰂魚涌、西灣河、筲箕灣、柴灣道、漁灣邨');
var NWFB_82_WEST = new Line('82', lineType_NWFB, '小西灣(藍灣半島)', '北角碼頭', [NP_FerryPier, MTR_ill_northpoint, MTR_ill_quarrybay, MTR_ill_taikoo, MTR_ill_saiwanho, MTR_ill_saukeiwan, CW_ChaiWanRoad, MTR_ill_chaiwan, MTR_ill_siusaiwan], 11).setNotes('經柴灣、東區醫院、筲箕灣、西灣河、鰂魚涌');
// All 08*
var NWFB_NUM_08x_ALL = [NWFB_81_EAST, NWFB_81_WEST, NWFB_82_EAST, NWFB_82_WEST];
// 09*
...
var NWFB_NUM_0xx_ALL = [].concat(NWFB_NUM_00x_ALL, NWFB_NUM_01x_ALL, NWFB_NUM_03x_ALL, NWFB_NUM_04x_ALL, NWFB_NUM_08x_ALL, NWFB_NUM_09x_ALL);
// 79*
var NWFB_798_EAST = new Line("798", lineType_NWFB, "火炭山尾街", "調景嶺站", [FoTanTsuen, ST_YuenWo, ST_ShatinTownCenter, MTR_mos_shatinwai, OldTatesTunnel_Interchange, OldTatesTunnel, KowloonBayFlyover, KwunTongBypass, TseungKwanOTunnel, MTR_tko_polam, MTR_tko_hanghau, MTR_tko_tseungkwano, MTR_tko_tiukengleng], 15).setNotes("將軍澳特快");
...
var NWFB_798A_AFTERNOON = new Line('798A', lineType_NWFB, '沙田市中心', '將軍澳(康盛花園)', [ST_ShatinTownCenter, MTR_mos_shatinwai, OldTatesTunnel_Interchange, OldTatesTunnel, KowloonBayFlyover, KwunTongBypass, TseungKwanOTunnel, MTR_tko_polam, TKO_HongSingGarden], 1440).markCommuter().setNotes('單班車1815開出；經寶琳北');
...
var NWFB_798B_AFTERNOON = new Line('798B', lineType_NWFB, '沙田市中心', '日出康城', [ST_ShatinTownCenter, MTR_mos_shatinwai, OldTatesTunnel_Interchange, OldTatesTunnel, KowloonBayFlyover, KwunTongBypass, TseungKwanOTunnel, MTR_tko_hanghau, MTR_tko_tseungkwano, MTR_tko_lohaspark], 1440).markCommuter().setNotes('單班車1830開出；經尚德');
...
// Kowloon section
// 00*
var GMB_KL_8_NORTH = new Line('8', lineType_GMB_KL, '尖沙咀 漢口道', '何文田', [MTR_tml_easttsimshatsui, MTR_tml_hunghom, MTR_tml_homantin, HMT_OiManEstate, HMT_HoManTinEstate], 6).setNotes('經愛民邨');
var GMB_KL_8_SOUTH = new Line('8', lineType_GMB_KL, '何文田', '尖沙咀 漢口道', [HMT_HoManTinEstate, HMT_OiManEstate, MTR_tml_homantin, MTR_tml_hunghom, MTR_tml_easttsimshatsui], 6).setNotes('經愛民邨');
// All 00*
...
// 02*
var GMB_NT_26_EAST = new Line("26", lineType_GMB_NT, "香港教育大學", "海柏花園", [TP_KwongFukEstate, ToloHighway_Coastal, MOS_HengHongStreet, MTR_mos_maonshan], 8).setNotes("大埔特快");
var GMB_NT_26_WEST = new Line("26", lineType_GMB_NT, "海柏花園", "香港教育大學", [MTR_mos_maonshan, MOS_HengHongStreet, ToloHighway_Coastal, TP_KwongFukEstate], 8).setNotes("大埔特快");
...
// 03*
var GMB_NT_34_EAST = new Line('34', lineType_GMB_NT, '流浮山', '元朗', [KCR_lrt_4_tinshuiwai, KCR_lrt_4_pingshan, KCR_lrt_5_fungninroad, KCR_lrt_5_yuenlong], 15).setNotes('經水邊圍');
var GMB_NT_34_WEST = new Line('34', lineType_GMB_NT, '元朗', '流浮山', [KCR_lrt_5_yuenlong, KCR_lrt_5_fungninroad, KCR_lrt_4_pingshan, KCR_lrt_4_tinshuiwai], 15).setNotes('經水邊圍');
// All 03*
var GMB_NT_NUM_03x_ALL = [GMB_NT_34_EAST, GMB_NT_34_WEST];
// 04*
...
var GMB_NT_44A_NORTH = new Line('44A', lineType_GMB_NT, '屯門站', '上水站', [KCR_lrt_2_tuenmun, KCR_lrt_2_taihing, KCR_lrt_3_tinking, KCR_lrt_3_siuhong, YuenLongHighway, SunTinHighway, FanlingHighway_KwuTung, MTR_erl_sheungshui], 5).setNotes('經良景、石排；設特別車沿線開出/直往上水');
var GMB_NT_44A_SOUTH = new Line('44A', lineType_GMB_NT, '上水站', '屯門站', [MTR_erl_sheungshui, FanlingHighway_KwuTung, SunTinHighway, YuenLongHighway, KCR_lrt_3_siuhong, KCR_lrt_3_tinking, KCR_lrt_2_taihing, MTR_tml_tuenmun], 5).setNotes('經良景、石排');
var GMB_NT_46_NORTH = new Line('46', lineType_GMB_NT, '屯門市中心', '富泰邨', [TM_TuenMunTownCenter, MTR_tml_tuenmun, KCR_lrt_2_primeview, MTR_tml_siuhong, LingNanUniversity], 5).setNotes('經景峰，新墟');
var GMB_NT_46_SOUTH = new Line('46', lineType_GMB_NT, '富泰邨', '屯門市中心', [LingNanUniversity, MTR_tml_siuhong, KCR_lrt_2_primeview, MTR_tml_tuenmun, TM_TuenMunTownCenter], 5).setNotes('經景峰，新墟');
// All 04*
var GMB_NT_NUM_04x_ALL = [GMB_NT_44_NORTH, GMB_NT_44_SOUTH, GMB_NT_44A_NORTH, GMB_NT_44A_SOUTH, GMB_NT_46_NORTH, GMB_NT_46_SOUTH];
// 06*
...
var GMB_NT_68K_EAST = new Line("68K", lineType_GMB_NT, "瑞峰花園", "沙田站", [ST_LungHangEstate, MTR_mos_taiwai, MTR_mos_chekungtemple, ST_ShatinTownCenter, MTR_erl_shatin], 8);
...
// All 0**
var GMB_NT_NUM_0xx_ALL = [].concat(GMB_NT_NUM_01x_ALL, GMB_NT_NUM_02x_ALL, GMB_NT_NUM_03x_ALL, GMB_NT_NUM_04x_ALL, GMB_NT_NUM_06x_ALL);
// 48*
...
// 80*
var GMB_NT_803_NORTH = new Line("803", lineType_GMB_NT, "顯徑", "利安", [MTR_tml_hinkeng, MTR_mos_taiwai, MTR_mos_chekungtemple, ST_JatMinChuen, ST_BelairGardens, ST_ShatinSeafood, ST_ShatinHospital, MTR_mos_taishuihang, MOS_HengHongStreet, MTR_mos_maonshan, MOS_LeeOnEstate], 15).setNotes("繁忙時間不停大水坑站");
var GMB_NT_803_SOUTH = new Line("803", lineType_GMB_NT, "利安", "顯徑", [MOS_LeeOnEstate, MTR_mos_maonshan, MOS_HengHongStreet, MTR_mos_taishuihang, ST_ShatinHospital, ST_ShatinSeafood, ST_BelairGardens, ST_JatMinChuen, MTR_mos_chekungtemple, MTR_mos_taiwai, MTR_tml_hinkeng], 15).setNotes("繁忙時間不停大水坑站");
...
// 81*
var GMB_NT_810_NORTH = new Line('810', lineType_GMB_NT, '沙田 偉華中心', '馬鞍山 雅典居', [ST_ShatinTownCenter, ST_YuenWo, ST_ShatinSeafood, ST_ShatinHospital, MTR_mos_taishuihang, MTR_mos_hengon, MTR_mos_maonshan], 10);
var GMB_NT_810_SOUTH = new Line('810', lineType_GMB_NT, '馬鞍山 雅典居', '沙田 偉華中心', [MTR_mos_maonshan, MTR_mos_hengon, MTR_mos_taishuihang, ST_ShatinHospital, ST_ShatinSeafood, ST_YuenWo, ST_ShatinTownCenter], 10);
// All 81*
var GMB_NT_NUM_81x_ALL = [GMB_NT_810_NORTH, GMB_NT_810_SOUTH];
// All 8**
var GMB_NT_NUM_8xx_ALL = [].concat(GMB_NT_NUM_80x_ALL, GMB_NT_NUM_81x_ALL);
...
var CHT_111_EAST = new Line('111', lineType_HARBOUR, '中環 (港澳碼頭)', '坪石 (彩虹站)', [MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, CrossHarbourTunnel, CrossHarbourTunnel_Interchange, MTR_tml_homantin, MTR_tml_tokwawan, MTR_tml_sungwongtoi, PE_RegalOrientalHotel, SunPoKong_Inside, MTR_ktl_diamondhill, MTR_ktl_choihung], 5).setNotes('經新蒲崗、土瓜灣上路、紅隧、灣仔、金鐘');
var CHT_111_WEST = new Line('111', lineType_HARBOUR, '坪石 (彩虹站)', '中環 (港澳碼頭)', [MTR_ktl_choihung, MTR_ktl_diamondhill, SunPoKong_Inside, PE_RegalOrientalHotel, MTR_tml_sungwongtoi, MTR_tml_tokwawan, MTR_tml_homantin, CrossHarbourTunnel_Interchange, CrossHarbourTunnel, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan], 5).setNotes('經新蒲崗、土瓜灣上路、紅隧、灣仔、金鐘');
...
var CHT_113_NORTH = new Line('113', lineType_HARBOUR, '堅尼地城 (卑路乍灣)', '彩虹', [MTR_ill_kennedytown, HKU_ShekTongTsui, MTR_ill_saiyingpun, MTR_ill_sheungwan, MTR_ill_central, MTR_ill_wanchai, HappyValley, CrossHarbourTunnel, CrossHarbourTunnel_Interchange, HMT_OiManEstate, KowloonHospital, MK_FlowerMarket, BoundaryPrince, MTR_ktl_lokfu, MTR_ktl_wongtaisin, MTR_ktl_diamondhill, ChoiHungBusTerminus], 15).setNotes('經中環、灣仔合和、紅隧、愛民邨、窩打老道、花墟、喇沙、東頭村、黃大仙');
var CHT_113_SOUTH = new Line('113', lineType_HARBOUR, '彩虹', '堅尼地城 (卑路乍灣)', [ChoiHungBusTerminus, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, MTR_ktl_lokfu, BoundaryPrince, KowloonHospital, HMT_OiManEstate, CrossHarbourTunnel_Interchange, CrossHarbourTunnel, HappyValley, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, MTR_ill_saiyingpun, HKU_ShekTongTsui, MTR_ill_kennedytown], 15).setNotes('經黃大仙、東頭村、喇沙、窩打老道、愛民邨、紅隧、灣仔合和、金鐘、中環、西環電車路');
...
// All 11*
var CHT_NUM_11x_ALL = [CHT_110, CHT_111_EAST, CHT_111_WEST, CHT_112_NORTH, CHT_112_SOUTH, CHT_113_NORTH, CHT_113_SOUTH, CHT_116_NORTH, CHT_116_SOUTH];
// 17*
...
// 30*
var CHT_307_NORTH = new Line("307", lineType_HARBOUR, "中環渡輪碼頭", "大埔中心", [MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_tinhau, EasternCorridor, EastHarbourTunnel, EastHarbourTunnel_Interchange, KwunTongBypass, KowloonBayFlyover, OldTatesTunnel, OldTatesTunnel_Interchange, ToloHighway_Coastal, TP_KwongFukEstate, KwongFukRoad]).setNotes("特快來往大埔、大老山、東隧、東廊");
var CHT_307_SOUTH = new Line("307", lineType_HARBOUR, "大埔中心", "中環渡輪碼頭", [WanTauKokLane, TP_KwongFukEstate, ToloHighway_Coastal, OldTatesTunnel_Interchange, OldTatesTunnel, KowloonBayFlyover, KwunTongBypass, EastHarbourTunnel_Interchange, EastHarbourTunnel, EasternCorridor, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan]).setNotes("特快來往大埔、大老山、東隧、東廊");
// All 30*
var CHT_NUM_30x_ALL = [CHT_307_NORTH, CHT_307_SOUTH];
// 37*
var CHT_373_MORNING = new Line('373', lineType_HARBOUR, '上水', '中環（香港站）', [MTR_erl_sheungshui, FL_TinPing, FL_LuenWoMarket, MTR_erl_fanling, TaiPoRoad_KiuTau, ToloHighway_TaiPo, ToloHighway_Coastal, OldTatesTunnel_Interchange, OldTatesTunnel, KowloonBayFlyover, KwunTongBypass, EastHarbourTunnel_Interchange, EastHarbourTunnel, EasternCorridor, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, CEN_FerryPier, MTR_tcl_hongkong], 20).markCommuter().setNotes('星期一至六（公眾假期除外） 經聯和墟 大窩西支路 東隧 灣仔 金鐘 中環 上環');
var CHT_373_AFTERNOON = new Line('373', lineType_HARBOUR, '中環（香港站）', '上水', [MTR_tcl_hongkong, MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, EasternCorridor, EastHarbourTunnel, EastHarbourTunnel_Interchange, KwunTongBypass, KowloonBayFlyover, KowloonBayFlyover, OldTatesTunnel, OldTatesTunnel_Interchange, ToloHighway_Coastal, ToloHighway_TaiPo, TaiPoRoad_KiuTau, FL_WahMing, MTR_erl_fanling, FL_LuenWoMarket, FL_TinPing, MTR_erl_sheungshui], 20).markCommuter().setNotes('星期一至六（公眾假期除外） 經上環 中環 金鐘 灣仔  東隧  大窩西支路   聯和墟 石湖墟');
// All 37*
var CHT_NUM_37x_ALL = [CHT_373_MORNING, CHT_373_AFTERNOON];
// All 3**
var CHT_NUM_3xx_ALL = [].concat(CHT_NUM_30x_ALL, CHT_NUM_37x_ALL);
// 60*
var CHT_601_EAST = new Line('601', lineType_HARBOUR, '金鐘(東)', '寶達', [MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_causewaybay, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, EastHarbourTunnel, EastHarbourTunnel_Interchange, MTR_ktl_lamtin, MTR_ktl_kwuntong, KT_SauMauPing, KT_PoTatEstate], 13).setNotes('經秀茂坪');
var CHT_601_WEST = new Line('601', lineType_HARBOUR, '寶達', '金鐘(東)', [KT_PoTatEstate, KT_SauMauPing, MTR_ktl_kwuntong, MTR_ktl_lamtin, EastHarbourTunnel_Interchange, EastHarbourTunnel, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_tinhau, MTR_ill_causewaybay, MTR_ill_wanchai, MTR_ill_admiralty], 13).setNotes('經銅鑼灣禮頓、秀茂坪');
var CHT_603_EAST = new Line('603', lineType_HARBOUR, '平田', '中環渡輪碼頭', [MTR_ktl_lamtin, MTR_ktl_yautong, EastHarbourTunnel_Interchange, EastHarbourTunnel, EasternCorridor, MTR_ill_wanchai, MTR_ill_central, MTR_ill_sheungwan, CEN_FerryPier], 15);
var CHT_603_WEST = new Line('603', lineType_HARBOUR, '中環渡輪碼頭', '平田', [CEN_FerryPier, MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_causewaybay, MTR_ill_tinhau, EasternCorridor, EastHarbourTunnel, EastHarbourTunnel_Interchange, MTR_ktl_yautong, MTR_ktl_lamtin], 15);
var CHT_606_NORTH = new Line('606', lineType_HARBOUR, '小西灣(藍灣半島)', '彩雲(豐盛街)', [MTR_ill_siusaiwan, MTR_ill_chaiwan, CW_ChaiWanRoad, SKW_YiuTungEstate, MTR_ill_saiwanho, MTR_ill_taikoo, MTR_ill_quarrybay, EastHarbourTunnel, EastHarbourTunnel_Interchange, MTR_ktl_lamtin, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, KowloonBayCommercial, MTR_ktl_choihung], 20).setNotes('經九龍灣商貿區');
var CHT_606_SOUTH = new Line('606', lineType_HARBOUR, '彩雲(豐盛街)', '小西灣(藍灣半島)', [MTR_ktl_choihung, KowloonBayCommercial, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, MTR_ktl_lamtin, EastHarbourTunnel_Interchange, EastHarbourTunnel, MTR_ill_quarrybay, MTR_ill_taikoo, MTR_ill_saiwanho, SKW_YiuTungEstate, CW_ChaiWanRoad, MTR_ill_chaiwan, MTR_ill_siusaiwan], 20).setNotes('經九龍灣商貿區');
// All 60*
var CHT_NUM_60x_ALL = [CHT_601_EAST, CHT_601_WEST, CHT_603_EAST, CHT_603_WEST, CHT_606_NORTH, CHT_606_SOUTH];
// 61*
var CHT_619_NEGATIVE = new Line('619', lineType_HARBOUR, '順利', '中環(港澳碼頭)', [KT_ShunLeeEstate, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, MTR_ktl_lamtin, EastHarbourTunnel_Interchange, EastHarbourTunnel, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_tinhau, MTR_ill_causewaybay, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan], 13);
var CHT_619_POSITIVE = new Line('619', lineType_HARBOUR, '中環(港澳碼頭)', '順利', [MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_causewaybay, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, EastHarbourTunnel, EastHarbourTunnel_Interchange, MTR_ktl_lamtin, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, KT_ShunLeeEstate], 13);
// All 61*
var CHT_NUM_61x_ALL = [CHT_619_NEGATIVE, CHT_619_POSITIVE];
// 67*
var CHT_671_NORTH = new Line('671', lineType_HARBOUR, '鴨脷洲 (利樂街)', '鑽石山站', [MTR_seil_southhoriz, MTR_seil_leitung, MTR_seil_wongchukhang, AberdeenTunnel_Interchange, AberdeenTunnel, HappyValley, MTR_ill_causewaybay, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, EastHarbourTunnel, EastHarbourTunnel_Interchange, MTR_ktl_lamtin, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, MTR_ktl_choihung, MTR_ktl_diamondhill], 30).setNotes('星期一至六 06:25-20:15 (星期日為 07:30-19:45)');
var CHT_671_SOUTH = new Line('671', lineType_HARBOUR, '鑽石山站', '鴨脷洲 (利樂街)', [MTR_ktl_diamondhill, ChoiHungBusTerminus, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, MTR_ktl_lamtin, EastHarbourTunnel_Interchange, EastHarbourTunnel, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_causewaybay, AberdeenTunnel, AberdeenTunnel_Interchange, MTR_seil_wongchukhang, MTR_seil_leitung, MTR_seil_southhoriz], 30).setNotes('星期一至六 06:30-20:15 (星期日為 07:30-19:45)');
var CHT_673_NORTH = new Line('673', lineType_HARBOUR, '中環（香港站 )', '上水', [MTR_tcl_hongkong, MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_causewaybay, MTR_ill_tinhau, EasternCorridor, EastHarbourTunnel, EastHarbourTunnel_Interchange, KwunTongBypass, KowloonBayFlyover, OldTatesTunnel, OldTatesTunnel_Interchange, ToloHighway_Coastal, ToloHighway_TaiPo, FanlingHighway_LamTsuen, MTR_erl_fanling, FL_LuenWoMarket, FL_TinPing, MTR_erl_sheungshui], 30).setNotes('星期一至日 10:30-23:30 經香港站 中環 金鐘 灣仔 銅鑼灣 東隧 大老山隧道 粉嶺 上水');
var CHT_673_SOUTH = new Line('673', lineType_HARBOUR, '上水', '中環（林士街 )', [MTR_erl_sheungshui, FL_TinPing, FL_LuenWoMarket, MTR_erl_fanling, FanlingHighway_Interchange, FanlingHighway_LamTsuen, ToloHighway_TaiPo, ToloHighway_Coastal, OldTatesTunnel_Interchange, OldTatesTunnel, KowloonBayFlyover, KwunTongBypass, EastHarbourTunnel_Interchange, EastHarbourTunnel, EasternCorridor, MTR_ill_tinhau, MTR_ill_causewaybay, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, CEN_FerryPier, MTR_tcl_hongkong], 30).setNotes('星期一至日 09:00-20:30 經上水 粉嶺 大老山隧道 東隧 銅鑼灣 灣仔 中環 香港站');
var CHT_678_MORNING = new Line('678', lineType_HARBOUR, '上水', '銅鑼灣（東院道)', [MTR_erl_sheungshui, MTR_erl_fanling, FL_WahMing, FanlingHighway_LamTsuen, ToloHighway_TaiPo, ToloHighway_Coastal, OldTatesTunnel_Interchange, OldTatesTunnel, KowloonBayFlyover, KwunTongBypass, EastHarbourTunnel_Interchange, EastHarbourTunnel, MTR_ill_saiwanho, MTR_ill_taikoo, MTR_ill_quarrybay, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_tinhau], 12).markCommuter().setNotes('星期一至五（公眾假期除外)  經粉嶺南,東隧 西灣河 鰂魚涌 北角 炮台山 天后');
var CHT_678_AFTERNOON = new Line('678', lineType_HARBOUR, '銅鑼灣（東院道)', '上水', [MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, MTR_ill_quarrybay, MTR_ill_taikoo, MTR_ill_saiwanho, EastHarbourTunnel, EastHarbourTunnel_Interchange, KwunTongBypass, KowloonBayFlyover, OldTatesTunnel, OldTatesTunnel_Interchange, ToloHighway_Coastal, ToloHighway_TaiPo, FanlingHighway_LamTsuen, FL_WahMing, MTR_erl_fanling, MTR_erl_sheungshui], 15).markCommuter().setNotes('星期一至五（公眾假期除外) 經維園, 炮台山 北角 鰂魚涌 太古 西灣河 東隧 粉嶺南');
// All 67*
var CHT_NUM_67x_ALL = [CHT_671_NORTH, CHT_671_SOUTH, CHT_673_NORTH, CHT_673_SOUTH, CHT_678_MORNING, CHT_678_AFTERNOON];
// 68*
var CHT_682_NORTH = new Line('682', lineType_HARBOUR, '柴灣(東)', '烏溪沙', [MTR_ill_siusaiwan, MTR_ill_chaiwan, CW_ChaiWanRoad, MTR_ill_saukeiwan, MTR_ill_saiwanho, MTR_ill_taikoo, MTR_ill_quarrybay, EastHarbourTunnel, EastHarbourTunnel_Interchange, KwunTongBypass, KowloonBayFlyover, OldTatesTunnel, OldTatesTunnel_Interchange, ST_SiuLekYuenPlayground, ST_ShatinHospital, MTR_mos_taishuihang, MOS_HengHongStreet, MTR_mos_maonshan, MOS_KamYingCourt, MTR_mos_wukaisha], 15).setNotes('經東隧、大隧、沙田第一城、濱景花園、富安花園、恆安/耀安、馬鞍山市中心、錦英苑、利安');
var CHT_682_SOUTH = new Line('682', lineType_HARBOUR, '烏溪沙', '柴灣(東)', [MTR_mos_wukaisha, MOS_KamYingCourt, MTR_mos_maonshan, MOS_HengHongStreet, MTR_mos_taishuihang, ST_ShatinHospital, ST_SiuLekYuenPlayground, OldTatesTunnel_Interchange, OldTatesTunnel, KowloonBayFlyover, KwunTongBypass, EastHarbourTunnel_Interchange, EastHarbourTunnel, MTR_ill_quarrybay, MTR_ill_taikoo, MTR_ill_saiwanho, MTR_ill_saukeiwan, CW_ChaiWanRoad, MTR_ill_chaiwan, MTR_ill_siusaiwan], 15).setNotes('經大隧、東隧、健康邨、太古、西灣河、筲箕灣、柴灣道、漁灣邨、小西灣');
// All 68*
var CHT_NUM_68x_ALL = [CHT_682_NORTH, CHT_682_SOUTH];
// 69*
var CHT_690_EAST = new Line('690', lineType_HARBOUR, '中環 (交易廣場)', '康盛花園', [MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_causewaybay, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, EastHarbourTunnel, EastHarbourTunnel_Interchange, MTR_ktl_lamtin, TseungKwanOTunnel, MTR_tko_polam, TKO_HongSingGarden], 30).setNotes('經中環至北角沿途各站（MTR)，往藍田、寶林、翠林邨');
var CHT_690_WEST = new Line('690', lineType_HARBOUR, '康盛花園', '中環 (交易廣場)', [TKO_HongSingGarden, MTR_tko_polam, TseungKwanOTunnel, MTR_ktl_lamtin, EastHarbourTunnel_Interchange, EastHarbourTunnel, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_causewaybay, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central], 30).setNotes('經翠林邨、寶林、啟田道、北角、炮台山、銅鑼灣至中環沿途各站（MTR)');
var CHT_694_NORTH = new Line('694', lineType_HARBOUR, '小西灣邨', '調景嶺站', [MTR_ill_siusaiwan, MTR_ill_chaiwan, CW_ChaiWanRoad, MTR_ill_saukeiwan, MTR_ill_saiwanho, EastHarbourTunnel, EastHarbourTunnel_Interchange, MTR_ktl_lamtin, TseungKwanOTunnel, MTR_tko_polam, MTR_tko_hanghau, MTR_tko_tseungkwano, MTR_tko_tiukengleng], 25).setNotes('特快線，設有分段收費');
var CHT_694_SOUTH = new Line('694', lineType_HARBOUR, '調景嶺站', '小西灣邨', [MTR_tko_tiukengleng, MTR_tko_tseungkwano, MTR_tko_hanghau, MTR_tko_polam, TseungKwanOTunnel, MTR_ktl_lamtin, EastHarbourTunnel_Interchange, EastHarbourTunnel, MTR_ill_saiwanho, MTR_ill_saukeiwan, CW_ChaiWanRoad, MTR_ill_chaiwan, MTR_ill_siusaiwan], 25).setNotes('特快線，設有分段收費');
// All 69*
var CHT_NUM_69x_ALL = [CHT_690_EAST, CHT_690_WEST, CHT_694_NORTH, CHT_694_SOUTH];
// All 6**
var CHT_NUM_6xx_ALL = [].concat(CHT_NUM_60x_ALL, CHT_NUM_61x_ALL, CHT_NUM_67x_ALL, CHT_NUM_68x_ALL, CHT_NUM_69x_ALL);
// 90*
...
// 91*
var CHT_914_SOUTH = new Line('914', lineType_HARBOUR, '長沙灣(海麗邨)', '銅鑼灣(天后)', [MTR_ill_tinhau, MTR_ill_causewaybay, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, WestHarbourTunnel, WestHarbourTunnel_Interchange, MTR_tml_austin, MTR_tcl_olympic, MTR_tcl_namcheong], 18).setNotes('經富昌邨、南昌邨、荔枝角道、大角咀道、海富苑、富榮花園/柏景灣、佐敦、西隧、中環、金鐘、灣仔、崇光百貨');
var CHT_914_NORTH = new Line('914', lineType_HARBOUR, '銅鑼灣(天后)', '長沙灣(海麗邨)', [MTR_tcl_namcheong, MTR_tcl_olympic, MTR_tml_austin, WestHarbourTunnel_Interchange, WestHarbourTunnel, MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_causewaybay, MTR_ill_tinhau], 18).setNotes('經大坑、銅鑼灣、灣仔、金鐘、中環、西隧、佐敦、富榮花園、柏景灣、大角咀、深水埗(海壇街)、南昌邨、富昌邨');
var CHT_914P_MORNING = new Line('914P', lineType_HARBOUR, '海麗邨', '銅鑼灣(天后)', [MTR_tcl_namcheong, MTR_tcl_olympic, WestHarbourTunnel_Interchange, WestHarbourTunnel, MTR_ill_sheungwan, MTR_tcl_hongkong, MTR_ill_admiralty, MTR_erl_exhibition, MTR_ill_causewaybay, MTR_ill_tinhau], 1440).markCommuter().setNotes('平日早上只開一班，經富昌邨、港灣豪庭、維港灣、海富苑、富榮花園/柏景灣、西隧、港澳碼頭、中環、政府總部、會展、維園');
var CHT_914X_MORNING = new Line('914X', lineType_HARBOUR, '海麗邨', '銅鑼灣(天后)', [MTR_tcl_namcheong, MTR_tcl_olympic, MTR_tml_austin, WestHarbourTunnel_Interchange, WestHarbourTunnel, MTR_ill_sheungwan, MTR_tcl_hongkong, MTR_ill_admiralty, MTR_erl_exhibition, MTR_ill_causewaybay, MTR_ill_tinhau], 1440).markCommuter().setNotes('平日開三班車；經富昌邨、南昌邨、深水埗(海壇街)、大角咀、海富苑、富榮花園/柏景灣、佐敦、西隧、港澳碼頭、IFC、會展、維園');
// All 91*
var CHT_NUM_91x_ALL = [CHT_914_NORTH, CHT_914_SOUTH, CHT_914P_MORNING, CHT_914X_MORNING];
// 93*
...
var CHT_962_EAST = new Line('962', lineType_HARBOUR, '屯門 (龍門居)', '銅鑼灣 (摩頓台)', [KCR_lrt_1_lungmun, KCR_lrt_1_tuenmunferrypier, KCR_lrt_1_samshing, CPR_GoldenBeach, CPR_SiuLam, TuenMunHighway_InterchangeEast, TuenMunHighway_TsingLungTau, TY_TingKauBridge, TY_CheungTsingTunnel, WestKowloonHighway, WestHarbourTunnel_Interchange, WestHarbourTunnel, MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_causewaybay, Moreton_CausewayBay], 1440).markCommuter().setNotes('經黃金海岸');
var CHT_962_WEST = new Line('962', lineType_HARBOUR, '銅鑼灣 (摩頓台)', '屯門 (龍門居)', [Moreton_CausewayBay, MTR_ill_causewaybay, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, WestHarbourTunnel, WestHarbourTunnel_Interchange, WestKowloonHighway, TY_CheungTsingTunnel, TY_TingKauBridge, TuenMunHighway_TsingLungTau, TuenMunHighway_InterchangeWest, CPR_SiuLam, CPR_GoldenBeach, KCR_lrt_1_samshing, KCR_lrt_1_tuenmunferrypier, KCR_lrt_1_lungmun], 1440).markCommuter().setNotes('經黃金海岸');
var CHT_962X_EAST = new Line('962X', lineType_HARBOUR, '屯門 (龍門居)', '銅鑼灣 (摩頓台)', [KCR_lrt_1_lungmun, KCR_lrt_1_tuenmunferrypier, KCR_lrt_1_samshing, TM_TuenMunTownCenter, TuenMunHighway_SoKwunWat, TuenMunHighway_InterchangeEast, TuenMunHighway_TsingLungTau, TY_TingKauBridge, TY_CheungTsingTunnel, WestKowloonHighway, WestHarbourTunnel_Interchange, WestHarbourTunnel, MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_causewaybay, Moreton_CausewayBay], 15);
var CHT_962X_WEST = new Line('962X', lineType_HARBOUR, '銅鑼灣 (摩頓台)', '屯門 (龍門居)', [Moreton_CausewayBay, MTR_ill_causewaybay, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, WestHarbourTunnel, WestHarbourTunnel_Interchange, WestKowloonHighway, TY_CheungTsingTunnel, TY_TingKauBridge, TuenMunHighway_TsingLungTau, TuenMunHighway_InterchangeWest, TuenMunHighway_SoKwunWat, TM_TuenMunTownCenter, KCR_lrt_1_samshing, KCR_lrt_1_tuenmunferrypier, KCR_lrt_1_lungmun], 15);
// All 96*
var CHT_NUM_96x_ALL = [CHT_960_NORTH, CHT_960_SOUTH, CHT_961_NORTH, CHT_961_SOUTH, CHT_962_EAST, CHT_962_WEST, CHT_962X_EAST, CHT_962X_WEST];
// 97*
...
var CHT_973_NORTH = new Line('973', lineType_HARBOUR, '赤柱市場', '尖沙咀(麽地道)', [MTR_seil_oceanpark, MTR_seil_wongchukhang, MTR_swil_aberdeen, MTR_swil_tinwan, OuterWahFoo, PokFuLam_Actual, MTR_swil_queenmary, UpperKennedyTown, MTR_ill_hku, MTR_ill_saiyingpun, WestHarbourTunnel, WestHarbourTunnel_Interchange, MTR_tml_austin, MTR_tml_easttsimshatsui], 30).setNotes('經淺水灣、深水灣、黃竹坑(平日早上)、香港仔、瑪麗醫院、HKU、西營盤、西隧、太空館');
var CHT_973_SOUTH = new Line('973', lineType_HARBOUR, '尖沙咀(麽地道)', '赤柱市場', [MTR_tml_easttsimshatsui, MTR_tml_austin, WestHarbourTunnel_Interchange, WestHarbourTunnel, MTR_ill_saiyingpun, MTR_ill_hku, UpperKennedyTown, MTR_swil_queenmary, PokFuLam_Actual, OuterWahFoo, MTR_swil_tinwan, MTR_swil_aberdeen, MTR_seil_wongchukhang, MTR_seil_oceanpark], 30).setNotes('經西隧、西營盤、HKU、瑪麗醫院、香港仔、深水灣、淺水灣');
...
// All 97*
var CHT_NUM_97x_ALL = [CHT_970_NORTH, CHT_970_SOUTH, CHT_970X_NORTH, CHT_970X_SOUTH, CHT_973_NORTH, CHT_973_SOUTH, KMB_978_NORTH, KMB_978_SOUTH];
// All 9**
var CHT_NUM_9xx_ALL = [].concat(CHT_NUM_90x_ALL, CHT_NUM_91x_ALL, CHT_NUM_93x_ALL, CHT_NUM_96x_ALL, CHT_NUM_97x_ALL);
// N1**
var CHT_N121_EAST = new Line('N121', lineType_HARBOUR, '中環(港澳碼頭)', '牛頭角', [MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, CrossHarbourTunnel, CrossHarbourTunnel_Interchange, MTR_tml_homantin, MTR_tml_tokwawan, MTR_tml_sungwongtoi, PE_RegalOrientalHotel, SunPoKong_Inside, MTR_ktl_diamondhill, PE_ChoiHung, MTR_ktl_kowloonbay], 15).markNightOnly().setNotes('經金鐘、灣仔、紅隧、土瓜灣上路、九龍城、新蒲崗、彩虹');
var CHT_N121_WEST = new Line('N121', lineType_HARBOUR, '牛頭角', '中環(港澳碼頭)', [MTR_ktl_kowloonbay, MTR_ktl_choihung, MTR_ktl_diamondhill, SunPoKong_Inside, PE_RegalOrientalHotel, MTR_tml_sungwongtoi, MTR_tml_tokwawan, MTR_tml_homantin, CrossHarbourTunnel_Interchange, CrossHarbourTunnel, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan], 15).markNightOnly().setNotes('經金鐘、灣仔、紅隧、土瓜灣上路、九龍城、新蒲崗、彩虹');
// All N1**
var CHT_NUM_N1xx_ALL = [CHT_N121_EAST, CHT_N121_WEST];
// N6**
var CHT_N680_NORTH = new Line('N680', lineType_HARBOUR, '中環(港澳碼頭)', '錦英苑', [MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_causewaybay, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, EastHarbourTunnel, EastHarbourTunnel_Interchange, KwunTongBypass, KowloonBayFlyover, OldTatesTunnel, OldTatesTunnel_Interchange, ST_SiuLekYuenPlayground, ST_ShatinHospital, MTR_mos_taishuihang, MOS_HengHongStreet, MTR_mos_maonshan, MOS_KamYingCourt], 20).markNightOnly().setNotes('經東隧、大隧、沙田第一城、濱景花園、富安花園、恆安/耀安、馬鞍山市中心、利安');
var CHT_N680_SOUTH = new Line('N680', lineType_HARBOUR, '錦英苑', '中環(港澳碼頭)', [MOS_KamYingCourt, MTR_mos_maonshan, MOS_HengHongStreet, MTR_mos_taishuihang, ST_ShatinHospital, ST_SiuLekYuenPlayground, OldTatesTunnel_Interchange, OldTatesTunnel, KowloonBayFlyover, KwunTongBypass, EastHarbourTunnel_Interchange, EastHarbourTunnel, MTR_ill_northpoint, MTR_ill_fortresshill, MTR_ill_tinhau, MTR_ill_causewaybay, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan], 20).markNightOnly().setNotes('經大隧、東隧、北角、炮台山、銅鑼灣、灣仔、中環');
// All N6**
var CHT_NUM_N6xx_ALL = [CHT_N680_NORTH, CHT_N680_SOUTH];
// All Nightly CHT bus
var CHT_NUM_Nxxx_ALL = [].concat(CHT_NUM_N1xx_ALL, CHT_NUM_N6xx_ALL);
// All Cross-Harbour Bus
var CHT_HK18_ALL = [].concat(CHT_NUM_1xx_ALL, CHT_NUM_3xx_ALL, CHT_NUM_6xx_ALL, CHT_NUM_9xx_ALL, CHT_NUM_Nxxx_ALL);
// All Section
var HK18_ALL_LINES = [].concat(WALK_HK18_ALL, TRAM_ALL, FERRY_HK18_ALL, GMB_HK18_ALL, KMB_HK18_ALL, LWB_HK18_ALL, CTB_HK18_ALL, NWFB_HK18_ALL, CHT_HK18_ALL);
