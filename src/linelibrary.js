...
var WALK_KLP_HMT_WMP_ToPier = new Line("", lineType_WALK, "黃埔花園", "紅磡渡輪碼頭", [MTR_ktl_whampoa, HH_HungHomFerryPier]);
var WALK_KLP_HMT_WMP_FromPier = new Line("", lineType_WALK, "紅磡渡輪碼頭", "黃埔花園", [HH_HungHomFerryPier, MTR_ktl_whampoa]);
...
// Wong Tai Sin
var WALK_KLP_WTS_Uphill = new Line("", lineType_WALK, "黃大仙", "竹園", [MTR_ktl_wongtaisin, ChukYuen]);
var WALK_KLP_WTS_Downhill = new Line("", lineType_WALK, "竹園", "黃大仙", [ChukYuen, MTR_ktl_wongtaisin]);
...
var TRAM_6_EAST = new Line("", lineType_TRAM, "堅尼地城", "筲箕灣", [MTR_ill_kennedytown, HKU_ShekTongTsui, ConnaughtRoadWest_Stop, MTR_ill_sheungwan, MTR_ill_central, MTR_ill_admiralty, MTR_ill_wanchai, MTR_ill_causewaybay, MTR_ill_tinhau, MTR_ill_fortresshill, MTR_ill_northpoint, MTR_ill_quarrybay, MTR_ill_taikoo, MTR_ill_saiwanho, MTR_ill_saukeiwan]);
...
// KMB Section
// 00*
var KMB_1_NORTH = new Line('1', lineType_KMB, '尖沙咀碼頭', '竹園邨', [MTR_twl_tsimshatsui, MTR_twl_jordan, MTR_twl_yaumatei, MTR_twl_mongkok, MTR_twl_princeedward, MongKokFlowerMarket, BoundaryPrince, MTR_ktl_lokfu, ChukYuen], 10).setNotes('經彌敦道、喇沙、九龍城、東頭邨');
var KMB_1_SOUTH = new Line('1', lineType_KMB, '竹園邨', '尖沙咀碼頭', [ChukYuen, MTR_ktl_lokfu, BoundaryPrince, MongKokFlowerMarket, MTR_twl_princeedward, MTR_twl_mongkok, MTR_twl_yaumatei, MTR_twl_jordan, MTR_twl_tsimshatsui], 10).setNotes('經彌敦道、喇沙、九龍城、東頭邨');
...
var KMB_6D_EAST = new Line("6D", lineType_KMB, "美孚", "牛頭角", [MTR_twl_meifoo, MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, MTR_ktl_shekkipmei, MongKokFlowerMarket, BoundaryPrince, PE_RegalOrientalHotel, SunPoKong_Inside, MTR_ktl_diamondhill, MTR_ktl_choihung, MTR_ktl_kowloonbay], 15);
var KMB_6D_WEST = new Line("6D", lineType_KMB, "牛頭角", "美孚", [MTR_ktl_kowloonbay, MTR_ktl_choihung, MTR_ktl_diamondhill, SunPoKong_Inside, PE_RegalOrientalHotel, BoundaryPrince, MongKokFlowerMarket, MTR_ktl_shekkipmei, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok, MTR_twl_meifoo], 15);
// All 00*
var KMB_NUM_00x_ALL = [KMB_1_NORTH, KMB_1_SOUTH, KMB_6_NORTH, KMB_6_SOUTH, KMB_6D_EAST, KMB_6D_WEST];
// 01*
var KMB_11D_EAST = new Line("11D", lineType_KMB, "樂富", "觀塘碼頭", [MTR_ktl_lokfu, BoundaryPrince, PE_RegalOrientalHotel, MTR_ktl_choihung, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, KT_KwunTongFerryPier], 20);
var KMB_11D_WEST = new Line("11D", lineType_KMB, "觀塘碼頭", "樂富", [KT_KwunTongFerryPier, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, MTR_ktl_choihung, PE_RegalOrientalHotel, BoundaryPrince, MTR_ktl_lokfu], 20);
// All 01*
...
// All 03*
var KMB_NUM_03x_ALL = [KMB_30X_NORTH, KMB_30X_SOUTH, KMB_36A_NORTH, KMB_36A_SOUTH];
// 04*
// Negative rotation vector -> clockwise path
var KMB_40X_EAST = new Line("40X", lineType_KMB, "葵涌邨", "烏溪沙站", [KwaiChungEstate, MTR_twl_kwaihing, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, YuenWo, ShatinSeafood, ShatinHospital, MTR_mos_taishuihang, HengHongStreet, MTR_mos_maonshan, KamYingCourt, MTR_mos_wukaisha], 13);
var KMB_40X_WEST = new Line("40X", lineType_KMB, "烏溪沙站", "葵涌邨", [MTR_mos_wukaisha, KamYingCourt, MTR_mos_maonshan, HengHongStreet, MTR_mos_taishuihang, ShatinHospital, ShatinSeafood, YuenWo, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_kwaihing, KwaiChungEstate], 13);
var KMB_43X_EAST = new Line("43X", lineType_KMB, "荃灣西站", "耀安", [MTR_tml_tsuenwanwest, TW_ChungOnStreet, YiPeiChuen, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ShatinSeafood, ShatinHospital, ChevalierGarden, MTR_mos_hengon, HengHongStreet], 13);
var KMB_43X_WEST = new Line("43X", lineType_KMB, "耀安", "荃灣西站", [HengHongStreet, MTR_mos_hengon, ChevalierGarden, ShatinHospital, ShatinSeafood, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, YiPeiChuen, TW_ChungOnStreet, MTR_tml_tsuenwanwest], 13);
...
var KMB_47A_EAST = new Line("47A", lineType_KMB, "葵芳南", "水泉澳", [MTR_twl_kwaifong, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ShatinTownCenter, MTR_mos_shatinwai, ShuiChuenO], 30);
var KMB_47A_WEST = new Line("47A", lineType_KMB, "水泉澳", "葵芳南", [ShuiChuenO, MTR_mos_shatinwai, ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_kwaihing, MTR_twl_kwaifong], 30).setNotes("早繁時間不經沙田市中心");
...
var KMB_48X_EAST = new Line("48X", lineType_KMB, "灣景花園", "禾輋邨", [BelvedereGarden, MTR_twl_tsuenking, MTR_twl_tsuenwan, MTR_twl_taiwohau, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ShatinTownCenter, YuenWo], 5);
var KMB_48X_WEST = new Line("48X", lineType_KMB, "禾輋邨", "灣景花園", [YuenWo, ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_taiwohau, MTR_twl_tsuenwan, MTR_twl_tsuenking, BelvedereGarden], 5);
var KMB_49X_EAST = new Line("49X", lineType_KMB, "青衣碼頭", "沙田廣源", [TsingYiFerryPier, TY_CheungOnEstate, TW_NinaTowers, MTR_twl_tsuenwan, CheungPeiShanRoad, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ShatinTownCenter, BelairGardens, MTR_mos_cityone], 8);
var KMB_49X_WEST = new Line("49X", lineType_KMB, "沙田廣源", "青衣碼頭", [MTR_mos_cityone, ShatinSeafood, BelairGardens, ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, CheungPeiShanRoad, MTR_twl_tsuenwan, TW_NinaTowers, TY_CheungOnEstate, TsingYiFerryPier], 8);
// All 04*
...
// 06*
var KMB_64K_EAST = new Line("64K", lineType_KMB, "元朗(西)", "大埔墟站", [KCR_lrt_5_fungninroad, MTR_tml_yuenlong, KSR_KoPoTsuen, MTR_tml_kamsheungroad, KSR_YuenKongTsuen, KSR_SheugnTsuen, Rural_Kadoorie, TaiPo_LamChuen, MTR_erl_taiwo, WanTauKokLane, MTR_erl_taipomarket]).setNotes("途經林錦公路");
var KMB_64K_WEST = new Line("64K", lineType_KMB, "大埔墟站", "元朗(西)", [MTR_erl_taipomarket, MTR_erl_taiwo, TaiPo_LamChuen, Rural_Kadoorie, KSR_SheugnTsuen, KSR_YuenKongTsuen, MTR_tml_kamsheungroad, KSR_KoPoTsuen, MTR_tml_yuenlong, KCR_lrt_5_fungninroad]).setNotes("途經林錦公路");
var KMB_67M_EAST = new Line("67M", lineType_KMB, "兆康苑", "葵芳站", [MTR_tml_siuhong, LingNamUniversity, KCR_lrt_2_primeview, KCR_lrt_2_puito, TuenMunHighway_SoKwunWat, TuenMunHighway_InterchangeEast, TuenMunHighway_TsingLungTau, TuenMunHighway_YauKomTau, MTR_twl_tsuenking, TW_ChungOnStreet, MTR_twl_taiwohau, MTR_twl_kwaihing, MTR_twl_kwaifong], 10).setNotes("星期一至日 05:25-23:40");
var KMB_67M_WEST = new Line("67M", lineType_KMB, "葵芳站", "兆康苑", [MTR_twl_kwaifong, KwongFaiWai, MTR_twl_taiwohau, TW_ChungOnStreet, MTR_twl_tsuenking, TuenMunHighway_YauKomTau, TuenMunHighway_TsingLungTau, TuenMunHighway_InterchangeWest, TuenMunHighway_SoKwunWat, KCR_lrt_2_puito, KCR_lrt_2_primeview, LingNamUniversity, MTR_tml_siuhong], 10).setNotes("星期一至日 06:10-00:40");
...
var KMB_68X_EAST = new Line('68X', lineType_KMB, '洪水橋(洪福邨)', '旺角(柏景灣)', [MTR_tml_hungshuikiu, KCR_lrt_4_hungshuikiu, KCR_lrt_4_pingshan, KCR_lrt_5_fungninroad, KCR_lrt_5_yuenlong, TsingLongHighway, TaiLamTunnel_Interchange, TaiLamTunnel, TuenMunHighway_YauKomTau, TsuenWanRoad, LaiKingChokePoint, MTR_twl_meifoo, MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, MTR_twl_princeedward, MTR_twl_mongkok, MTR_tcl_olympic], 18).setNotes('每日05:25-00:25');
var KMB_68X_WEST = new Line('68X', lineType_KMB, '旺角(柏景灣)', '洪水橋(洪福邨)', [MTR_tcl_olympic, MTR_twl_mongkok, MTR_twl_princeedward, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok, MTR_twl_meifoo, LaiKingChokePoint, TsuenWanRoad, TuenMunHighway_YauKomTau, TaiLamTunnel, TaiLamTunnel_Interchange, TsingLongHighway, KCR_lrt_5_yuenlong, KCR_lrt_5_fungninroad, KCR_lrt_4_pingshan, KCR_lrt_4_hungshuikiu, MTR_tml_hungshuikiu], 18).setNotes('每日06:00-01:05');
// All 06*
...
// 07*
var KMB_72_NORTH = new Line("72", lineType_KMB, "長沙灣", "大埔太和", [MTR_twl_laichikok, MTR_twl_cheungshawan, MTR_twl_shamshuipo, TaiPoRoad_KowloonReservoir, TaiPoRoad_ShatinHeights, TaiPoRoad_MeiLam, MTR_erl_shatin, YuenWo, TaiPoRoad_Shatin, TaiPoRoad_CUHK, TaiPoRoad_TaiPoKau, KwongFukEstate, KwongFukRoad, MTR_erl_taiwo], 20);
var KMB_72_SOUTH = new Line("72", lineType_KMB, "大埔太和", "長沙灣", [MTR_erl_taiwo, WanTauKokLane, KwongFukEstate, TaiPoRoad_TaiPoKau, TaiPoRoad_CUHK, TaiPoRoad_Shatin, YuenWo, MTR_erl_shatin, TaiPoRoad_ShatinHeights, TaiPoRoad_KowloonReservoir, MTR_twl_shamshuipo, MTR_twl_cheungshawan, MTR_twl_laichikok], 20);
...
// 08*
var KMB_80_NORTH = new Line('80', lineType_KMB, '觀塘碼頭', '美林', [KT_KwunTongFerryPier, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, HungNgokHouse_ChoiHung, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, LionRockTunnel, LionRockTunnelHighway, ST_LungHangEstate, MTR_tml_hinkeng, MTR_erl_taiwai, TaiPoRoad_MeiLam], 10);
var KMB_80_SOUTH = new Line('80', lineType_KMB, '美林', '觀塘碼頭', [MTR_erl_taiwai, MTR_tml_hinkeng, ST_LungHangEstate, LionRockTunnelHighway, LionRockTunnel, MTR_ktl_wongtaisin, MTR_ktl_diamondhill, MTR_ktl_choihung, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, KT_KwunTongFerryPier], 10);
...
var KMB_80X_EAST = new Line('80X', lineType_KMB, '沙田(秦石)', '觀塘碼頭', [MTR_mos_chekungtemple, MTR_mos_shatinwai, OldTatesTunnel_Interchange, OldTatesTunnel, ChoiHungBusTerminus, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, KT_KwunTongFerryPier], 10).setNotes('經觀塘道、彩虹、大老山隧道');
var KMB_80X_WEST = new Line('80X', lineType_KMB, '觀塘碼頭', '沙田(秦石)', [KT_KwunTongFerryPier, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, HungNgokHouse_ChoiHung, OldTatesTunnel, OldTatesTunnel_Interchange, MTR_mos_shatinwai, MTR_mos_chekungtemple], 10).setNotes('經觀塘道、彩虹、大老山隧道');
...
var KMB_83K = new Line("83K", lineType_KMB, "沙田黃泥頭", "沙田市中心", [ST_KwongYuen, HangSengUniversity, MTR_mos_cityone, ShatinSeafood, BelairGardens, ShatinTownCenter, YuenWo, MTR_mos_cityone, HangSengUniversity, ST_KwongYuen]).markCircular();
var KMB_85A_NORTH = new Line('85A', lineType_KMB, '九龍城碼頭', '沙田廣源邨', [KLC_KowloonCityPier, MTR_tml_sungwongtoi, BoundaryPrince, MTR_ktl_lokfu, LionRockTunnel, LionRockTunnel_Interchange, LionRockTunnelHighway, SunTinWai, MTR_mos_shatinwai, BelairGardens, MTR_mos_cityone, HangSengUniversity, ST_KwongYuen], 25).setNotes('經浸會大學');
var KMB_85A_SOUTH = new Line('85A', lineType_KMB, '沙田廣源邨', '九龍城碼頭', [ST_KwongYuen, HangSengUniversity, MTR_mos_cityone, ShatinSeafood, BelairGardens, MTR_mos_shatinwai, SunTinWai, LionRockTunnelHighway, LionRockTunnel_Interchange, LionRockTunnel, MTR_ktl_lokfu, BoundaryPrince, MTR_tml_sungwongtoi, KLC_KowloonCityPier], 25).setNotes('經浸會大學');
...
var KMB_88K_NORTH = new Line("88K", lineType_KMB, "顯徑", "駿景園", [MTR_tml_hinkeng, ST_LungHangEstate, MTR_erl_taiwai, TaiPoRoad_MeiLam, ShatinTownCenter, YuenWo, MTR_erl_fotan, RoyalAscot], 12);
var KMB_88K_SOUTH = new Line("88K", lineType_KMB, "駿景園", "顯徑", [RoyalAscot, MTR_erl_fotan, YuenWo, ShatinTownCenter, TaiPoRoad_MeiLam, MTR_erl_taiwai, ST_LungHangEstate, MTR_tml_hinkeng], 12);
...
// 09*
var KMB_98A = new Line("98A", lineType_KMB, "坑口北", "牛頭角站", [MTR_tko_hanghau, MTR_tko_polam, KT_Anderson, SauMauPing, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, SauMauPing, KT_Anderson, MTR_tko_polam, MTR_tko_hanghau], 12).markCircular();
...
// 26*
var KMB_263_EAST = new Line("263", lineType_KMB, "屯門站", "沙田站", [MTR_tml_tuenmun, TM_TuenMunTownCenter, KCR_lrt_1_samshing, TuenMunHighway_SoKwunWat, TuenMunHighway_InterchangeEast, TuenMunHighway_TsingLungTau, TuenMunHighway_YauKomTau, CheungPeiShanRoad, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, MTR_erl_shatin], 12).setNotes("經豐景圍、安定、市中心");
var KMB_263_WEST = new Line("263", lineType_KMB, "沙田站", "屯門站", [MTR_erl_shatin, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, CheungPeiShanRoad, TuenMunHighway_YauKomTau, TuenMunHighway_TsingLungTau, TuenMunHighway_InterchangeWest, TuenMunHighway_SoKwunWat, KCR_lrt_1_samshing, TM_TuenMunTownCenter, MTR_tml_tuenmun], 12).setNotes("經豐景圍、安定、市中心");
var KMB_263A_MORNING = new Line('263A', lineType_KMB, '屯門站', '香港科學園第三期', [MTR_tml_tuenmun, KCR_lrt_1_samshing, TuenMunHighway_SoKwunWat, TuenMunHighway_InterchangeEast, TuenMunHighway_TsingLungTau, TuenMunHighway_YauKomTau, CheungPeiShanRoad, ShingMunTunnel, ShingMunTunnelHighway, TaiPoRoad_Shatin, ShatinSeafood, MTR_erl_university, SciencePark], 1440).markCommuter().setNotes('單班車0725開出；經濱景花園、大學站，不停城門隧道轉車站');
...
var KMB_269B_NORTH = new Line('269B', lineType_KMB, '紅磡(紅鸞道)', '天水圍市中心', [HH_HungHomFerryPier, MTR_tml_hunghom, MTR_tml_easttsimshatsui, MTR_twl_tsimshatsui, MTR_twl_jordan, MTR_tml_austin, WestKowloonHighway, LaiKingChokePoint, TY_CheungTsingTunnel, TY_TingKauBridge, TaiLamTunnel, TaiLamTunnel_Interchange, TsingLongHighway, YuenLongHighway, LongTinRoad, MTR_tml_tinshuiwai, KCR_lrt_4_tinshui, KCR_lrt_4_tinwing], 20).setNotes('天水圍特快 (不經元朗)');
var KMB_269B_SOUTH = new Line('269B', lineType_KMB, '天水圍市中心', '紅磡(紅鸞道)', [KCR_lrt_4_tinwing, KCR_lrt_4_tinshui, MTR_tml_tinshuiwai, LongTinRoad, YuenLongHighway, TsingLongHighway, TaiLamTunnel_Interchange, TaiLamTunnel, TY_TingKauBridge, TY_CheungTsingTunnel, LaiKingChokePoint, WestKowloonHighway, MTR_tml_austin, MTR_tml_easttsimshatsui, HH_HungHomFerryPier], 20).setNotes('天水圍特快 (不經元朗)');
var KMB_269C_EAST = new Line('269C', lineType_KMB, '天水圍市中心', '觀塘碼頭', [KCR_lrt_4_tinwing, KCR_lrt_4_tinshui, MTR_tml_tinshuiwai, LongTinRoad, YuenLongHighway, TsingLongHighway, TaiLamTunnel_Interchange, TaiLamTunnel, TY_TingKauBridge, TY_CheungTsingTunnel, LaiKingChokePoint, ChingCheungRoad_Other, ChingCheungRoad_BeaconHill, MTR_ktl_wongtaisin, SunPoKong_Inside, ChoiHungBusTerminus, MTR_ktl_kowloonbay, MTR_ktl_ngautaukok, MTR_ktl_kwuntong, KT_KwunTongFerryPier], 10).setNotes('天水圍特快 (不經元朗)');
var KMB_269C_WEST = new Line('269C', lineType_KMB, '觀塘碼頭', '天水圍市中心', [KT_KwunTongFerryPier, MTR_ktl_kwuntong, MTR_ktl_ngautaukok, MTR_ktl_kowloonbay, MTR_ktl_choihung, MTR_ktl_diamondhill, MTR_ktl_wongtaisin, ChingCheungRoad_BeaconHill, ChingCheungRoad_Other, LaiKingChokePoint, TY_CheungTsingTunnel, TY_TingKauBridge, TaiLamTunnel, TaiLamTunnel_Interchange, TsingLongHighway, YuenLongHighway, LongTinRoad, MTR_tml_tinshuiwai, KCR_lrt_4_tinshui, KCR_lrt_4_tinwing], 10).setNotes('天水圍特快 (不經元朗)');
var KMB_269D_EAST = new Line('269D', lineType_KMB, '天富', '瀝源', [KCR_lrt_4_tinwing, KCR_lrt_5A_tinyat, KCR_lrt_4_tinshui, MTR_tml_tinshuiwai, LongTinRoad, KCR_lrt_5_fungninroad, MTR_tml_yuenlong, TsingLongHighway, TaiLamTunnel_Interchange, TaiLamTunnel, TuenMunHighway_YauKomTau, CheungPeiShanRoad, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, ShatinTownCenter, YuenWo], 15).setNotes('經元朗');
var KMB_269D_WEST = new Line('269D', lineType_KMB, '瀝源', '天富', [YuenWo, ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, CheungPeiShanRoad, TuenMunHighway_YauKomTau, TaiLamTunnel, TaiLamTunnel_Interchange, TsingLongHighway, MTR_tml_yuenlong, KCR_lrt_5_fungninroad, LongTinRoad, MTR_tml_tinshuiwai, KCR_lrt_4_tinshui, KCR_lrt_5A_tinyat, KCR_lrt_4_tinwing], 15).setNotes('經元朗');
// All 26*
var KMB_NUM_26x_ALL = [KMB_263_EAST, KMB_263_WEST, KMB_263A_MORNING, KMB_263A_AFTERNOON, KMB_269B_NORTH, KMB_269B_SOUTH, KMB_269C_EAST, KMB_269C_WEST, KMB_269D_EAST, KMB_269D_WEST];
// 27*
var KMB_270A_NORTH = new Line("270A", lineType_KMB, "尖東麼地道", "上水", [MTR_tml_easttsimshatsui, MTR_twl_tsimshatsui, MTR_twl_jordan, MTR_twl_yaumatei, KowloonHospital, MTR_erl_kowloontong, LionRockTunnel, LionRockTunnel_Interchange, TaiPoRoad_Shatin, ToloHighway_TaiPo, FanlingHighway_LamTsuen, WahMingTerminus, MTR_erl_fanling, MTR_erl_sheungshui]);
var KMB_270A_SOUTH = new Line("270A", lineType_KMB, "上水", "尖東麼地道", [MTR_erl_sheungshui, MTR_erl_fanling, WahMingTerminus, FanlingHighway_Interchange, FanlingHighway_LamTsuen, ToloHighway_TaiPo, TaiPoRoad_Shatin, LionRockTunnel_Interchange, LionRockTunnel, MTR_erl_kowloontong, KowloonHospital, MTR_twl_yaumatei, MTR_twl_jordan, MTR_tml_easttsimshatsui]);
...
var KMB_278X_NORTH = new Line('278X', lineType_KMB, '荃灣（如心廣場）', '上水', [TW_NinaTowers, TW_ChungOnStreet, MTR_twl_taiwohau, TW_LeiMukShueEstate, ShingMunTunnel_Interchange_East, ShingMunTunnel, ShingMunTunnelHighway, TaiPoRoad_Shatin, ToloHighway_Coastal, ToloHighway_TaiPo, FanlingHighway_LamTsuen, WahMingTerminus, MTR_erl_fanling, MTR_erl_sheungshui], 10).setNotes('經華明');
var KMB_278X_SOUTH = new Line('278X', lineType_KMB, '上水', '荃灣（如心廣場）', [MTR_erl_sheungshui, MTR_erl_fanling, WahMingTerminus, FanlingHighway_Interchange, FanlingHighway_LamTsuen, ToloHighway_TaiPo, ToloHighway_Coastal, TaiPoRoad_Shatin, ShingMunTunnelHighway, ShingMunTunnel, ShingMunTunnel_Interchange_West, TW_LeiMukShueEstate, MTR_twl_taiwohau, TW_ChungOnStreet, TW_NinaTowers], 10).setNotes('經華明');
// All 27*
var KMB_NUM_27x_ALL = [KMB_270A_NORTH, KMB_270A_SOUTH, KMB_273, KMB_273A, KMB_273D, KMB_278X_NORTH, KMB_278X_SOUTH];
// 28*
var KMB_280X_NORTH = new Line("280X", lineType_KMB, "尖東麼地道", "穗禾苑", [MTR_tml_easttsimshatsui, MTR_tml_austin, EaglesNestTunnel, TsingShaInterchange, ShatinHeightsTunnel, ShatinTownCenter, YuenWo, FoTanTsuen], 20).setNotes("經青沙公路");
var KMB_280X_SOUTH = new Line("280X", lineType_KMB, "穗禾苑", "尖東麼地道", [FoTanTsuen, YuenWo, ShatinTownHall, ShatinHeightsTunnel, TsingShaInterchange, EaglesNestTunnel, NgaCheungRoad_WHTX, MTR_twl_tsimshatsui], 20).setNotes("經青沙公路");
...
var KMB_281M_NORTH = new Line("281M", lineType_KMB, "九龍塘站", "新田圍", [MTR_erl_kowloontong, LionRockTunnel, LionRockTunnel_Interchange, LionRockTunnelHighway, ST_LungHangEstate, MTR_tml_hinkeng, MTR_erl_taiwai, MTR_mos_chekungtemple, SunTinWai]);
var KMB_281M_SOUTH = new Line("281M", lineType_KMB, "新田圍", "九龍塘站", [SunTinWai, MTR_mos_chekungtemple, MTR_erl_taiwai, MTR_tml_hinkeng, ST_LungHangEstate, LionRockTunnelHighway, LionRockTunnel_Interchange, LionRockTunnel, MTR_erl_kowloontong]);
 ...
 */
// A4*
var LWB_A41_EAST = new Line('A41', lineType_LWB, '機場', '愉翠苑', [MTR_aex_airport, Airport_HKZHMCBridgePort, LantauLink_SiuHoWan, LantauLink_YamO, LantauLink_Interchange, LantauLink_TsingMaBridge, TsingYiNorthHighway, TW_TexacoFlyover, CheungPeiShanRoad, ShingMunTunnel, ShingMunTunnelHighway, ShatinTownCenter, JatMinEstate, BelairGardens, MTR_mos_cityone], 20).setNotes('經大橋口岸');
var LWB_A41_WEST = new Line('A41', lineType_LWB, '愉翠苑', '機場', [MTR_mos_cityone, BelairGardens, JatMinEstate, ShatinTownCenter, ShingMunTunnelHighway, ShingMunTunnel, CheungPeiShanRoad, TW_TexacoFlyover, TsingYiNorthHighway, LantauLink_TsingMaBridge, LantauLink_Interchange, LantauLink_YamO, LantauLink_SiuHoWan, MTR_aex_airport, Airport_HKZHMCBridgePort], 20).setNotes('經大橋口岸');
// All A4*
...
// E4*
var LWB_E42_EAST = new Line('E42', lineType_LWB, '機場', '博康', [MTR_aex_airport, Airport_CathayPacificCity, MTR_tcl_tungchung, LantauLink_SiuHoWan, LantauLink_YamO, LantauLink_Interchange, LantauLink_TsingMaBridge, TY_TsingYiWest, TW_TexacoFlyover, CheungPeiShanRoad, ShingMunTunnel, ShingMunTunnelHighway, TaiPoRoad_MeiLam, MTR_mos_taiwai, MTR_mos_chekungtemple, ShatinTownCenter, MTR_mos_shatinwai], 16).setNotes('經機場南部設施');
var LWB_E42_WEST = new Line('E42', lineType_LWB, '博康', '機場', [MTR_mos_shatinwai, ShatinTownCenter, MTR_mos_chekungtemple, MTR_mos_taiwai, TaiPoRoad_MeiLam, ShingMunTunnelHighway, ShingMunTunnel, CheungPeiShanRoad, TW_TexacoFlyover, TY_TsingYiWest, LantauLink_TsingMaBridge, LantauLink_Interchange, LantauLink_YamO, LantauLink_SiuHoWan, MTR_tcl_tungchung, Airport_CathayPacificCity, MTR_aex_airport], 16).setNotes('經機場南部設施');
// All E4*
...
var NWFB_8_EAST = new Line("8", lineType_NWFB, "灣仔北", "杏花邨", [WC_WanChaiFerryPier, MTR_ill_wanchai, MTR_ill_causewaybay, MTR_ill_tinhau, EasternCorridor, CW_ChaiWanRoad, MTR_ill_chaiwan, MTR_ill_hengfachuen], 13).setNotes("東走特快");
var NWFB_8_WEST = new Line("8", lineType_NWFB, "杏花邨", "灣仔北", [MTR_ill_hengfachuen, MTR_ill_chaiwan, CW_ChaiWanRoad, EasternCorridor, MTR_ill_fortresshill, MTR_ill_tinhau, MTR_ill_causewaybay, MTR_ill_wanchai, WC_WanChaiFerryPier], 13).setNotes("東走特快");
...
// 79*
var NWFB_798_EAST = new Line("798", lineType_NWFB, "火炭山尾街", "調景嶺站", [FoTanTsuen, YuenWo, ShatinTownCenter, MTR_mos_shatinwai, OldTatesTunnel_Interchange, OldTatesTunnel, KowloonBayFlyover, KwunTongBypass, TseungKwanOTunnel, MTR_tko_polam, MTR_tko_hanghau, MTR_tko_tseungkwano, MTR_tko_tiukengleng], 15).setNotes("將軍澳特快");
var NWFB_798_WEST = new Line("798", lineType_NWFB, "調景嶺站", "火炭山尾街", [MTR_tko_tiukengleng, MTR_tko_tseungkwano, MTR_tko_hanghau, MTR_tko_polam, TseungKwanOTunnel, KwunTongBypass, KowloonBayFlyover, OldTatesTunnel, OldTatesTunnel_Interchange, MTR_mos_shatinwai, MTR_erl_shatin, YuenWo, FoTanTsuen], 15).setNotes("沙田特快；沙田站只准落客");
...
var GMB_NT_28K = new Line("28K", lineType_GMB_NT, "大埔墟站", "新城市廣場", [MTR_erl_taipomarket, TaiPoRoad_TaiPoKau, TaiPoRoad_CUHK, RoyalAscot, MTR_erl_fotan, MTR_erl_shatin, MTR_erl_fotan, RoyalAscot, TaiPoRoad_CUHK, TaiPoRoad_TaiPoKau, MTR_erl_taipomarket], 9).markCircular();
var GMB_NT_28S = new Line("28S", lineType_GMB_NT, "白石角", "新城市廣場", [PakShekKok, CheungShueTan, TaiPoRoad_CUHK, RoyalAscot, MTR_erl_fotan, MTR_erl_shatin, MTR_erl_fotan, RoyalAscot, TaiPoRoad_CUHK, CheungShueTan, PakShekKok], 35).markCircular();
// All 02*
var GMB_NT_NUM_02x = [GMB_NT_26_EAST, GMB_NT_26_WEST, GMB_NT_28K, GMB_NT_28S];
// 06*
var GMB_NT_65A_EAST = new Line("65A", lineType_GMB_NT, "沙田大會堂", "黃泥頭", [ShatinTownHall, BelairGardens, MTR_mos_cityone, HangSengUniversity, ST_KwongYuen], 7);
var GMB_NT_65A_WEST = new Line("65A", lineType_GMB_NT, "黃泥頭", "沙田大會堂", [ST_KwongYuen, HangSengUniversity, MTR_mos_cityone, ShatinSeafood, BelairGardens, ShatinTownHall], 7);
...
var GMB_NT_67K_NORTH = new Line("67K", lineType_GMB_NT, "沙田站", "亞公角", [MTR_erl_shatin, BelairGardens, ShatinSeafood, ShatinHospital], 15);
var GMB_NT_67K_SOUTH = new Line("67K", lineType_GMB_NT, "亞公角", "沙田站", [ShatinHospital, ShatinSeafood, BelairGardens, MTR_erl_shatin], 15);
...
// All 06*
var GMB_NT_NUM_06x = [GMB_NT_65A_EAST, GMB_NT_65A_WEST, GMB_NT_65K_NORTH, GMB_NT_65K_SOUTH, GMB_NT_67A_EAST, GMB_NT_67A_WEST, GMB_NT_67K_NORTH, GMB_NT_67K_SOUTH, GMB_NT_68K_EAST, GMB_NT_68K_WEST];
// All 0**
var GMB_NT_NUM_0xx_ALL = [].concat(GMB_NT_NUM_02x, GMB_NT_NUM_06x);
// 48*
var GMB_NT_481_EAST = new Line('481', lineType_GMB_NT, '荃灣街市街', '火炭山尾街', [TsuenWanMarket, CheungPeiShanRoad, ShingMunTunnel, ShingMunTunnelHighway, TaiPoRoad_Shatin, FoTanTsuen], 5);
var GMB_NT_481_WEST = new Line('481', lineType_GMB_NT, '火炭山尾街', '荃灣街市街', [FoTanTsuen, TaiPoRoad_Shatin, ShingMunTunnelHighway, ShingMunTunnel, CheungPeiShanRoad, MTR_twl_tsuenwan, TsuenWanMarket], 5);
var GMB_NT_481A_EAST = new Line('481A', lineType_GMB_NT, '荃灣街市街', '沙田大會堂', [TsuenWanMarket, TsuenWanTownHall, CheungPeiShanRoad, ShingMunTunnel, ShingMunTunnelHighway, ShatinTownHall], 10);
var GMB_NT_481A_WEST = new Line('481A', lineType_GMB_NT, '沙田大會堂', '荃灣街市街', [ShatinTownHall, ShingMunTunnelHighway, ShingMunTunnel, CheungPeiShanRoad, MTR_twl_tsuenwan, TsuenWanMarket], 10);
var GMB_NT_481B_EAST = new Line('481B', lineType_GMB_NT, '荃灣街市街', '大圍銅鑼灣山', [TsuenWanMarket, TsuenWanTownHall, CheungPeiShanRoad, ShingMunTunnel, ShingMunTunnelHighway, TaiPoRoad_MeiLam, MTR_erl_taiwai], 10).setNotes('部分班次只往大圍站');
var GMB_NT_481B_WEST = new Line('481B', lineType_GMB_NT, '大圍銅鑼灣山', '荃灣街市街', [TaiPoRoad_MeiLam, MTR_erl_taiwai, ShingMunTunnelHighway, ShingMunTunnel, CheungPeiShanRoad, MTR_twl_tsuenwan, TsuenWanMarket], 10).setNotes('部分班次由大圍站開出');
var GMB_NT_482_EAST = new Line('482', lineType_GMB_NT, '荃灣街市街', '沙田大會堂', [TsuenWanMarket, CheungPeiShanRoad, ShingMunTunnel, ShingMunTunnelHighway, TaiPoRoad_MeiLam, TaiPoRoad_Shatin, ShatinTownHall], 15).markNightOnly();
var GMB_NT_482_WEST = new Line('482', lineType_GMB_NT, '沙田大會堂', '荃灣街市街', [ShatinTownHall, TaiPoRoad_Shatin, TaiPoRoad_MeiLam, ShingMunTunnelHighway, ShingMunTunnel, CheungPeiShanRoad, TsuenWanMarket], 15).markNightOnly();
// All 48*
...
// 80*
var GMB_NT_803_NORTH = new Line("803", lineType_GMB_NT, "顯徑", "利安", [MTR_tml_hinkeng, MTR_mos_taiwai, MTR_mos_chekungtemple, JatMinEstate, BelairGardens, ShatinSeafood, ShatinHospital, MTR_mos_taishuihang, HengHongStreet, MTR_mos_maonshan, LeeOnEstate], 15).setNotes("繁忙時間不停大水坑站");
var GMB_NT_803_SOUTH = new Line("803", lineType_GMB_NT, "利安", "顯徑", [LeeOnEstate, MTR_mos_maonshan, HengHongStreet, MTR_mos_taishuihang, ShatinHospital, ShatinSeafood, BelairGardens, JatMinEstate, MTR_mos_chekungtemple, MTR_mos_taiwai, MTR_tml_hinkeng], 15).setNotes("繁忙時間不停大水坑站");
...
var KMB_978_NORTH = new Line('978', lineType_KMB, '灣仔北', '華明總站', [WC_WanChaiFerryPier, MTR_ill_wanchai, MTR_ill_admiralty, MTR_ill_central, MTR_ill_sheungwan, WestHarbourTunnel, WestHarbourTunnel_Interchange, WestKowloonHighway, LaiKingChokePoint, TY_CheungTsingTunnel, TY_TingKauBridge, TaiLamTunnel, TaiLamTunnel_Interchange, TsingLongHighway, SunTinHighway, FanlingHighway_KwuTung, MTR_erl_sheungshui, MTR_erl_fanling, WahMingTerminus], 20).setNotes('星期一至日 10:00-23:30；經大欖隧道、西隧');
var KMB_978_SOUTH = new Line('978', lineType_KMB, '華明總站', '灣仔北', [WahMingTerminus, MTR_erl_fanling, MTR_erl_sheungshui, FanlingHighway_KwuTung, SunTinHighway, TsingLongHighway, TaiLamTunnel_Interchange, TaiLamTunnel, TY_TingKauBridge, TY_CheungTsingTunnel, LaiKingChokePoint, WestKowloonHighway, WestHarbourTunnel_Interchange, WestHarbourTunnel, MTR_ill_sheungwan, MTR_tcl_hongkong, MTR_ill_admiralty, MTR_erl_exhibition, WC_WanChaiFerryPier], 20).setNotes('星期一至日 06:00-23:00；經大欖隧道、西隧');
// All 97*
var CHT_NUM_97x_ALL = [CHT_970_NORTH, CHT_970_SOUTH, CHT_970X_NORTH, CHT_970X_SOUTH, KMB_978_NORTH, KMB_978_SOUTH];
// All 9**
var CHT_NUM_9xx_ALL = [].concat(CHT_NUM_90x_ALL, CHT_NUM_96x_ALL, CHT_NUM_97x_ALL);
