...
var KCR_lrt_1_ALL = [KCR_lrt_1_samshing];
var KCR_lrt_2_ALL = [KCR_lrt_2_tuenmun, KCR_lrt_2_puito, KCR_lrt_2_primeview, KCR_lrt_2_taihing];
...
var FanlingHighway_LamTsuen = new Waypoint("fanlinghw", "").markAttributes("i");
...
var HKU_ShekTongTsui = new Waypoint("shektongtsui", "");
...
var KT_Anderson = new Waypoint("anderson", "");
var SauMauPing = new Waypoint("", "");
var KT_KwunTongFerryPier = new Waypoint("", "");
var PE_RegalOrientalHotel = new Waypoint("", "富豪東方酒店");
...
var WC_WanChaiFerryPier = new Waypoint("", "").addNeighbor(MTR_erl_exhibition);
var CW_ChaiWanRoad = new Waypoint("", "");
var ShuiChuenO = new Waypoint("", "");
var ShatinHospital = new Waypoint("", "");
var KwaiChungEstate = new Waypoint("", "");
var YiPeiChuen = new Waypoint("", "");
var CheungPeiShanRoad = new Waypoint("", "").markAttributes("i");
...
var SKW_YiuTungEstate = new Waypoint("", "");
var KowloonBayCommercial = new Waypoint("", "");
var WestWood_HKU = new Waypoint("", "").addNeighbor(HKU_ShekTongTsui);
var TaiPo_LamChuen = new Waypoint("", "");
var Rural_Kadoorie = new Waypoint("", "");
var KSR_SheugnTsuen = new Waypoint("", "");
...
var ChukYuen = new Waypoint("", "");
var ChingCheungRoad_BeaconHill = new Waypoint("", "");
var ChingCheungRoad_Other = new Waypoint("", "");
var KowloonTongCornwall = new Waypoint("", "");
var UpperKennedyTown = new Waypoint("", "");
var SoUkEstate = new Waypoint("", "");
var OuterWahFoo = new Waypoint("", "");
...
var TsuenWanMarket = new Waypoint("", "").addNeighbor(TW_ChungOnStreet).addNeighbor(MTR_twl_tsuenwan);
var TsuenWanTownHall = new Waypoint("", "");
var SciencePark = new Waypoint("", "");
var PE_ChoiHung = new Waypoint("", "麗晶花園/坪石邨");
var PE_SunPoKong = new Waypoint("", "");
var Airport_CathayPacificCity = new Waypoint("", "");
...
var TY_TsingYiWest = new Waypoint("", "");
var TW_TexacoFlyover = new Waypoint("", "");
var TsingYiNorthHighway = new Waypoint("", "");
var Airport_HKZHMCBridgePort = new Waypoint("", "");
var TC_YatTungEstate = new Waypoint("", "");
var HH_HungHomFerryPier = new Waypoint("", "");
var TY_CheungTsingTunnel = new Waypoint("", "").markAttributes("i");
var TY_TingKauBridge = new Waypoint("", "").markAttributes("i");
var KLC_KowloonCityPier = new Waypoint("", "");
var ST_KwongYuen = new Waypoint("", "");
var FanlingHighway_KwuTung = new Waypoint("", "").markAttributes("i");
var SunTinHighway = new Waypoint("", "").markAttributes("i");
var YL_YuenLongPark = new Waypoint("", "");
var YL_Residence88 = new Waypoint("", "");
var TKO_HongSingGarden = new Waypoint("", "");
var KLC_ArgyleStreet = new Waypoint("", "");
var ST_LungHangEstate = new Waypoint("", "");
var KSR_KamTinCore = new Waypoint("", "");
var KSR_ShekKongMilitary = new Waypoint("", "");
var KSR_YuenKongTsuen = new Waypoint("", "");
var ConnaughtRoadFlyover = new Waypoint("", "").markAttributes("i");
var CW_SiuSaiWan = new Waypoint("", "");
var TM_TuenMunTownCenter = new Waypoint("", "").addNeighbor(MTR_tml_tuenmun).addNeighbor(KCR_lrt_2_puito);
