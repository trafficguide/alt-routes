...
var ChungOnStreet = new Waypoint("chungonstreet", "").addNeighbor(MTR_twl_tsuenwan);
var ShingMunTunnel_Interchange = new Waypoint("smtInterchange", "").markAttributes("x");
var ShingMunTunnel = new Waypoint("smtActual", "").markAttributes("i");
var ShatinTownCenter = new Waypoint("stcenter", "").addNeighbor(MTR_erl_shatin);
var ShatinTownHall = new Waypoint("sttownhall", "").addNeighbor(MTR_erl_shatin).addNeighbor(ShatinTownCenter);
var FoTanTsuen = new Waypoint("fotanvillage", "").addNeighbor(MTR_erl_fotan);
var ChevalierGarden = new Waypoint("chevalier", "").addNeighbor(MTR_mos_taishuihang);
var KamYingCourt = new Waypoint("kamyingcourt", "").addNeighbor(LeeOnEstate);
var ToloHighway_TaiPo = new Waypoint("tlh_taipo", "").markAttributes("i");
